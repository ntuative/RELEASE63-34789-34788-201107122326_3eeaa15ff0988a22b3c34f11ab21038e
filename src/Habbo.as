package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_22:String = "client.init.core.init";
      ...
      public static const const_20:String = "flash_version";
      
      public static const const_17:String = "avg_update";
      
      public static const const_15:String = "debug";
      
      public static const const_13:String = "error_desc";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_20] = Capabilities.version;
            _loc6_[const_17] = 0;
            _loc6_[const_13] = param1;
            _loc6_[const_14] = String(param2);
            if(param3 != null)
            {
               _loc6_[ERROR_VARIABLE_DATA] = String(param3.getStackTrace());
            }
            _loc6_[const_15] = "Memory usage: " + Math.round(0 / (1024 * 1024)) + " MB";
            _loc5_.data = _loc6_;
      ...
      private function onAddedToStage(param1:Event) : void
      {
         ...
         var _loc2_:String = stage.loaderInfo.parameters["url_prefix"];
         if(_loc2_ != null)
         {
            _crashURL = _loc2_ + "/flash_client_error";
         }
