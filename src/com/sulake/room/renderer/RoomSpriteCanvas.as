package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1448:int = 50;
      
      private static const const_1055:Number = 60;
      
      private static const const_1449:Number = 50;
      ...
      private var var_629:RoomObjectCache;
      
      private var var_530:Array;
      
      private var var_630:Array;
      
      private var var_1465:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2421:Number = -1.0E7;
      
      private var var_2418:Number = -1.0E7;
      ...
      private var var_3073:Boolean = false;
      
      private var var_2422:Array;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_276 = new Sprite();
         this.var_276.mouseEnabled = false;
         this.var_111 = new Sprite();
         this.var_111.name = "canvas";
         this.var_111.mouseEnabled = false;
         this.var_276.addChild(this.var_111);
         ...
         this.var_629 = new RoomObjectCache(_loc6_);
         this.var_831 = new ColorTransform();
         this.var_634 = new Matrix();
      ...
      {
         this.var_529.x -= param1 - this.var_631;
         this.var_631 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_529.y -= param1 - this.var_633;
         this.var_633 = param1;
      }
      ...
      {
         if(param1 && !this.var_1114)
         {
            this.var_1114 = true;
            if(this.var_152 != null && !this.var_276.contains(this.var_152))
            {
               this.var_276.addChild(this.var_152);
               this.var_111.mask = this.var_152;
            }
         }
         else if(!param1 && this.var_1114)
         {
            this.var_1114 = false;
            if(this.var_152 != null && this.var_276.contains(this.var_152))
            {
               this.var_276.removeChild(this.var_152);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_276.numChildren > 0)
            {
               this.var_276.removeChildAt(0);
            }
            this.var_276 = null;
         }
         this.var_111 = null;
      ...
      {
         this.var_629.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1791 = !this.var_1791;
         ...
         if(this.var_531 != this.var_2420 || this.var_532 != this.var_2417)
         {
            _loc8_ = true;
         }
         if(this.var_111.x != this.var_631 || this.var_111.y != this.var_633)
         {
            this.var_111.x = this.var_631;
            this.var_111.y = this.var_633;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2420 = this.var_531;
         this.var_2417 = this.var_532;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1466 > 0)
         {
            _loc2_ = param1 - this.var_1466;
            if(_loc2_ > const_1055 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2416 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_781;
               if(this.var_781 == const_388 + 1)
               {
                  this.var_560 = _loc2_;
                  this.var_1790 = this.var_2419;
               }
               else if(this.var_781 > const_388 + 1)
               {
                  _loc3_ = Number(this.var_781 - const_388);
                  this.var_560 = this.var_560 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1790 = this.var_1790 * (_loc3_ - 1) / _loc3_ + Number(this.var_2419) / _loc3_;
                  if(this.var_781 > const_388 + const_1448)
                  {
                     this.var_781 = const_388;
                     if(!this.var_1182 && this.var_560 > const_1055)
                     {
                        this.var_1182 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1182 && this.var_560 < const_1449)
                     {
                        this.var_1182 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_629.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_629.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1791 && this.var_1182);
         ...
         _loc13_ += int(this.var_531 / 2);
         _loc14_ += int(this.var_532 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
      ...
      {
         if(param1 < this.var_531 && param1 + param3 >= 0 && (param2 < this.var_532 && param2 + param4 >= 0))
         {
            if(!this.var_3073)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_531)
         {
            param3 -= this.var_531 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_532)
         {
            param4 -= this.var_532 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2422)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_782 || this.var_782 == 0)
         {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_634.identity();
            if(flipH)
            {
               this.var_634.scale(-1,1);
               this.var_634.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_634.scale(1,-1);
               this.var_634.translate(0,data.height);
            }
            finalData.draw(data,this.var_634);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_723);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_831.redMultiplier = tR;
            this.var_831.greenMultiplier = tG;
            this.var_831.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_831);
            if(name.length > 0)
            {
               this.var_275.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1183 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1793;
         }
         this.var_1793 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1183;
         return this.var_1793;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_531 / 2;
         var _loc12_:Number = param2 - this.var_532 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1792,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_632.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_632.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2421 || param2 != this.var_2418)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_632.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_632.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_373 != null && param1 != null)
         {
            this.var_373.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_373 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_373.getKey(_loc1_);
            _loc3_ = this.var_373.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1465.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
