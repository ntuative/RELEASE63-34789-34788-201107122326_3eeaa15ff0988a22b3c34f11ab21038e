package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_1038 = param1 * 1024 * 1024;
         this.var_1984 = param2 * 1024 * 1024;
         this.var_1563 = param3 * 1024 * 1024;
         if(this.var_1563 < 0)
         {
            this.var_1563 = 0;
         }
      ...
      {
         this.var_1038 += this.var_1563;
         if(this.var_1038 > this.var_1984)
         {
            this.var_1038 = this.var_1984;
         }
      }
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_839 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_839 += param2.width * param2.height * 4;
      }
   }
}
