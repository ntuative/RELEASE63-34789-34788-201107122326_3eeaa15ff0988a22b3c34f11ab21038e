package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1922:int = 0;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_453,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_507,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_865,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_729 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_729 == null || this.var_586 == null)
         {
            return;
         }
         this._state = const_2035;
         if(this.var_1355 != null)
         {
            _loc1_ = this.var_1355;
            this.var_1355 = null;
            this.initialize(_loc1_,this.var_188);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_730.indexOf(_loc5_) < 0)
            {
               this.var_61.loadObjectContent(_loc5_,events);
               this.var_730.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1201;
         return true;
      }
      
      public function method_10(param1:IRoomContentLoader) : void
      {
         if(this.var_61 != null)
         {
            this.var_61.dispose();
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_586.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_586.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_729.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_729 != null)
         {
            return this.var_729.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_61.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_730.indexOf(param1);
            if(_loc2_ >= 0)
            {
            ...
            {
               this._state = const_740;
               if(this.var_188 != null)
               {
                  this.var_188.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_1000;
            this.var_188.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_188 != null)
            {
               this.var_188.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_1093.indexOf(_loc2_) < 0)
         {
            this.var_1093.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1093.length > 0)
         {
            _loc2_ = this.var_1093[0];
            this.var_1093.splice(0,1);
            _loc3_ = this.var_61.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_188 != null)
               {
                  this.var_188.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_188 != null)
            {
               this.var_188.contentLoaded(_loc2_,true);
            }
            if(this.var_730.length > 0)
            {
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2910)
            {
               this.var_2120 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_61 == null || this.var_586 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_586.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_586.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_729.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_188 != null)
                              {
                                 this.var_188.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
