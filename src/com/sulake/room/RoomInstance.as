package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_673:Dictionary;
      ...
      private var var_180:IRoomRendererBase;
      ...
      public function RoomInstance(param1:String, param2:IRoomInstanceContainer)
      {
         ...
         this._id = param1;
         this.var_673 = new Dictionary();
         this.var_674 = new Dictionary();
         this.var_1534 = [];
         this.var_1535 = [];
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_285 != null)
         {
            ...
            {
               _loc3_ = this.var_285.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_673)
            {
               delete this.var_673[_loc1_];
            }
            this.var_673 = null;
         }
         if(this.var_674 != null)
         {
            for(_loc1_ in this.var_674)
            {
               delete this.var_674[_loc1_];
            }
            this.var_674 = null;
         }
         this.var_1535 = [];
      ...
      {
         if(this.var_1534.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1534.push(param1);
         }
         if(this.var_673[param1] != param2)
         {
            this.var_673[param1] = param2;
         }
      }
      
      public function getString(param1:String) : String
      {
         return this.var_674[param1];
      }
      ...
      public function setString(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(this.var_674[param1] != param2)
         {
            this.var_674[param1] = param2;
         }
      }
      ...
      public function createObjectInternal(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(this.var_180 != null)
            {
               this.var_180.feedRoomObject(_loc6_);
            }
            return _loc6_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_180)
               {
                  this.var_180.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_180)
                  {
                     this.var_180.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_180.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      {
         return this.var_285.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_285.getValue(_loc2_) != null)
         {
            return this.var_285.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_285.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_285.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_285.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_285.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
