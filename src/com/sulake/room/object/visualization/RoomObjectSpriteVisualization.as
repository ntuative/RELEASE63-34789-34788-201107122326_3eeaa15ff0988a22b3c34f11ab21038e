package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_424:IRoomObject;
      
      private var var_764:IGraphicAssetCollection;
      
      protected var var_507:int = -1;
      
      protected var var_146:int = -1;
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_764.removeReference();
         }
         this.var_764 = param1;
         if(this.var_764 != null)
         {
            this.var_764.addReference();
         }
      }
      ...
      {
         this.var_507 = 4294967295;
         this.var_146 = 4294967295;
         this.var_102 = -1;
      }
