package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_424:IRoomObjectController;
      ...
      {
         if(this.var_424 == param1)
         {
            return;
         }
         if(this.var_424 != null)
         {
            this.var_424.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_424 = param1;
            this.var_424.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_424 != null)
            {
               this.var_424.setLocation(param1.loc);
               this.var_424.setDirection(param1.dir);
            }
         }
      }
