package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private var var_677:IRoomObjectEventHandler;
      ...
      public function RoomObject(param1:int, param2:int, param3:String)
      {
         ...
         this.var_1935 = new Vector3d();
         this.var_678 = new Array(param2);
         var _loc4_:Number = param2 - 1;
         while(_loc4_ >= 0)
         {
            this.var_678[_loc4_] = 0;
            _loc4_--;
         }
         this._type = param3;
      ...
      {
         this.var_1936.assign(this.var_104);
         return this.var_1936;
      }
      
      public function getDirection() : IVector3d
      {
         this.var_1935.assign(this.var_461);
      ...
      {
         if(param1 >= 0 && param1 < this.var_678.length)
         {
            return this.var_678[param1];
         }
         return -1;
      }
      ...
      {
         if(param2 >= 0 && param2 < this.var_678.length)
         {
            if(this.var_678[param2] != param1)
            {
               this.var_678[param2] = param1;
               ++this._updateID;
            }
            return true;
         }
      ...
      {
         if(param1 == this.var_677)
         {
            return;
         }
         var _loc2_:IRoomObjectEventHandler = this.var_677;
         if(_loc2_ != null)
         {
            this.var_677 = null;
            _loc2_.object = null;
