package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1111:uint = 11;
      ...
      private var var_351:IAdManager;
      ...
      private var var_227:IHabboFriendList;
      
      private var var_1316:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_202:IHabboHelp;
      
      private var var_1590:Array;
      
      private var _crashed:Boolean = false;
      
      private var var_295:PerformanceTracker = null;
      
      private var var_487:FramerateTracker = null;
      
      private var var_294:LatencyTracker = null;
      
      private var var_699:LagWarningLogger = null;
      
      private var var_486:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_295 = new PerformanceTracker();
         this.var_487 = new FramerateTracker();
         this.var_294 = new LatencyTracker();
         this.var_699 = new LagWarningLogger();
         this.var_486 = new ToolbarClickTracker(this);
         this.var_1590 = new Array(const_1111);
         var _loc4_:int = 0;
         while(_loc4_ < const_1111)
         {
            this.var_1590[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2030,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1890,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1950,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_768,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1353,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1316)
            {
               this.var_1316.release(new IIDHabboWindowManager());
               this.var_1316 = null;
            }
            if(this.var_351)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_321,this.onZoomToggle);
               }
            ...
            if(this.var_227)
            {
               ...
               {
                  Component(this.var_227).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_227).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_227).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_227).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_227).events.removeEventListener(HabboFriendListTrackingEvent.const_678,this.onFriendlistTrackingEvent);
               }
               this.var_227.release(new IIDHabboFriendList());
               this.var_227 = null;
            }
            if(this.var_202)
            {
               ...
               {
                  this.var_202.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_202.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_202.release(new IIDHabboHelp());
               this.var_202 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_207,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_191,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_332,this.onRoomAction);
               }
            ...
            {
               this.var_343.stop();
               this.var_343.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_343 = null;
            }
      ...
      {
         this.var_1590[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_141 = IHabboConfigurationManager(param2);
         if(this.var_141)
         {
            if(this.var_294 != null)
            {
               this.var_294.configuration = this.var_141;
            }
            if(this.var_295 != null)
            {
               this.var_295.configuration = this.var_141;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1965);
            if(this.var_141)
            {
               if(this.var_699 != null)
               {
                  this.var_699.configure(this.var_141);
               }
               if(this.var_487 != null)
               {
                  this.var_487.configure(this.var_141);
               }
               if(this.var_486 != null)
               {
                  this.var_486.configure(this.var_141);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._communication != null)
         {
            ...
            this._communication.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(this.method_8));
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_871,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_270,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_783,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_75,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_621,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_295 != null)
            {
               this.var_295.connection = param1;
            }
            if(this.var_294 != null)
            {
               this.var_294.communication = this._communication;
               this.var_294.connection = param1;
            }
            if(this.var_699 != null)
            {
               this.var_699.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_783)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1963);
         }
         else if(param1.type == HabboHotelViewEvent.const_621)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1915);
         }
         else if(param1.type == HabboHotelViewEvent.const_75)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1805);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_871:
               this.trackLoginStep(HabboLoginTrackingStep.const_1804,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_296:
               this.trackLoginStep(HabboLoginTrackingStep.const_296);
               break;
            ...
            case HabboCommunicationEvent.const_216:
               ...
               break;
            case HabboCommunicationEvent.const_270:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_270);
               if(this.var_294 != null)
               {
                  this.var_294.init();
               }
      ...
      {
         this.var_1316 = IHabboWindowManager(param2);
         if(this.var_1316)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_141)
            {
               if(this.var_141.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_141.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1590)
                  {
                  ...
                  if(this.var_295 != null)
                  {
                     _loc4_["null"] = this.var_295.flashVersion;
                     _loc4_["null"] = this.var_295.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1349);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1349,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_321,this.onZoomToggle);
      }
      ...
      private function method_8(param1:HabboAchievementNotificationMessageEvent) : void
      {
      ...
      {
         this.var_227 = param2 as IHabboFriendList;
         Component(this.var_227).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_227).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_227).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_227).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_227).events.addEventListener(HabboFriendListTrackingEvent.const_678,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_678:
      ...
      {
         this.var_202 = param2 as IHabboHelp;
         this.var_202.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_202.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2787)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1883);
            this.var_2787 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1353,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_768,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_207,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_191,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_332,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_351 = param2 as IAdManager;
         this.var_351.events.addEventListener(AdEvent.const_557,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_191)
         {
            if(this.var_2024 < 1)
            {
               if(!this.var_343)
               {
                  this.var_343 = new Timer(60000,1);
                  this.var_343.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_343.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_332)
         {
            if(this.var_343)
            {
               this.var_343.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_487)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_487.frameRate),_loc2_);
                  ++this.var_2024;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_486)
         {
            this.var_486.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_486)
         {
            this.var_486.track(param1.type);
         }
      }
      ...
      {
         if(this.var_141 != null && !Boolean(this.var_141.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_699.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_563 > -1 && _loc2_ < this.var_563)
         {
            ++this.var_2023;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2023);
         }
         if(this.var_563 > -1 && _loc2_ - this.var_563 > 15000)
         {
            ++this.var_2022;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2022);
         }
         this.var_563 = _loc2_;
         if(this.var_295 != null)
         {
            this.var_295.update(param1,this.var_563);
         }
         if(this.var_294 != null)
         {
            this.var_294.update(param1,this.var_563);
         }
         if(this.var_487 != null)
         {
            this.var_487.trackUpdate(param1,this,this.var_563);
         }
         if(this.var_699 != null)
         {
            this.var_699.update(this.var_563);
         }
      }
   }
}
