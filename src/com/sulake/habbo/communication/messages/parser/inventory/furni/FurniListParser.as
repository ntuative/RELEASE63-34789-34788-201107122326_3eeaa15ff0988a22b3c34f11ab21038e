package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_3047:String;
      
      protected var var_3046:int;
      
      protected var var_3048:int;
      
      protected var var_1705:Array;
      ...
      {
         this.var_3047 = param1.readString();
         this.var_3046 = param1.readInteger();
         this.var_3048 = param1.readInteger();
         this.var_1705 = new Array();
         var _loc2_:int = param1.readInteger();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            this.var_1705.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
