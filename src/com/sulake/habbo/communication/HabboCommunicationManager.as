package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private const const_2354:int = 2;
      ...
      private var var_1587:IMessageConfiguration;
      ...
      {
         this.var_1587 = new HabboMessages();
         this.var_381 = [];
      ...
      {
         if(this.var_381.length == 0 || this.var_451 < 0 || this.var_451 >= this.var_381.length)
         {
            return 0;
         }
         return this.var_381[this.var_451];
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_278.registerProtocolType(HabboProtocolType.const_1330,WedgieProtocol);
            this._connection = this.var_278.createConnection(HabboConnectionType.const_268,ConnectionType.const_1376);
            _loc3_ = this.var_278.getProtocolInstanceOfType(HabboProtocolType.const_1330);
            this._connection.registerMessageClasses(this.var_1587);
      ...
      private function nextPort() : void
      {
         ...
         this._connection.init(this.var_39 + this.getKey([[65244,65185,65191,65189,65188],[65174,65238,65184],[65171,65172]],0),this.var_381[this.var_451]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_381[this.var_451]);
         this.tryNextPort();
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_381[this.var_451]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_278 ? this.var_278.queueConnection(HabboConnectionType.const_268,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_278)
         {
            this.var_278.addConnectionMessageEvent(HabboConnectionType.const_268,param1);
         }
      }
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1802,param1);
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1755,String(param2));
      }
      
      public function messageReceived(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1986,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2039,param1 + " " + param2);
         if(this.var_155.length > 0)
         {
            this.var_155 += ",R:" + param1;
         }
         else
         {
            this.var_155 = "R:" + param1;
         }
         if(this.var_155.length > 150)
         {
            this.var_155 = this.var_155.substring(this.var_155.length - 150);
         }
         ErrorReportStorage.addDebugData("MESSAGE_QUEUE",this.var_155);
      }
      
      public function messageSent(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1898,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1999,param1 + " " + param2);
         if(this.var_155.length > 0)
         {
            this.var_155 += ",S:" + param1;
         }
         else
         {
            this.var_155 = "S:" + param1;
