package com.sulake.habbo.inventory.recycler
{
   ...
   public class RecyclerModel implements IInventoryModel
   {
      ...
      {
         if(this.var_12 == null || this.var_12.furniModel == null)
         {
            return;
         }
         this._state = STATE_ACTIVE;
         this._itemList = new Map();
         this.var_12.furniModel.showRecyclable(true);
      }
      
      public function stopRecycler() : void
      {
         var _loc2_:int = 0;
         if(this._itemList == null || this.var_12 == null || this.var_12.furniModel == null)
         {
            return;
         }
         this._state = name_5;
         this.var_12.furniModel.showRecyclable(false);
         var _loc1_:int = 0;
         while(_loc1_ < this._itemList.length)
         {
            _loc2_ = this._itemList.getKey(_loc1_);
            this.var_12.furniModel.removeLockFrom(_loc2_);
            _loc1_++;
         }
         this._itemList = null;
      }
      ...
      public function lockSelectedFurni() : int
      {
         ...
         var _loc1_:IItem = this.var_12.furniModel.requestSelectedFurniToRecycler();
         if(_loc1_ == null)
         {
            return 0;
         }
