package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_29:IHabboCommunicationManager;
      
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         this.var_12 = param1;
         this.var_29 = this.var_12.communication;
         this.var_29.addHabboConnectionMessageEvent(new FurniListEvent(this.onFurniList));
         this.var_29.addHabboConnectionMessageEvent(new FurniListInsertEvent(this.onFurniListInsert));
         this.var_29.addHabboConnectionMessageEvent(new FurniListRemoveEvent(this.onFurniListRemove));
         this.var_29.addHabboConnectionMessageEvent(new FurniListUpdateEvent(this.onFurniListUpdate));
         this.var_29.addHabboConnectionMessageEvent(new PostItPlacedEvent(this.onPostItPlaced));
         this.var_29.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(this.onAvatarEffects));
         this.var_29.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(this.onAvatarEffectActivated));
         this.var_29.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(this.onAvatarEffectAdded));
         this.var_29.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(this.onAvatarEffectExpired));
         this.var_29.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(this.onClubStatus));
         this.var_29.addHabboConnectionMessageEvent(new BadgesEvent(this.onBadges));
         this.var_29.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(this.onUserBadges));
         this.var_29.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(this.onAchievementReceived));
         this.var_29.addHabboConnectionMessageEvent(new BadgePointLimitsEvent(this.onBadgePointLimits));
         this.var_29.addHabboConnectionMessageEvent(new AchievementsScoreEvent(this.onAchievementsScore));
         this.var_29.addHabboConnectionMessageEvent(new TradingAcceptEvent(this.onTradingAccepted,TradingAcceptParser));
         this.var_29.addHabboConnectionMessageEvent(new TradingConfirmationEvent(this.onTradingConfirmation,TradingConfirmationParser));
         this.var_29.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(this.onTradingAlreadyOpen,TradingAlreadyOpenParser));
         this.var_29.addHabboConnectionMessageEvent(new TradingCloseEvent(this.onTradingClose,TradingCloseParser));
         this.var_29.addHabboConnectionMessageEvent(new TradingCompletedEvent(this.onTradingCompleted,TradingCompletedParser));
         this.var_29.addHabboConnectionMessageEvent(new TradingItemListEvent(this.onTradingItemList,TradingItemListParser));
         this.var_29.addHabboConnectionMessageEvent(new TradingNotOpenEvent(this.onTradingNotOpen,TradingNotOpenParser));
         this.var_29.addHabboConnectionMessageEvent(new TradingOpenEvent(this.onTradingOpen,TradingOpenParser));
         this.var_29.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(this.onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         this.var_29.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(this.onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         this.var_29.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(this.onRoomClosed));
         this.var_29.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(this.onRoomClosed));
         this.var_29.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(this.onRoomClosed));
         this.var_29.addHabboConnectionMessageEvent(new PetInventoryEvent(this.onPets));
         this.var_29.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(this.onPetAdded));
         this.var_29.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(this.onPetRemoved));
         this.var_29.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(this.onPetInventoryUpdated));
         this.var_29.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(this.onMarketplaceConfiguration));
         this.var_29.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(this.onMarketplaceCanMakeOfferResult));
         this.var_29.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(this.onMarketplaceMakeOfferResult));
         this.var_29.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(this.onMarketplaceItemStats));
         this.var_29.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(this.onNotEnoughCredits));
         this.var_29.addHabboConnectionMessageEvent(new UserRightsMessageEvent(this.onUserRights));
         this.var_29.addHabboConnectionMessageEvent(new UnseenItemsEvent(this.onUnseenItems));
      }
      ...
      private function getConnection() : IConnection
      {
         ...
         return this.var_29.getHabboMainConnection(null);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:FurniModel = this.var_12.furniModel;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_72,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:EffectsModel = this.var_12.effectsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_161);
         _loc2_.refreshViews();
         this.var_12.notifyChangedEffects();
      }
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_12.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember,_loc2_.isVIP,_loc2_.responseType == ScrSendUserInfoMessageParser.const_1331);
            this.var_12.events.dispatchEvent(new HabboInventoryHabboClubEvent());
         }
      }
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:BadgesModel = this.var_12.badgesModel;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         _loc3_.updateView();
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_225);
      }
      ...
      public function onBadgePointLimits(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_12.localization.setBadgePointLimit(_loc3_.badgeId,_loc3_.limit);
         }
      }
      ...
      public function onUserBadges(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.userId != this.var_12.sessionData.userId)
         {
            return;
         }
         var _loc3_:BadgesModel = this.var_12.badgesModel;
      ...
      public function onAchievementReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:BadgesModel = this.var_12.badgesModel;
         if(_loc4_ != null)
         {
      ...
      public function onAchievementsScore(param1:IMessageEvent) : void
      {
         ...
         this.var_12.localization.registerParameter("achievements_score_description","score",_loc3_.score.toString());
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:ISessionDataManager = this.var_12.sessionData;
         var _loc3_:IRoomSession = this.var_12.roomSession;
         if(!_loc2_)
         {
         ...
         this.var_12.toggleInventorySubPage(InventorySubCategory.const_369);
         ...
         var _loc13_:TradingModel = this.var_12.tradingModel;
         if(_loc13_ != null)
         {
      ...
      {
         var _loc2_:TradingModel = this.var_12.tradingModel;
         if(_loc2_ != null)
         {
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         var _loc11_:FurniModel = this.var_12.furniModel;
         if(_loc11_ == null)
         {
            return;
         }
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_234)
            {
            ...
            if(_loc9_.itemType == "S")
            {
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModelCategory.const_38,_loc9_.category,_loc9_.stuffData);
            ...
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModelCategory.const_45,_loc9_.category,_loc9_.stuffData);
                  _loc3_.add(_loc8_,_loc6_);
               }
         ...
         var _loc12_:TradingModel = this.var_12.tradingModel;
         if(_loc12_ != null)
         {
      ...
      {
         this.var_12.closeView();
      }
      
      private function onPets(param1:PetInventoryEvent) : void
      {
         var _loc4_:* = null;
         if(param1 == null || this.var_12 == null)
         {
            return;
         }
         var _loc2_:PetsModel = this.var_12.petsModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_137);
         this.var_12.petsModel.setListInitialized();
      }
      ...
      private function onPetAdded(param1:PetAddedToInventoryEvent) : void
      {
         ...
         this.var_12.furniModel.automaticSwitchToPetCategory();
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var _loc2_:MarketplaceModel = this.var_12.marketplaceModel;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_432);
         var _loc4_:FurniModel = this.var_12.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_12.isInventoryCategoryInit(InventoryCategory.const_432))
         {
            _loc2_ = this.var_12.marketplaceModel;
            if(_loc2_ == null)
            {
               return;
            }
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_12.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_451));
         this.var_12.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_436));
         this.var_12.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_58));
         this.var_12.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1225));
         this.var_12.updateUnseenItemCounts();
      }
   }
}
