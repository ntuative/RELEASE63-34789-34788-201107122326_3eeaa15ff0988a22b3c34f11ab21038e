package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1876:uint = 9;
      
      public static const const_205:uint = 0;
      
      public static const const_232:uint = 1;
      
      public static const const_398:uint = 2;
      
      public static const const_353:uint = 3;
      
      public static const const_540:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_2864 = param5;
         this.var_1083 = new Map();
         this.var_1349 = false;
         this.var_2092 = param6;
         this.var_823 = true;
         this.state = const_232;
         this.var_60.setup(param1,param3,param4,param6);
         this.var_60.updateItemList(this.var_870);
         this.var_60.updateItemList(this.var_1623);
      ...
      public function close() : void
      {
         if(this.var_823)
         {
            if(this._state != const_205 && this._state != const_297)
            {
      ...
      {
         this.var_60.setMinimized(param1 != InventoryCategory.const_72);
         this.var_12.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_869 + " OTHER: " + this.var_1349);
         ...
         {
            case const_205:
               if(param1 == const_232 || param1 == const_297)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_302 == null || this.var_302.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_302.length)
         {
            _loc2_ = this.var_302.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_60.alertPopup(TradingView.const_1243);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_870)
            {
               this.var_869 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1349 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_60.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_870)
            {
               this.var_60.alertPopup(TradingView.const_1337);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_302.length < const_1876)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_234)
            {
               _loc6_ = String(param2) + "poster" + param5;
            }
            if(this.var_302.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
