package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1156:uint = 4284532064;
      
      private static const const_1155:uint = 2577770;
      ...
      private var var_739:ItemPopupCtrl;
      ...
      private var var_2182:IWindowContainer;
      
      private var var_234:Timer;
      
      private var var_1129:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_739 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_81 && !this.var_81.disposed)
            {
               this.var_81.dispose();
               this.var_81 = null;
            }
            if(this.var_234)
            {
               this.var_234.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_234.stop();
               this.var_234 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(this.var_81 == null)
         {
            this.var_81 = this.createNormalWindow();
         }
         if(this.var_2182 == null)
         {
            this.var_2182 = this.createMinimizedWindow();
         }
         if(!this.var_1156)
         {
            return this.var_81;
      ...
      {
         return this.var_81.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      
      protected function getOtherUsersItemGrid() : IItemGridWindow
      {
         return this.var_81.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            this.updateActionState();
            _loc2_ = this.var_81.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = this.var_19.otherUserName;
            }
            _loc1_ = this.var_81.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1156) : uint(const_1155);
            }
            _loc3_ = this.var_81.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = this.var_81.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1156) : uint(const_1155);
            }
            _loc3_ = this.var_81.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      public function updateActionState() : void
      {
         ...
         if(this.var_81)
         {
            _loc1_ = this.var_81.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
      ...
      {
         var _loc2_:ITextWindow = this.var_81.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc2_:ITextWindow = this.var_81.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_81.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      {
         var _loc1_:ITextWindow = this.var_81.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_81.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_81.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_81.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      {
         var _loc1_:ITextWindow = this.var_81.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_81.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_234 = new Timer(1000,3);
            this.var_234.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_234.reset();
         this.var_234.repeatCount = 3;
         this.var_234.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_234.currentCount));
         if(this.var_234.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1129)
         {
            this.var_1129.isSelected = false;
            this.var_1129 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_234)
            {
               _loc7_ = "${poster_" + _loc5_.stuffData + "_name}";
            }
            if(_loc5_.category == FurniCategory.const_1932)
            {
            ...
            if(_loc5_.category == FurniCategory.const_1188)
            {
               _loc7_ = this.getTraxSongFurniName(_loc4_,_loc7_,true,param2.id,param3);
            }
            this.var_739.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_632);
            this.var_739.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_739.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_210.push(param4);
            this.var_210.push(param1);
            this.var_210.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_210.length > 0)
         {
            _loc2_ = this.var_210.pop();
            _loc3_ = this.var_210.pop();
            _loc4_ = uint(this.var_210.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_739.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_632);
               }
            }
            else
            {
               this.var_210.push(_loc4_);
               this.var_210.push(_loc3_);
