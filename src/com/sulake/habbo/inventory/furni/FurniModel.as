package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1536:int = 1000;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_159,this.onObjectPlaced);
               }
            ...
            {
               this.var_669.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_669.stop();
               this.var_669 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_38)
            {
               ...
               {
                  this.var_1525 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1525;
            }
            else
            {
         ...
         this.var_27.setInventoryCategoryInit(InventoryCategory.const_72);
         ...
         if(this.getSelectedItemIndex(const_38) == -1)
         {
            this.toggleItemSelection(const_38,0);
         }
         if(this.getSelectedItemIndex(const_45) == -1)
         {
            this.toggleItemSelection(const_45,0);
         }
         this.initListImages();
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_333)
         {
         ...
         else if(param3 == FurniCategory.const_334)
         {
         ...
         if(this.var_821 == null)
         {
            this.var_821 = this._windowManager.buildFromXML(this.var_2621) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_821.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_821.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_38,const_45];
         var _loc5_:int = 0;
      ...
      {
         if(param1 == InventoryCategory.const_72 && this.var_27.isVisible)
         {
      ...
      {
         this.var_2622 = getTimer();
         this.switchCategory(const_306);
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_432);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_38,const_45];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_38,const_45];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_670.add(const_38,new Array());
         this.var_670.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_38;
            _loc5_ = this.var_465.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_45;
            _loc5_ = this.var_464.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_234)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_306)
            {
      ...
      {
         return getTimer() < this.var_2622 + const_1536;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_369;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_366 || _loc3_.category == FurniCategory.const_333 || _loc3_.category == FurniCategory.const_334)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_670.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_670.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_1001)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function updateView() : void
      {
         if(this._view != null)
         {
            this.updateGroupItems(const_38);
            this.updateGroupItems(const_45);
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_465.indexOf(_loc2_) == -1)
            {
               this.var_465.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_464.indexOf(_loc2_) == -1)
            {
               this.var_464.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_451:
               return this.var_465.length;
            case UnseenItemCategoryEnum.const_436:
               return this.var_464.length;
            default:
               return this.var_465.length + this.var_464.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_45:
               if(this.var_464 && this.var_464.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_436));
                  this.var_464 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_38:
               if(this.var_465 && this.var_465.length > 0)
               {
