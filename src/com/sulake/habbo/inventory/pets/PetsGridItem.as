package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1604.setSelectedGridItem(this);
               this.var_1603 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1603 = false;
                  this.var_1604.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1474)
         {
            return;
         }
         this.var_1474.color = !!this.var_1489 ? uint(const_1439) : uint(const_1440);
         this.var_2309.visible = param1;
      }
