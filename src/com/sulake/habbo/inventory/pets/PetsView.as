package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_2071:int = 0;
      
      private const const_1053:int = 1;
      
      private const const_1058:int = 2;
      
      private const const_1061:int = 3;
      ...
      private var var_229:IItemGridWindow;
      ...
      private var var_237:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_229 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_237);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_601.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_229.removeGridItem(_loc2_.window);
         if(this.var_237 == _loc2_)
         {
            this.var_237 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_601 == null || this.var_601.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_601.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_601.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_229.addGridItem(_loc2_.window);
            this.var_601.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_237.pet;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowEvent.const_48)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_78.switchToFurnitureCategory(FurniModelCategory.const_45);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_237 != null)
         {
            this.var_237.setSelected(false);
         }
         this.var_237 = param1;
         if(this.var_237 != null)
         {
            this.var_237.setSelected(true);
         }
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1053;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1058;
         }
         else
         {
            _loc2_ = this.const_1061;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1053:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1058:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1061:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc8_ = this._avatarRenderer.createPetImage(param1,param2,_loc7_,AvatarScaleType.const_62,this);
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_57);
               }
               _loc8_.dispose();
            }
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_451) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_436) > 0;
