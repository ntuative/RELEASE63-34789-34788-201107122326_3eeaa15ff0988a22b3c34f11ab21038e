   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_27.toggleInventoryPage(InventoryCategory.const_72,param2);
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1843 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_29,RoomObjectTypeEnum.const_221,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1843 && param1.type == RoomEngineObjectEvent.const_159)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_540.indexOf(_loc2_) == -1)
            {
               this.var_540.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_540 && this.var_540.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_58));
            this.var_540 = [];
            this._view.update();
      ...
      {
         return this.var_540.length;
      }
      
      public function isUnseen(param1:int) : Boolean
      {
         return this.var_540.indexOf(param1) > -1;
      }
   }
}
