package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_488:int = 3;
      ...
      private var var_1960:IWindowContainer;
      
      private var var_834:String;
      
      private var var_2664:IWindowContainer;
      ...
      private const const_2075:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_834);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_391 != null && this.var_391 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_391 || !this.var_27.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_834);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         if(param1 != this.var_391)
         {
            this.resetUnseenCounters(this.var_391);
         }
         ...
         _loc2_.container.removeChild(this.var_1960);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_391 == InventoryCategory.const_137)
            {
               this.toggleCategoryView(InventoryCategory.const_137);
            }
            else if(this.var_391 == InventoryCategory.const_72)
            {
               this.toggleCategoryView(InventoryCategory.const_72);
            }
            else if(this.var_27 != null)
            {
               this.var_27.toggleInventoryPage(InventoryCategory.const_72);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1961)
         {
            this.var_1961 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1961,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_488;
            _loc3_.y = const_488;
         }
         return _loc3_;
      }
