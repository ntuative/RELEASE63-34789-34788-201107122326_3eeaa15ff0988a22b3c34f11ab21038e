package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private var var_78:MarketplaceModel;
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(!param1 || !this._localization || !this._roomEngine || !this.var_78)
         {
            return;
         }
         ...
         this.checkPrice();
         this._localization.registerParameter("inventory.marketplace.make_offer.expiration_info","time",this.var_78.expirationHours.toString());
         this._localization.registerParameter("inventory.marketplace.make_offer.min_price","minprice",this.var_78.offerMinPrice.toString());
         this._localization.registerParameter("inventory.marketplace.make_offer.max_price","maxprice",this.var_78.offerMaxPrice.toString());
         ...
         this.var_2552 = this._localization.getKey(_loc5_);
      ...
      {
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",this.var_2552);
         this._localization.registerParameter("inventory.marketplace.confirm_offer.info","price",this.var_1881.toString());
      ...
      private function confirmationCallback(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            this.var_78.makeOffer(this.var_1881);
         }
         this.var_78.releaseItem();
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "buy_tokens_button":
                  this.var_78.buyMarketplaceTokens();
                  this.disposeView();
                  break;
               ...
               case "make_offer_button":
                  ...
                  if(_loc3_ != null)
                  {
                     this.var_1881 = parseInt(_loc3_.text);
      ...
      {
         var _loc1_:* = null;
         if(false && "AvatarEditorGridColorItem" == this._config.getKey("client.credits.embed.enabled"))
         {
      ...
      private function checkPrice() : void
      {
         ...
         if(_loc2_ > this.var_78.offerMaxPrice)
         {
            _loc1_.text = this.var_78.offerMaxPrice.toString();
            _loc2_ = this.var_78.offerMaxPrice;
         }
         var _loc3_:int = Math.max(Math.ceil(this.var_78.commission * 0.01 * _loc2_),1);
         ...
         if(_loc2_ < this.var_78.offerMinPrice)
         {
      ...
      {
         if(!this._view || !this._localization || !this.var_78)
         {
            return;
         }
         ...
         var _loc4_:int = Math.floor(param1 / (1 + this.var_78.commission * 0.01));
