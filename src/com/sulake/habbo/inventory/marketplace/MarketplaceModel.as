package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_252 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_252.id);
            this.var_252 = null;
         }
      }
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2358 = _loc2_;
         this.var_2361 = this.var_252.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_2080,this.var_2081);
         }
      }
      ...
      {
         if(param1 != this.var_2358 || param2 != this.var_2361)
         {
            return;
         }
         if(!this._view)
