package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_591:int = 0;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_397 = param5;
         this.var_397.events.addEventListener(BadgeImageReadyEvent.const_237,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_397.events.removeEventListener(BadgeImageReadyEvent.const_237,this.onBadgeImageReady);
            this.var_397 = null;
         }
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_855[_loc2_] == param1)
            {
               this.var_855.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1326.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_706.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_397.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_256.unshift(_loc11_);
            }
            else
            {
               this.var_256.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_368);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_256.length)
         {
            _loc3_ = this.var_256[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_591);
         ...
         var _loc3_:Array = this.getBadges(const_368);
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case const_591:
               _loc2_ = new Array();
               for each(_loc3_ in this.var_256)
               {
                  if(!_loc3_.isInUse)
                  {
                     _loc2_.push(_loc3_);
      ...
      {
         return this.getItemInIndex(param1,const_368);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_591);
      }
      ...
      {
         if(param1 == InventoryCategory.const_225 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_706.indexOf(_loc2_) == -1)
            {
               this.var_706.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_706 && this.var_706.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1225));
            this.var_706 = [];
