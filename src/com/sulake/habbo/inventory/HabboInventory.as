package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2351:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_64)
         {
            _loc1_ = this.var_64.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_64.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_585,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_64.getValue(InventoryCategory.const_72));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_64.getValue(InventorySubCategory.const_369));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_64.getValue(InventoryCategory.const_161));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_64.getValue(InventoryCategory.const_225));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_64.getValue(InventorySubCategory.const_1357));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_64.getValue(InventoryCategory.const_137));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_64.getValue(InventoryCategory.const_432) as MarketplaceModel;
      }
      ...
      {
         return this.var_115.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_115.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_115.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_115.clubHasEverBeenMember;
      }
      
      public function get clubIsExpiring() : Boolean
      {
         return this.var_115.clubIsExpiring;
      }
      ...
      {
         this.var_115.clubPeriods = param1;
         this.var_115.clubDays = param2;
         this.var_115.clubHasEverBeenMember = param3;
         this.var_115.isVIP = param4;
         this.var_115.clubIsExpiring = param5;
      ...
      {
         this.var_397 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_82,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_585,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_82:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_585:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_397 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_64.add(InventoryCategory.const_432,_loc1_);
         ...
         this.var_64.add(InventoryCategory.const_72,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_397);
         this.var_64.add(InventoryCategory.const_225,_loc3_);
         ...
         this.var_64.add(InventoryCategory.const_161,_loc4_);
         ...
         this.var_64.add(InventorySubCategory.const_369,_loc5_);
         ...
         this.var_64.add(InventorySubCategory.const_1357,_loc6_);
         ...
         this.var_64.add(InventoryCategory.const_137,_loc7_);
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_64.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         {
            _loc3_ = this.var_64.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_369:
               this._view.toggleCategoryView(InventoryCategory.const_72,false);
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = this.var_64.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_982.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      {
         var _loc2_:IInventoryModel = this.var_64.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2351);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_252));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2469)
         {
            this.var_2469 = _loc1_;
