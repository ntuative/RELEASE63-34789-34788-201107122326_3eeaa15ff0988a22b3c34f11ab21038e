package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1106:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1583:String = "sendAccessTokenToServer";
      
      private static const const_1584:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1583,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1584,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1106);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1106);
         }
      }
