package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1817:GroupDetailsView;
      
      private var var_2457:Boolean;
      
      private var var_2459:Boolean;
      
      private var var_1292:Dictionary;
      
      private var var_644:ProductDataParser;
      ...
      private var var_326:FurnitureDataParser;
      
      private var var_1819:UserTagManager;
      
      private var var_1203:BadgeImageManager;
      
      private var var_1204:HabboGroupInfoManager;
      
      private var var_976:IgnoredUsersManager;
      ...
      private var var_1200:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3076 = [];
         this.var_1819 = new UserTagManager(events);
         this.var_1204 = new HabboGroupInfoManager(this,events);
         this.var_976 = new IgnoredUsersManager(this);
         this.var_1200 = new FaceBookSession();
         this.var_1292 = new Dictionary();
         this.var_1202 = [];
         this.var_977 = [];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_326)
         {
            this.var_326.removeEventListener(FurnitureDataParser.const_139,this.onFurnitureReady);
            this.var_326.dispose();
            this.var_326 = null;
         }
         if(this.var_644)
         {
            this.var_644.removeEventListener(ProductDataParser.const_139,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         if(this.var_141 == null || this._localization == null)
         {
            return;
         }
         this.var_1203 = new BadgeImageManager(context.root.assets,events,this.var_141,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1819.communication = this._communication;
         this.var_1204.communication = this._communication;
         this.var_1200.communication = this._communication;
         this.var_976.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_326)
         {
            ...
            this.var_326 = new FurnitureDataParser(this.var_533,this._wallItems,this.var_534,this._localization);
            this.var_326.addEventListener(FurnitureDataParser.const_139,this.onFurnitureReady);
            if(this.var_141.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_141.getKey("furnidata.load.url");
               this.var_326.loadData(_loc3_);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(this.var_326)
         {
            this.var_326.localization = this._localization;
            this.var_326.registerFurnitureLocalizations();
         }
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_1820 = _loc2_.clubLevel;
         this.var_1818 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2526 = _loc3_.respectTotal;
         this.var_1201 = _loc3_.respectLeft;
         this.var_790 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_1020 = _loc3_.sex;
         this.var_1754 = _loc3_.realName;
         this.var_2458 = _loc3_.identityId;
         this.var_976.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_1020 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_1020));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2457 = _loc2_.isOpen;
         this.var_2459 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1818 >= SecurityLevelEnum.const_1238;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1819.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1203.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1203.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1817 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1204.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1817.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1204.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1204.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1203.getBadgeImage(param1,BadgeImageManager.const_1229);
      }
      ...
      {
         return this.var_976.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_976.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_976.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1201 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1201 = this.var_1201 - 1;
      }
      
      public function givePetRespect(param1:int) : void
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_790 < 1 || _loc2_ == null)
         {
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_534.getValue(param1);
      ...
      public function openHabboHomePage(param1:int) : void
      {
         ...
         {
            urlString = this.var_141.getKey("link.format.userpage");
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         {
            _loc2_ = this.var_141.getKey("productdata.load.url");
            this.var_644 = new ProductDataParser(_loc2_,this.var_1292);
            this.var_644.addEventListener(ProductDataParser.const_139,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_977.indexOf(param1) == -1)
            {
