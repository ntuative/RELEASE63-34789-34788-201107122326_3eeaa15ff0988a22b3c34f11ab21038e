package com.sulake.habbo.session
{
   ...
   public class IgnoredUsersManager
   {
      ...
      private var var_33:SessionDataManager;
      ...
      {
         var _loc1_:IConnection = this.var_33.communication.getHabboMainConnection(null);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         var _loc1_:IConnection = this.var_33.communication.getHabboMainConnection(null);
         _loc1_.send(new GetIgnoredUsersMessageComposer(this.var_33.userName));
      }
      ...
      private function onIgnoreResult(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:String = String(this.var_1602.shift());
      ...
      {
         this.var_1602.push(param1);
         var _loc2_:IConnection = this.var_33.communication.getHabboMainConnection(null);
