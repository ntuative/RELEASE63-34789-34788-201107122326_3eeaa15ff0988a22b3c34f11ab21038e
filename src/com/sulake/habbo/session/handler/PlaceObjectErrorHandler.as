      ...
      private function onPlaceObjectError(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.errorCode)
         {
            case PlaceObjectErrorEnum.const_271:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_262:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_316:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_236:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_247:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_286:
               _loc4_ = "null";
               break;
            case PlaceObjectErrorEnum.const_273:
               _loc4_ = "null";
               break;
            default:
               return;
