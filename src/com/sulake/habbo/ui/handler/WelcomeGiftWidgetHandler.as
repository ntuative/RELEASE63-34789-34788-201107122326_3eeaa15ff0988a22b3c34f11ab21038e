package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_666;
      }
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_778 = [];
         this.var_778.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_778.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_778)
         {
            return;
         }
         for each(_loc1_ in this.var_778)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_1017);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_890);
         return _loc1_;
      }
