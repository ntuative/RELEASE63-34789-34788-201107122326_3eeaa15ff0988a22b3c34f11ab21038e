package com.sulake.habbo.ui.handler
{
   ...
   public class EffectsWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         {
            this._container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_252,this.onEffectsChanged);
         }
         this._container = param1;
         if(this._container != null)
         {
            this._container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_252,this.onEffectsChanged);
         }
      }
      ...
      {
         return [RoomWidgetRequestWidgetMessage.const_444];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_444:
               this._widget.open();
         }
         return null;
      }
