package com.sulake.habbo.ui.handler
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         {
            this._container.sessionDataManager.events.removeEventListener(UserNameUpdateEvent.const_851,this.onUserNameUpdate);
         }
         ...
         if(this._container && this._container.sessionDataManager && this._container.sessionDataManager.events)
         {
            this._container.sessionDataManager.events.addEventListener(UserNameUpdateEvent.const_851,this.onUserNameUpdate);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_949);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionUserDataUpdateEvent.const_138);
         _loc1_.push(RoomSessionDanceEvent.const_180);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_949:
               this.dispatchOwnAvatarInfo();
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserDataUpdateEvent.const_138:
               this._container.events.dispatchEvent(new RoomWidgetUserDataUpdateEvent());
               break;
            case RoomSessionDanceEvent.const_180:
