package com.sulake.habbo.ui.handler
{
   ...
   public class VoteWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionVoteEvent.const_173);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionVoteEvent.const_173:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_173,_loc2_.question,_loc2_.choices);
               break;
