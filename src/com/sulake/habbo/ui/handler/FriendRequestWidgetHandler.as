package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_760);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_749);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_917);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_760:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_749:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_917:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_146);
         _loc1_.push(FriendRequestEvent.const_60);
         _loc1_.push(FriendRequestEvent.const_230);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_146:
            ...
            case FriendRequestEvent.const_230:
