package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_244.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_244.events.addEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_195,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_237,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_190,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_115,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_195,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_237,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_190,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_115,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_654.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_654.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_244 != null)
         {
            this.var_244.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_244.events.removeEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
            this.var_244 = null;
         }
         this.var_1150 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_610);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_1027);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_514);
         _loc1_.push(RoomWidgetUserActionMessage.const_587);
         _loc1_.push(RoomWidgetUserActionMessage.const_450);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_796);
         _loc1_.push(RoomWidgetFurniActionMessage.const_249);
         _loc1_.push(RoomWidgetFurniActionMessage.const_978);
         _loc1_.push(RoomWidgetFurniActionMessage.const_922);
         _loc1_.push(RoomWidgetFurniActionMessage.const_737);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1228);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_928);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_1003);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_809);
         _loc1_.push(RoomWidgetUserActionMessage.const_593);
         _loc1_.push(RoomWidgetUserActionMessage.const_664);
         _loc1_.push(RoomWidgetUserActionMessage.const_665);
         _loc1_.push(RoomWidgetUserActionMessage.const_2036);
         _loc1_.push(RoomWidgetPetCommandMessage.const_502);
         _loc1_.push(RoomWidgetPetCommandMessage.const_989);
         _loc1_.push(RoomWidgetUserActionMessage.const_645);
         _loc1_.push(RoomWidgetUserActionMessage.const_287);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_847);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_593)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_287 || param1.type == RoomWidgetUserActionMessage.const_645 || param1.type == RoomWidgetUserActionMessage.const_665)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_610:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_1027:
            ...
            case RoomWidgetUserActionMessage.const_547:
               ...
               break;
            case RoomWidgetUserActionMessage.const_645:
               this._container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_598:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1261,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_514:
            ...
            case RoomWidgetUserActionMessage.const_587:
               ...
               break;
            case RoomWidgetUserActionMessage.const_450:
            ...
            case RoomWidgetUserActionMessage.const_609:
               ...
               break;
            case RoomWidgetUserActionMessage.const_796:
            ...
            case RoomWidgetUserActionMessage.const_665:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_978:
            ...
            case RoomWidgetFurniActionMessage.const_1228:
               ...
               break;
            case RoomWidgetUserActionMessage.const_287:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_928:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_1003:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_809:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_307);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_352);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_439) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_439);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_808) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1300;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_307);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1294);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1208);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_601)
                  {
                     _loc30_ = this.var_244.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_441) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_441.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_244.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_221)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_131)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_653)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_370);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_117)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_168)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_950);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_985;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_993;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1735);
               }
               else
               {
               ...
               _loc19_ = _loc12_.sex;
               _loc20_ = this._container.avatarRenderManager.createAvatarImage(_loc18_,AvatarScaleType.const_62,_loc19_);
               if(_loc20_ != null)
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_145];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_145:
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         {
            _loc5_ = this._container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_62,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_654.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_654.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_950);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc4_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_62,null);
            if(_loc4_ != null)
            {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_244 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_244.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_402,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_244 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_403,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
