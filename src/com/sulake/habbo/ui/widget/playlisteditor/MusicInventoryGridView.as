package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_640:IItemGridWindow;
      ...
      public function destroy() : void
      {
         ...
         {
            this.var_640.destroyGridItems();
            this.var_640 = null;
         }
         if(this.var_244 != null)
         {
            if(this.var_244.events != null)
            {
      ...
      public function refresh() : void
      {
         ...
         this.var_640.removeGridItems();
         var _loc1_:Map = this._items;
         var _loc2_:Map = new Map();
         var _loc3_:Array = _loc1_.getKeys();
         this._items = new Map();
         var _loc4_:int = this.var_244.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_244.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_244.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_244.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
            ...
            this.var_640.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_112.playButtonState = MusicInventoryGridItem.const_1239;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_112 != null)
         {
            this.var_112.playButtonState = MusicInventoryGridItem.const_497;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_112.playButtonState == MusicInventoryGridItem.const_497)
               {
                  this.var_112.playButtonState = MusicInventoryGridItem.const_1211;
            ...
            {
               _loc4_ = this.var_640.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
