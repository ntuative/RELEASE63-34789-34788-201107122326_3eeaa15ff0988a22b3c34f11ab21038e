package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_893:String = "PLSV_ADD_SONGS";
      
      public static const const_1320:String = "PLSV_START_PLAYBACK";
      
      public static const const_568:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_568)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_453[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_453[const_893];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_453.add(const_568,_loc1_);
