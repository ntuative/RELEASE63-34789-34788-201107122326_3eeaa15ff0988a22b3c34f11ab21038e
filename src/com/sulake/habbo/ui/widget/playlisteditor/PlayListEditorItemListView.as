package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorItemListView
   {
      ...
      private var var_112:PlayListEditorItem;
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_505);
            }
            return;
         }
         ...
         if(this.var_1314 >= 0 && this.var_1314 < this._items.length)
         {
            _loc2_ = this._items[this.var_1314] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_505);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1168);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_remove_from_playlist" || _loc3_)
            {
               ...
               if(this.var_1051 > -1)
               {
                  this._widget.sendRemoveFromPlayListMessage(this.var_1051);
               }
               this.var_112 = null;
               this.var_1051 = -1;
            }
            else
            {
               ...
               if(_loc4_ != -1)
               {
                  this.var_1051 = _loc4_;
                  this.var_112 = this._items[_loc4_];
                  this.var_112.select();
