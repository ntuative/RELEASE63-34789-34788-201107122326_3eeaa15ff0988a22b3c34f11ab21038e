package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_997:MeMenuSoundSettingsSlider;
      
      private var var_1000:BitmapData;
      
      private var var_999:BitmapData;
      
      private var var_998:BitmapData;
      ...
      {
         this.var_996 = param1.volume;
         if(this.var_997 != null)
         {
            this.var_997.setValue(this.var_996);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1000 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_999 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_998 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1001 = (_loc5_.content as BitmapData).clone();
         }
         this.var_997 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_951));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_996 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1001);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1000);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_998);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_999);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_912);
         }
