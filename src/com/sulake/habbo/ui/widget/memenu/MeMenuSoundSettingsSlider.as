package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_2040:MeMenuSoundSettingsView;
      ...
      private var var_1164:Number = 1.0;
      ...
      {
         return param1 / this.var_1734 * (this.var_1164 - this._minValue) + this._minValue;
      }
      
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type != WindowEvent.const_435)
         {
            return;
         }
         this.var_2040.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_762 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_762.width,this.var_762.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_762,this.var_762.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_763 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_763.width,this.var_763.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_763,this.var_763.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1734 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
