package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1515:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_195.state = RoomChatHistoryPulldown.const_276;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_195.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_276);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_195.state == RoomChatHistoryPulldown.const_454 || this.var_195.state == RoomChatHistoryPulldown.const_493;
      }
      ...
      {
         if(!this.var_455 && !this.var_1875)
         {
            this.var_455 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_195.state = RoomChatHistoryPulldown.const_454;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_53 != null)
         {
            ...
            if(param2)
            {
               this.var_53.scrollV = this.var_658;
            }
         }
         if(this.var_195 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_456 > 0 && param2)
         {
            if(this.var_1882)
            {
               if(Math.abs(param1 - this.var_456) <= const_1241)
               {
                  return;
               }
               this.var_1882 = false;
            ...
            if(this.var_455)
            {
               ...
               _loc5_ = (param1 - this.var_456) / this.var_53.height;
               _loc3_ = this.var_658 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_456;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_53.scrollV < 1 - const_1515 / this.var_53.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1883)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_53 != null)
         {
            this.var_658 = this.var_53.scrollV;
         }
         if(this.var_53 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_658 - this.var_53.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
