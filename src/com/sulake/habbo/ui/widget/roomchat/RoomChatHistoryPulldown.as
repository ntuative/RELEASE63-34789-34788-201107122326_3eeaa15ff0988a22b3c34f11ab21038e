package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_1070:int = 3;
      
      public static const const_493:int = 2;
      
      public static const const_454:int = 1;
      
      public static const const_276:int = 0;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_41 = param3;
         this.var_2289 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1737 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2290 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1735 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1736 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2286 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2287 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_83 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_359,HabboWindowStyle.const_31,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_91),null,0,0) as IBitmapWrapperWindow;
         this.var_41.addChild(this.var_83);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_71,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_41.height - const_91,param3.width,const_91),null,0) as IWindowContainer;
         this.var_41.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_365,HabboWindowStyle.const_47,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_91),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_493:
               this.var_83.blend += param1 / const_1047;
               this._window.blend += param1 / const_1047;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_454:
               if(this._state == const_276)
               {
                  this.state = const_493;
               }
               else
               {
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_41.width - this.var_2285;
         }
         if(this.var_83 != null)
         {
            this.var_83.rectangle = this.var_41.rectangle;
            this.var_83.height -= const_91;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2288 == this._window.width)
         {
            return;
         }
         this.var_2288 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2290;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1735;
            barX.disposesBitmap = false;
            this.var_2285 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2289,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1737,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1737,destGripRBitmap);
         ...
         this.var_83.bitmap = this.var_2287;
