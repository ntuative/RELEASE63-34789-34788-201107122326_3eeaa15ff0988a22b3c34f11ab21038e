package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1995:String = "POLL_OFFER_STATE_OK";
      
      public static const const_844:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_112:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_112)
         {
            return;
         }
         this._state = const_1995;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_734,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._state = const_844;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_660,this._id));
