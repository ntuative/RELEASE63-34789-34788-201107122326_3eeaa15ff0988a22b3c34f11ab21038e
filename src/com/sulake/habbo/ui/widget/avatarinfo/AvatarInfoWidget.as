package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1074:String = "use_minimized_own_avatar_menu";
      ...
      private var var_243:AvatarInfoData;
      ...
      private var var_3077:Boolean;
      
      private var var_801:AvatarInfoView;
      
      private var var_799:OwnAvatarMenuView;
      
      private var var_800:AvatarMenuView;
      
      private var var_382:Map;
      
      private var var_2516:Boolean = false;
      
      private var var_1853:Boolean = true;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_22 = param6;
         this.var_141 = param4;
         this.var_243 = new AvatarInfoData();
         this.var_2515 = Boolean(this.var_141.getBoolean("menu.avatar.enabled",false));
         this.var_1856 = this.var_141.getBoolean("menu.own_avatar.enabled",false);
         this.var_382 = new Map();
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_201,this.onRoomObjectAdded);
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_428,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_252,this.onEffectsChanged);
         this.handler.widget = this;
      }
      
      public function get handler() : AvatarInfoWidgetHandler
      {
         return var_942 as AvatarInfoWidgetHandler;
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_949,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_382)
         {
            _loc1_.dispose();
         }
         this.var_382 = null;
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_201,this.onRoomObjectAdded);
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_428,this.onRoomObjectRemoved);
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_252,this.onEffectsChanged);
         this._view = null;
         this.var_141 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_385,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_198,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_499,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_1032,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_385,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_198,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_499,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_123:
               ...
               if(this.var_1856 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_499:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_385:
               this.var_1853 = true;
               break;
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_352:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_1032:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1855 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_1027,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_443:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1855)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_168:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_131,false,!!_loc3_.isSpectatorMode ? null : this.var_243);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_653,false,null);
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_198:
               ...
               for each(_loc7_ in this.var_382)
               {
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_375,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      {
         this.var_243.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_243.amIController = param1.amIController;
         this.var_243.amIOwner = param1.amIOwner;
         this.var_243.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_243.canBeKicked = param1.canBeKicked;
         this.var_243.canTrade = param1.canTrade;
         this.var_243.canTradeReason = param1.canTradeReason;
         this.var_243.hasFlatControl = param1.hasFlatControl;
         this.var_243.isIgnored = param1.isIgnored;
         this.var_243.respectLeft = param1.respectLeft;
         this.var_243.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_117;
         this.var_243.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1856) : Boolean(this.var_2515);
         }
            ...
            if(!this.var_1854)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_799)
                     {
                        this.var_799 = new OwnAvatarMenuView(this);
                     }
                  ...
                  else
                  {
                     ...
                     for each(_loc8_ in this.var_382)
                     {
               ...
               else
               {
                  if(!this.var_801)
                  {
                     this.var_801 = new AvatarInfoView(this);
                  }
                  this._view = this.var_801;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_382.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_382.length > 0)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc3_ in this.var_382)
         {
      ...
      {
         return this.handler.container.config.getBoolean(const_1074,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1074,!!param1 ? "1" : "0");
      }
   }
}
