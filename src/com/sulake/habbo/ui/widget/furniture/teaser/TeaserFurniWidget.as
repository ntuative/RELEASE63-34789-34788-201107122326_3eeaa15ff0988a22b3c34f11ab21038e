package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2106:int = 0;
      
      private const const_2104:int = 1;
      
      private const const_2101:int = 2;
      
      private const const_2102:int = 3;
      
      private const const_2100:int = 4;
      
      private const const_2379:int = 0;
      
      private const const_2375:int = 1;
      
      private const const_2380:int = 2;
      
      private const const_2378:int = 3;
      
      private const const_2374:int = 4;
      
      private const const_2373:int = 5;
      
      private const const_2105:String = "deco_img";
      
      private const const_2103:String = "dialog_bg";
      
      private const const_2377:String = "%campaign%_dialog_bg.png";
      
      private const const_394:String = "%campaign%_gift_package.png";
      
      private const const_2381:String = "%campaign%_gift_content.png";
      
      private const const_2376:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1671 = this.var_151.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1671 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1674.length)
         {
            _loc2_ = this.var_1674.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_151 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_581,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_1012,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_793,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_581,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_581:
               _loc2_ = this.const_2106;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_793:
               ...
               {
                  _loc2_ = this.const_2100;
               }
               this._shareId = null;
               this.var_1672 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1673 != _loc2_ || _loc3_ != this.var_208))
         {
            this._window.dispose();
            this._window = null;
         }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1673)
            {
               case this.const_2106:
               ...
               case this.const_2104:
                  if(this.var_430 == this.const_2379)
                  {
                  ...
                  else if(this.var_430 == this.const_2375)
                  {
                     ...
                     _loc2_ = this.const_2381;
                  }
                  else if(this.var_430 == this.const_2380)
                  {
                  ...
                  else if(this.var_430 == this.const_2378)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_430 == this.const_2374)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_208,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_430 == this.const_2373)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2377.replace("%campaign%",this.var_208);
            this.setDecoImage(_loc5_,this.const_2103);
            _loc2_ = _loc2_.replace("%campaign%",this.var_208);
            this.setDecoImage(_loc2_,this.const_2105);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_1008);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_194);
         ...
         if(this.var_12)
         {
            if(this.var_1672 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1672 == 1 ? "null" : InventoryCategory.const_137);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_761,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1674.push(new ImageDownloader(this,_assets,this.var_208,this.var_1671,param1,param2));
            return;
         }
