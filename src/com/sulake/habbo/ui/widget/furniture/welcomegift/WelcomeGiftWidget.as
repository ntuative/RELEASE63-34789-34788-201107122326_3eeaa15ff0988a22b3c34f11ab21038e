package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_1084:String = "welcome_gift_email_verified";
      
      private const const_1537:String = "welcome_gift_email_change";
      
      private const const_2361:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1263)
         {
            this.setViewState(this.const_1084);
         }
         else
         {
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_697:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1015;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1015);
               break;
            case this.const_1084:
            ...
            case this.const_1537:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1015);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1529;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1537);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_1017,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1263 ? this.const_1084 : this.const_697);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1528 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1528));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_519,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_954,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_519,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_954,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_519:
               this.var_1529 = param1.email;
               this.var_1263 = param1.isVerified;
               this.var_1015 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1529 = this.var_1528;
            this.setViewState(this.const_697);
         }
         else
         {
            if(param1.result == this.const_2361)
            {
               this.var_1015 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1528);
