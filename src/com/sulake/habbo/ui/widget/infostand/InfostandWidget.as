package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_2081:String = "infostand_user_view";
      
      private const const_2079:String = "infostand_furni_view";
      
      private const const_2076:String = "infostand_pet_view";
      
      private const const_2080:String = "infostand_bot_view";
      
      private const const_2077:String = "infostand_jukebox_view";
      
      private const const_2078:String = "infostand_songdisk_view";
      
      private var var_1237:InfoStandFurniView;
      
      private var var_196:InfoStandUserView;
      
      private var var_383:InfoStandPetView;
      
      private var var_457:InfoStandBotView;
      
      private var var_1005:InfoStandJukeboxView;
      
      private var var_1004:InfoStandSongDiskView;
      
      private var var_2562:Array;
      
      private var var_1510:InfostandUserData;
      
      private var var_670:InfostandFurniData;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1237 = new InfoStandFurniView(this,this.const_2079,this._catalog);
         this.var_196 = new InfoStandUserView(this,this.const_2081);
         this.var_383 = new InfoStandPetView(this,this.const_2076,this._catalog);
         this.var_457 = new InfoStandBotView(this,this.const_2080);
         this.var_1005 = new InfoStandJukeboxView(this,this.const_2077,this._catalog);
         this.var_1004 = new InfoStandSongDiskView(this,this.const_2078,this._catalog);
         this.var_1510 = new InfostandUserData();
         this.var_670 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_175 = new Timer(this.const_2359);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_385,this.onRoomObjectSelected);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_1021,this.onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_115,this.onPetInfo);
         param1.addEventListener(RoomWidgetPetCommandsUpdateEvent.PET_COMMANDS,this.onPetCommands);
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_402,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_385,this.onRoomObjectSelected);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_1021,this.onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_115,this.onPetInfo);
         param1.removeEventListener(RoomWidgetPetCommandsUpdateEvent.PET_COMMANDS,this.onPetCommands);
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_402,this.onSongUpdate);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_287,this.var_383.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_2081);
         if(this.var_175)
         {
            this.var_175.stop();
         }
      ...
      {
         this.userData.setData(param1);
         this.var_457.update(param1);
         this.selectView(this.const_2080);
         if(this.var_175)
         {
            this.var_175.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_441) != -1)
         {
            ...
            this.selectView(this.const_2078);
         }
         else
         {
            this.var_1237.update(param1);
            this.selectView(this.const_2079);
         }
         if(this.var_175)
         {
            this.var_175.stop();
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_383.update(this.petData);
      ...
      {
         this.var_383.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         if(param1.isOwnUser)
         {
            this.var_196.setTags(param1.tags);
         }
         else
         {
            this.var_196.setTags(param1.tags,this.var_2562);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_457.image = param1.image;
         }
         else
         {
            this.var_196.image = param1.image;
            this.var_196.setMotto(param1.customInfo,param1.isOwnUser);
            this.var_196.achievementScore = param1.achievementScore;
         }
      }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_457.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
               this.var_196.setBadgeImage(_loc2_,param1.badgeImage);
            }
            return;
         }
         if(param1.badgeID == this.userData.groupBadgeId)
         {
            this.var_196.setGroupBadgeImage(param1.badgeImage);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_149:
               _loc2_ = param1.id == this.var_670.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_198:
               if(this.var_196 != null && this.var_196.window != null && this.var_196.window.visible)
               {
                  _loc2_ = param1.id == this.var_1510.userRoomId;
                  break;
               }
               ...
               if(this.var_457 != null && this.var_457.window != null && this.var_457.window.visible)
               {
                  _loc2_ = param1.id == this.var_1510.userRoomId;
                  break;
               }
