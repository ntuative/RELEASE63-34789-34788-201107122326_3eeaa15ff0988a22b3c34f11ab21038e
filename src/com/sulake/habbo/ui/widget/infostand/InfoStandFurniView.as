package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_268 = this.var_47.findChildByTag("catalog");
         if(this.var_268 != null)
         {
            this.var_268.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1300 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_601 && param1.isRoomOwner)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc6_.addEventListener(WindowKeyboardEvent.const_197,this.adElementKeyEventProc);
                  }
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1321.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_55.addListItem(this.var_268);
            }
            this.var_268.visible = param1;
         }
         else
         {
            this.var_55.removeListItem(this.var_268);
         }
      }
   }
}
