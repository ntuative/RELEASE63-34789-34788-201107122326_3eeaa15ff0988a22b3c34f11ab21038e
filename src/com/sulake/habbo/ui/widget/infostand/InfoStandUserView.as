package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1128:TagListRenderer;
      
      private var var_156:IBorderWindow;
      
      private var var_2541:int;
      
      private var var_2540:Boolean = true;
      
      private const const_1077:int = 5;
      
      private const const_2355:int = 3;
      
      private const const_1505:int = 11184810;
      
      private const const_1504:int = 16777215;
      
      private const const_2358:int = 2000;
      
      private const const_2357:int = 50;
      
      private const const_2356:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1128 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2540 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_156.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_156.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_156.x = _loc5_.left - this.var_156.width;
         this.var_156.y = _loc5_.top + (_loc5_.height - this.var_156.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_156.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_156.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_156.x = _loc7_.left - this.var_156.width;
         this.var_156.y = _loc7_.top + (_loc7_.height - this.var_156.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_156 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_156 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1077;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc5_.textColor = this.const_1504;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1077,this.const_2357);
         _loc5_.height = Math.max(_loc5_.height,this.const_2356);
         _loc3_.height = _loc5_.height + this.const_2355;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_325,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_325,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1128.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_985:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2541 > this.const_2358 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2541 = _loc6_;
               _loc3_.textColor = this.const_1504;
            }
         }
         else
         {
