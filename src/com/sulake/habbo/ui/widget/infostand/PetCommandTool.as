package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_447:IFrameWindow;
      
      private var var_1211:Map;
      ...
      private const const_2353:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1211 = new Map();
         this.var_377 = new Timer(this.const_2353);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1211.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_538);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1211.getValue(this.var_538) as CommandConfiguration;
      ...
      {
         this.var_1211.remove(param1);
         this.var_1211.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_989,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_42.setParamFlag(WindowParam.const_101,true);
         this.var_42.context.getDesktopWindow().addEventListener(WindowEvent.const_40,this.onWindowDesktopResized);
         this.var_42.procedure = this.onCommandWindowProcedure;
         this.var_42.position = const_1467;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_447 == null)
         {
            ...
            this.var_447 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_447 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_447.x = 200;
            this.var_447.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_287,this.var_538));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_502,this.var_538,this.var_1831 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_502,this.var_538,this.var_1831 + " " + _loc5_);
