package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1668:int = 162;
      
      private static const const_1667:int = 16;
      
      private static const const_719:int = 4;
      
      private static const const_1665:uint = 14342874;
      
      private static const const_1666:uint = 3815994;
      
      private static const const_1669:uint = 2085362;
      
      private static const const_1677:uint = 39616;
      
      private static const const_1673:uint = 10513106;
      
      private static const const_1674:uint = 8734654;
      
      private static const const_1670:uint = 9094430;
      
      private static const const_1678:uint = 6200576;
      
      private static const const_1671:String = "happiness";
      
      private static const const_1672:String = "experience";
      
      private static const const_1676:String = "energy";
      
      private static const const_1675:int = 250;
      ...
      private var var_233:PetCommandTool;
      ...
      {
         if(this.var_55 == null || this.var_47 == null || this.var_109 == null)
         {
            return;
         }
         this.var_109.width = this.var_109.width;
         this.var_109.visible = this.var_109.width > 0;
         this.var_55.height = this.var_55.scrollableRegion.height;
         this.var_47.height = this.var_55.height + 20;
         this._window.width = Math.max(this.var_47.width,this.var_109.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this.var_109.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1671,param1.nutrition,param1.nutritionMax,const_1677,const_1669);
         this.updateStateElement(const_1672,param1.experience,param1.experienceMax,const_1674,const_1673);
         this.updateStateElement(const_1676,param1.energy,param1.energyMax,const_1678,const_1670);
         ...
         this.updateWindow();
         this.var_538 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_233 && this.var_233.isVisible() && param1.isOwnPet)
         {
            this.var_233.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_233.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1668,const_1667,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1665);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1666);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_719,_loc7_.width - 2,_loc7_.height - 2 - const_719);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_719);
      ...
      private function openTrainView() : void
      {
         if(this.var_233 == null)
         {
            this.var_233 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_538) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_233.showWindow(true);
            this.var_233.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc4_:* = [];
         this.var_109.groupChildrenWithTag("CMD_BUTTON",_loc4_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_233 && this.var_233.getPetId() == this.var_538)
               {
                  this.var_233.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1783,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_450,this._widget.petData.ownerId);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:int = const_1675;
         this.var_109.width = _loc1_;
         var _loc2_:* = [];
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1147 + const_1148;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1148;
            }
         }
         this.var_109.height = _loc4_ + const_1147;
         this.updateWindow();
      }
   }
}
