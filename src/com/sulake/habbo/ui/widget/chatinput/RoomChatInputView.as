package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1482:int = 250;
      
      private static const const_1483:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1481:String = "${widgets.chatinput.say}";
      ...
      private var var_1838:IWindow;
      
      private var _button:IWindow;
      
      private var var_1839:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1214 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2478 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2479 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_379 = new Timer(1000,1);
         this.var_379.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_450 = new Timer(10000,1);
         this.var_450.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_450.reset();
            this.var_450.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_450 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1838 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1839 = this._window.findChildByName("send_button_text");
         this.var_1495 = this._window.findChildByName("block_text");
         this.var_1839.caption = const_1481;
         ...
         this.var_26.addEventListener(WindowKeyboardEvent.const_325,this.keyUpHandler);
         this.var_26.addEventListener(WindowEvent.const_114,this.onInputChanged);
         ...
         this._window.addEventListener(WindowEvent.const_646,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1838.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1482 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1483);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_26 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1214 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_26.text = "";
                  this.var_649 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_649.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_648);
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_128);
