package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1233:IRoomWidgetFactory;
      ...
      private var var_1660:IHabboAvatarEditor = null;
      ...
      private var var_1246:IHabboHelp;
      
      private var var_1101:IHabboModeration;
      ...
      private var var_1363:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1654 = RoomDesktop.const_644;
         super(param1,param2,param3);
         var _loc4_:RoomWidgetFactory = new RoomWidgetFactory(this,0,param3);
         this.var_1233 = _loc4_;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1246.release(new IIDHabboHelp());
            this.var_1246 = null;
         }
         ...
         {
            this.var_1101.release(new IIDHabboModeration());
            this.var_1101 = null;
         }
         ...
         if(this.var_1363)
         {
            this.var_1363.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1363 = null;
         }
         this.var_1660 = null;
         ...
         if(this.var_352)
         {
            while(this.var_352.length > 0)
            {
               _loc1_ = this.var_352.getKey(0) as String;
               _loc2_ = this.var_352.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1660 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_351 != null && this.var_351.events != null)
         {
            this.var_351.events.addEventListener(InterstitialEvent.const_551,this.interstitialCompleteEventHandler);
            this.var_351.events.addEventListener(InterstitialEvent.const_572,this.adEventHandler);
            this.var_351.events.addEventListener(AdEvent.const_557,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1246 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1101 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1101);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_264,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_222,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_565,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserBadgesEvent.const_145,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_130,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_150,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_60,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_350,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_595,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_662,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_984,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1233,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1332,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_316,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_822,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_583,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_173,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_606,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_146,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDanceEvent.const_180,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_264:
               this.createDesktop(param1.session);
               break;
            case RoomSessionEvent.const_77:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_824);
               break;
            case RoomSessionEvent.const_82:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_868);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_262:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_984:
               errorMessage = "${room.error.cant_set_not_owner}";
               break;
            case RoomSessionErrorMessageEvent.const_316:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_2933);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1363 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_191,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_528,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_67,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_946,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_902,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_619,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_1020,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_494,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_256,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_528 || param1.type == RoomEngineEvent.const_652)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_191:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_888);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_161);
               if(!_loc5_)
               {
                  _loc3_.createWidget(RoomWidgetEnum.const_673);
               }
               _loc3_.createWidget(RoomWidgetEnum.const_376);
               if(this.var_1654 != RoomDesktop.const_644)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_376,this.var_1654);
               }
               if(this.var_351 != null)
               {
                  this.var_351.showRoomAd(param1.roomId,param1.roomCategory);
               }
            ...
            case RoomEngineEvent.const_332:
               ...
               break;
            case RoomEngineRoomColorEvent.const_946:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1233;
         _loc3_.sessionDataManager = this.var_397;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_1082;
         _loc3_.inventory = this.var_12;
         _loc3_.toolbar = this._toolbar;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1660;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_351;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1246;
         _loc3_.moderation = this.var_1101;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1363;
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2933 = param1.roomCategory;
         }
         else
         {
            this.var_1655 = false;
         }
         this.var_352.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_352.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_376);
            if(_loc3_ != RoomDesktop.const_644)
            {
               this.var_1654 = _loc3_;
            }
            _loc2_.dispose();
            this.var_1655 = false;
         }
      ...
      {
         return this.var_352.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_352.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
