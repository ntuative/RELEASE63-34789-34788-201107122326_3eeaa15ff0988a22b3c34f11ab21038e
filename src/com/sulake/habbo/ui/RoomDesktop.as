package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1514:int = 1000;
      ...
      private var var_1233:IRoomWidgetFactory = null;
      
      private var var_397:ISessionDataManager = null;
      
      private var var_15:IRoomSessionManager = null;
      
      private var var_1082:IAvatarRenderManager = null;
      ...
      private var var_1246:IHabboHelp = null;
      ...
      private var var_281:DesktopLayoutManager;
      
      private var var_1879:Boolean = true;
      
      private var var_1880:Boolean = true;
      
      private var var_811:Array;
      
      private var var_246:IToolTipWindow;
      
      private var var_2550:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_281 = new DesktopLayoutManager();
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_230,this.processEvent);
         }
      }
      ...
      public function set navigator(param1:IHabboNavigator) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_321,this.onNavigatorEvent);
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_865,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_281.setLayout(param1,this._windowManager,this._config);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_230,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_865,this.onRoomContentLoaded);
         }
         ...
         {
            this._navigator.events.removeEventListener(HabboNavigatorEvent.const_321,this.onNavigatorEvent);
         ...
         {
            this.var_545.reset();
            this.var_545.removeEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
            this.var_545 = null;
         }
         this.var_1877 = null;
      }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_33 != null)
         {
            this.var_811 = this._roomEngine.loadRoomResources(this.var_33.roomResources);
            if(this.var_811.length > 0)
            {
               this.var_1880 = false;
               this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_116));
            }
         }
      }
      ...
      {
         if(this.var_351 != null && this.var_33.state == RoomSessionEvent.const_264)
         {
            this.var_1879 = !this.var_351.showInterstitial();
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_813.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_813.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_812.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_812.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         }
         _loc2_ = this.var_1233.createWidget(param1,_loc4_);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            this.var_281.addWidgetWindow(param1,_loc2_.mainWindow);
         }
         if(_loc3_)
         {
            param1 = "null";
            _loc13_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_281.roomViewRect);
      ...
      public function disposeWidget(param1:String) : void
      {
         ...
         if(this.var_38 != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               {
                  this.var_281.removeWidgetWindow(param1,_loc2_.mainWindow);
               }
               _loc2_.dispose();
            }
         }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_812.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1265) == 1)
               {
                  _loc2_ = true;
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_902:
               ...
               {
                  _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_385,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               }
               if(this.var_1101 != null && _loc3_ == RoomObjectCategoryEnum.const_29)
               {
                  _loc7_ = this.var_33.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_131)
                  {
                     this.var_1101.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_201:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_619:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_142,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_193:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_1032,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_196:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_443,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_1020:
               if(!this.var_33.isRoomController && !this.var_397.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_157:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_884,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_494:
            ...
            case RoomEngineObjectEvent.const_156:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_766,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_652:
               ...
               break;
            case RoomEngineEvent.const_528:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_281.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_882);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_840);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_932);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_1031);
         ...
         this.var_281.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2550);
      ...
      {
         var _loc3_:IWindowContainer = this.var_281.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_281.roomViewRect;
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_33.roomId,this.var_33.roomCategory,this.var_332[0],_loc2_.width,_loc2_.height);
         if(this.var_545 == null)
         {
            this.var_545 = new Timer(const_1514,1);
            this.var_545.addEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
         }
         else
         {
            this.var_545.reset();
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1878) / 1000);
      ...
      {
         var _loc2_:* = null;
         if(param1.type == HabboNavigatorEvent.const_321)
         {
            if(this.var_33 != null)
            {
               _loc2_ = this._roomEngine.getRoomCanvasGeometry(this.var_33.roomId,this.var_33.roomCategory,this.getFirstCanvasId());
      ...
      {
         if(this.var_15 != null && this.var_33 != null && this.var_1879 && this.var_1880)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_458);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_584:
               ...
               this.var_246 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_420,WindowStyle.const_104,WindowParam.const_101) as IToolTipWindow;
               this.var_246.setParamFlag(WindowParam.const_30,false);
