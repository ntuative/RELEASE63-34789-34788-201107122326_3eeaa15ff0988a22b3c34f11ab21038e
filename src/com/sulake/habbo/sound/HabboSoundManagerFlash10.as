package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1541:int = 60;
      
      private static const const_1540:int = 25165823;
      
      private static const const_1539:int = 16777215;
      ...
      private var var_996:Number = 1.0;
      ...
      private var var_830:int = -1;
      
      private var var_829:TraxSequencer;
      
      private var var_244:IHabboMusicController;
      
      private var var_1272:Map;
      
      private var var_1545:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         this.var_1272 = new Map();
         this.var_1545 = new ByteArray();
         ...
         events.addEventListener(TraxSongLoadEvent.const_971,this.onTraxLoadComplete);
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1193:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1968:
               ...
               case HabboSoundTypesEnum.const_1305:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1235:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_1850:
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_141.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_141.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_676.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1272.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1022.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_141.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2630 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1022 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_141 == null || this._connection == null || this._roomEngine == null || this.var_244 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_2032,this.var_830));
         this.var_830 = -1;
         this.var_829 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_996 * 100)));
         }
      }
      ...
      {
         this.var_996 = param1;
         this.var_244.updateVolume(this.var_996);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_676.remove(param1);
            if(this.var_288.getValue(_loc2_) == null)
            {
               this.var_1545.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1545,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1545,_loc2_,TraxSample.const_2029,TraxSample.const_1891);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1271.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1541 && this.var_1271.length > 0)
            {
               _loc3_ = this.var_1271.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_676.length == 0 && this.var_830 != -1)
            {
               this.var_829.ready = true;
               _loc4_ = this.var_830;
               this.var_830 = -1;
               this.var_829 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_971,_loc4_));
               if(this.var_2630)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_829 == null && this.var_1272.length > 0)
         {
            _loc1_ = this.var_1272.getKey(0);
            _loc2_ = this.var_1272.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_971,_loc1_));
               }
               else
               {
                  this.var_829 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         if(_loc1_ > const_1540)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1539 && _loc9_ < _loc2_.length)
            {
