package com.sulake.habbo.sound.object
{
   ...
   public class HabboSound implements IHabboSound
   {
      ...
      private var var_1185:Sound = null;
      ...
      public function HabboSound(param1:Sound)
      {
         ...
         this.var_1185.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_996 = 1;
      ...
      {
         this._complete = false;
         this.var_490 = this.var_1185.play(0);
      ...
      {
         return this.var_1185.length;
      }
      
      public function get ready() : Boolean
      {
         return !this.var_1185.isBuffering;
      }
