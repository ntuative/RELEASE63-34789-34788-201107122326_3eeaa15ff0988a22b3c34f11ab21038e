package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      public static const const_1273:int = -1;
      
      private static const const_1526:int = HabboMusicPrioritiesEnum.const_132;
      ...
      private var var_93:IEventDispatcher;
      ...
      private var var_548:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_778.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_778.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_778)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_825,this.onJukeboxInit);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_256,this.onJukeboxDispose);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_947,this.onSoundMachineInit);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_1028,this.onSoundMachineDispose);
         this.var_1240 = new Timer(1000);
         this.var_1240.start();
         this.var_1240.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_302)
         {
            this.var_333[_loc6_] = null;
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1895)
            {
            ...
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_129,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_778)
               {
            ...
            if(this.var_283)
            {
               ...
               {
                  _loc3_ = this.var_283.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_93)
            {
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_825,this.onJukeboxInit);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_256,this.onJukeboxDispose);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_947,this.onSoundMachineInit);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_1028,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_333[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_333[param1];
      ...
      {
         var _loc1_:int = this.var_333.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_333[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_283.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_302)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_667.add(param1,param2);
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_283.length)
         {
            ...
            if(_loc3_.id != this.var_1515 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         var _loc1_:* = [];
         var _loc2_:int = 0;
         while(_loc2_ < this.var_333.length)
         {
            if(this.var_333[_loc2_] != null)
            {
               _loc3_ = this.var_333[_loc2_];
               _loc4_ = this.var_283.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_283.add(_loc6_.id,_loc10_);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_302)
         {
            return false;
         }
         ...
         this.var_1895 = this.getSongRequestCountAtPriority(param1);
         this.var_1515 = param2;
         if(this._priorityPlaying <= const_1526)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_132)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2574 != param1.id || _loc3_ > this.var_2573 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2574 = param1.id;
            this.var_2573 = _loc3_;
         }
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_548 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_93,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_548 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
