package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_244:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_244 = param2;
         this.var_778 = [];
         this.var_778.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_778.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_778)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_933,this.onSoundMachinePlayEvent);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_828,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_93)
            {
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_933,this.onSoundMachinePlayEvent);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_828,this.onSoundMachineStopEvent);
               this.var_93 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_444 == param1)
         {
            this.playCurrentSongAndNotify(this.var_444);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_244.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_444 = -1;
         this.var_642 = false;
         this.var_244.stop(HabboMusicPrioritiesEnum.const_132);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_244.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_244.playSong(param1,HabboMusicPrioritiesEnum.const_132,_loc3_,0,0,0))
         {
