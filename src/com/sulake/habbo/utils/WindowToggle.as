package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1829:int = 1;
      ...
      private var var_1574:Function;
      
      private var var_1049:Function;
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_1048)
            {
               this.var_1048.addChild(this._window);
            }
