package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_774)
         {
            this.var_774 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_774)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_773)
         {
            this.var_773 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_773)
            {
               return;
            }
