package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1454:uint = 13232628;
      
      private static var var_1759:uint = 11129827;
      ...
      private var var_1758:IWindowContainer;
      ...
      private var var_1175:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_335;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_522 = param1;
         if(this.var_1760 == this.var_522)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1758 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_774)
         {
            this.var_774 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_774)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_773)
         {
            this.var_773 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_773)
            {
               return;
            }
            this._window.content.addChild(this.var_773);
         }
         this._window.caption = this.var_27.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_773.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_522;
         }
         this.showView(this.var_773);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_27.localization.registerParameter("help.tutorial.name.available","name",this.var_522);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1140 || param1 == ChangeUserNameResultMessageEvent.var_1141)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1175 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1175.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1454;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_522 = this.var_27.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_27.changeName(this.var_522);
               break;
            ...
            case "header_button_close":
               this.var_27.showView(TutorialUI.const_96);
         }
      }
