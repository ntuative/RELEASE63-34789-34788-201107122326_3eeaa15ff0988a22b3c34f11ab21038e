package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_335:String = "TUI_NAME_VIEW";
      
      public static const const_399:String = "TUI_CLOTHES_VIEW";
      ...
      private var var_423:NameChangeView;
      
      private var var_1393:Boolean = false;
      
      private var var_1394:Boolean = false;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         super();
         this.var_36 = param1;
         this.var_3023 = param2;
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_636,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_504,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_559,this.onTaskDoneEvent);
         if(this.var_36.sessionDataManager != null)
         {
            this.var_36.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_337,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1393 && this.var_1394 && this.var_1691;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_636,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_504,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_559,this.onTaskDoneEvent);
            if(this.var_36.sessionDataManager != null)
            {
               this.var_36.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_337,this.onFigureUpdate);
            }
            this.var_36 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_636:
               this.var_1691 = true;
               if(this.var_54 != null && this.var_54.id == const_523)
               {
                  this.showView(const_96);
               }
               break;
            case HabboHelpTutorialEvent.const_504:
               if(this.var_54 != null && this.var_54.id == const_399)
               {
                  this.var_2191 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2400 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_335:
               ...
               if(this.var_423 == null)
               {
                  this.var_423 = new NameChangeView(this);
               }
               this.var_423.showMainView();
               this.prepareForTutorial();
               break;
            case const_399:
         ...
         this._window.height = _loc2_.height + this.var_2402;
         this._window.width = _loc2_.width + this.var_2400;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_36.hideUI();
         this.var_36.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_125));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_54 != null && (this.var_54.id == const_335 || this.var_54.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      {
         this.var_1393 = true;
         if(this.var_54 != null && (this.var_54.id == const_399 || this.var_54.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_423.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_504)
         {
            this.var_423.checkedName = _loc2_.name;
         }
         else
         {
            this.var_423.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
