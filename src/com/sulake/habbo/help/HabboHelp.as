package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1107:IHabboConfigurationManager;
      
      private var var_397:ISessionDataManager;
      
      private var var_1365:FaqIndex;
      ...
      private var var_897:HotelMergeUI;
      
      private var var_1659:CallForHelpData;
      
      private var var_2948:UserRegistry;
      
      private var var_2866:String = "";
      
      private var var_1106:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1659 = new CallForHelpData();
         this.var_2948 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1365 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1107)
         {
            this.var_1107.release(new IIDHabboConfigurationManager());
            this.var_1107 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_1107.getKey(param1,param2,param3);
      }
      ...
      public function reportUser(param1:int, param2:String) : void
      {
         ...
         this.var_76.showUI(HabboHelpViewEnum.const_457);
      }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_897)
         {
            this.var_897 = new HotelMergeUI(this);
         }
         this.var_897.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_124)
         {
            this.var_124.showView(TutorialUI.const_335);
         }
      }
      ...
      {
         this.var_1107 = IHabboConfigurationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_1106)
         {
            this.var_1106 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_1106.showWelcomeScreen(param1);
      }
