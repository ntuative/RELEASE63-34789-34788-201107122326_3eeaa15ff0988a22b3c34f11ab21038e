package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(param1 != null)
         {
            this.var_252 = FaqItem(param1);
         }
         if(this.var_252 == null)
         {
            return;
         }
         if(!this.var_252.hasAnswer)
         {
            main.sendMessage(new GetFaqTextMessageComposer(this.var_252.questionId));
            return;
         }
         var _loc3_:FaqCategory = this.var_252.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = this.var_252.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = this.hackHTML(this.var_252.answerText);
         }
         if(_loc3_ != null)
         {
            _loc5_ = _loc3_.getItemByIndex(this.var_252.index + 1);
         }
         ...
         if(_loc6_ != null)
         {
            if(_loc5_ != null)
            {
               ...
               _loc6_.setParamFlag(WindowParam.const_30);
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_252 != null)
         {
            _loc2_ = this.var_252.category;
            main.showUI(HabboHelpViewEnum.const_344);
            main.tellUI(HabboHelpViewEnum.const_344,_loc2_);
         }
      }
      ...
      private function onNextEntry(param1:WindowMouseEvent) : void
      {
         ...
         {
            main.tellUI(HabboHelpViewEnum.const_310,this.getNextItem());
         }
      }
      ...
      private function getNextItem() : FaqItem
      {
         ...
         if(_loc1_ == null || this.var_252 == null)
         {
            return null;
         }
         var _loc2_:FaqCategory = this.var_252.category;
         if(_loc2_ == null)
         {
            return null;
         }
         return _loc2_.getItemByIndex(this.var_252.index + 1);
      }
   }
}
