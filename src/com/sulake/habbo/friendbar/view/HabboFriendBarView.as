package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends AbstractView implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1721:int = 127;
      
      private static const const_491:int = 1;
      
      private static const const_1723:int = 2;
      
      private static const const_731:int = 3;
      
      private static const const_1162:int = 3;
      
      private static const const_1713:Boolean = false;
      
      private static const const_732:int = 3;
      
      private static const const_1714:String = "arrow";
      
      private static const const_1726:String = "left";
      
      private static const const_1724:String = "right";
      
      private static const const_1728:String = "bar_xml";
      
      private static const const_1727:String = "toggle_xml";
      
      private static const const_71:String = "container";
      
      private static const const_1161:String = "wrapper";
      
      private static const const_1725:String = "border";
      
      private static const const_733:String = "list";
      ...
      private static const const_1038:String = "pieces";
      
      private static const BUTTON_LEFT_SINGLE:String = "button_left";
      
      private static const const_1722:String = "button_right";
      
      private static const const_1716:String = "button_left_page";
      
      private static const const_1718:String = "button_right_page";
      
      private static const const_1715:String = "button_left_end";
      
      private static const const_1720:String = "button_right_end";
      
      private static const const_1424:String = "button_close";
      
      private static const const_1717:String = "button_open";
      
      private static const const_1719:String = "link_friendlist";
      
      private static const const_1163:String = "messenger";
      
      private static const const_1160:String = "friendlist";
      
      private static const const_730:String = "stream";
       
      
      private var var_51:IHabboFriendBarData;
      ...
      private var var_1398:ITab;
      
      private var var_1136:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1697:TextCropper;
      
      private var var_602:FriendListIcon;
      
      private var var_425:MessengerIcon;
      
      private var var_922:StreamIcon;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_51)
            {
               if(!this.var_51.disposed)
               {
                  if(this.var_51.events)
                  {
                     this.var_51.events.removeEventListener(FriendBarUpdateEvent.const_942,this.onRefreshView);
                     this.var_51.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_51.events.removeEventListener(FriendRequestUpdateEvent.const_846,this.onFriendRequestUpdate);
                     this.var_51.events.removeEventListener(NewMessageEvent.const_921,this.onNewInstantMessage);
                     this.var_51.events.removeEventListener(NotificationEvent.const_860,this.onFriendNotification);
                  }
                  this.var_51.release(new IIDHabboFriendBarData());
                  this.var_51 = null;
               }
            }
            if(_windowManager)
            {
               if(true)
               {
                  _windowManager.getWindowContext(const_491).getDesktopWindow().removeEventListener(WindowEvent.const_40,this.onDesktopResized);
               }
            }
            this.var_1697.dispose();
            this.var_1697 = null;
            super.dispose();
         }
      }
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(this.var_236)
         {
            this.var_236.visible = !param1;
            if(this.var_46)
            {
               this.var_236.x = this.var_46.x;
               this.var_236.y = this.var_46.y;
               this.var_236.activate();
            }
         }
      }
      ...
      public function populate() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc1_:int = this.var_1136;
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_46.findChildByName(const_71) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_733) as IItemListWindow;
         ...
         var _loc6_:int = this.var_51.numFriends;
         var _loc7_:int = this.var_51.numFriendRequests;
         var _loc8_:int = this.maxNumOfTabsVisible;
         var _loc9_:int = _loc6_ + (!!this.var_1698 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(_loc7_ > 0)
         {
            if(this._startIndex == 0)
            {
               if(this.var_77.length < _loc8_)
               {
                  if(_loc7_ == 1)
                  {
                     _loc12_ = this.var_51.getFriendRequestAt(0);
                  ...
                  {
                     _loc14_ = FriendRequestsTab.allocate(this.var_51.getFriendRequestList());
                     this.var_77.push(_loc14_);
                     _loc3_.addListItem(_loc14_.window);
                  }
               }
         ...
         while(_loc5_ < _loc6_ + _loc11_)
         {
            ...
            _loc13_ = this.var_51.getFriendAt(_loc5_);
         ...
         if(this.var_1698)
         {
            ...
            {
               _loc15_ = 1;
               if(this.var_77.length + _loc15_ < const_732)
               {
                  _loc15_ = Math.min(_loc8_ - this.var_77.length,const_732 - this.var_77.length);
               }
      ...
      {
         this.var_51 = param2 as IHabboFriendBarData;
         this.var_51.events.addEventListener(FriendBarUpdateEvent.const_942,this.onRefreshView);
         this.var_51.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_51.events.addEventListener(FriendRequestUpdateEvent.const_846,this.onFriendRequestUpdate);
         this.var_51.events.addEventListener(NewMessageEvent.const_921,this.onNewInstantMessage);
         this.var_51.events.addEventListener(NotificationEvent.const_860,this.onFriendNotification);
      }
      ...
      {
         var _loc2_:* = null;
         Tab.var_358 = this.var_51;
         Tab.var_503 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = _windowManager;
         Tab.var_2246 = var_757;
         Tab.var_2229 = this.var_1697;
         Token.WINDOWING = _windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1728);
         this.var_46 = _windowManager.buildFromXML(_loc1_.content as XML,const_491) as IWindowContainer;
         this.var_46.x = const_731;
         this.var_46.y = this.var_46.parent.height - (this.var_46.height + const_1723);
         this.var_46.width = this.var_46.parent.width - (const_731 + const_1162);
         this.var_46.setParamFlag(WindowParam.const_293,true);
         this.var_46.procedure = this.barWindowEventProc;
         if(const_1713)
         {
            _loc1_ = assets.getAssetByName(const_1727);
            this.var_236 = _windowManager.buildFromXML(_loc1_.content as XML,const_491) as IWindowContainer;
            this.var_236.x = this.var_46.x;
            this.var_236.y = this.var_46.y;
            this.var_236.setParamFlag(WindowParam.const_293,true);
            this.var_236.visible = false;
            this.var_236.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_46.findChildByName(const_1160));
         ...
         this.var_602 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_46.findChildByName(const_1163));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_425 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_425.enable(false);
         this.visible = true;
         _windowManager.getWindowContext(const_491).getDesktopWindow().addEventListener(WindowEvent.const_40,this.onDesktopResized);
         this.var_46.findChildByName(const_730).visible = var_1107.getBoolean("friendbar.stream.enabled",false) == true;
         _loc2_ = IWindowContainer(this.var_46.findChildByName(const_730));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_922 = new StreamIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(var_611)
         {
            _loc3_ = var_611.createAvatarImage(param1,AvatarScaleType.const_62,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_46.findChildByName(const_733) as IItemListWindow;
         var _loc4_:int = this.var_51.numFriends;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc2_ = this.var_51.getFriendAt(_loc5_);
            if(_loc2_.figure == param1)
            {
               ...
               if(_loc8_)
               {
                  ...
                  if(_loc9_)
                  {
                     _loc10_ = _loc9_.getChildByName(const_1038) as IItemListWindow;
                     if(_loc10_)
                     {
         ...
         var _loc6_:Array = this.var_51.getFriendRequestList();
      ...
      {
         return this.var_1136 == param1.id;
      }
      ...
      public function selectTab(param1:ITab, param2:Boolean) : void
      {
         if(!param1.selected)
         {
            ...
            {
               this.var_1136 = FriendEntityTab(param1).friend.id;
            }
         }
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_602)
         {
            this.var_602.notify(this.var_51.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function onNewInstantMessage(param1:NewMessageEvent) : void
      {
         if(this.var_425)
         {
            if(param1.notify)
            {
               this.var_425.notify(true);
            }
            else
            {
               this.var_425.enable(true);
            }
         }
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            _loc4_ = this.var_51.numFriends + (!!this.var_1698 ? 1 : 0) + (this.var_51.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
         ...
         if(param1.type == WindowEvent.const_570)
         {
            this.deSelect(true);
         }
      }
      ...
      private function onIconMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               ...
               {
                  this.var_51.toggleMessenger();
                  _loc2_.notify(false);
               }
               else if(_loc2_ is StreamIcon)
               {
                  this.var_51.toggleOfflineStream();
                  _loc2_.notify(false);
               }
               break;
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_46.findChildByName(const_1161) as IWindowContainer;
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1714,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            _loc4_.visible = param1;
         }
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1726,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1724,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param3)
            {
         ...
         if(!disposed)
         {
            if(this.var_46)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_77.length < const_732)
                     {
                        param1 = true;
                     }
                     else if(this.var_77.length < this.var_51.numFriends + (!!this.var_1698 ? 1 : 0))
                     {
                        param1 = true;
                     }
                     else if(this.numFriendEntityTabsVisible < this.var_51.numFriends)
                     {
                        param1 = true;
                     }
                  }
      ...
      private function get maxNumOfTabsVisible() : int
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1161) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_733) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1721 + _loc3_.spacing);
      }
