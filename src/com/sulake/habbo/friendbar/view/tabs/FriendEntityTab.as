package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1626:String = "entity_xml";
      
      private static const const_1628:String = "facebook_piece_xml";
      
      private static const const_1627:String = "controls_piece_xml";
      
      protected static const const_1038:String = "pieces";
      
      protected static const const_386:String = "icons";
      
      protected static const const_468:String = "header";
      
      protected static const const_1422:String = "facebook";
      
      protected static const const_1420:String = "controls";
      
      protected static const const_317:String = "canvas";
      
      protected static const const_712:String = "name";
      
      protected static const const_1149:String = "btn_message";
      
      protected static const const_1037:String = "icon_message";
      
      protected static const const_1421:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1039:String = "label";
      
      protected static const const_633:String = "notification";
      
      private static const const_74:uint = 10338138;
      
      private static const const_1117:uint = 13891476;
      
      private static const const_1137:String = null;
      
      private static const const_714:String = "icon_tag_notify";
      
      private static const const_1629:String = "icon_tag_message";
      
      private static const POOL:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
      
      private static const const_483:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         _loc3_ = _loc2_.getListItemByName(const_1420) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_633,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1628).content as XML) as IWindowContainer;
               _loc3_.name = const_1422;
               _loc6_ = _loc3_.getChildByName(const_712) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2229.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1627).content as XML) as IWindowContainer;
               _loc3_.name = const_1420;
               _loc8_ = _loc3_.getChildByName(const_1149);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1421);
               if(_loc8_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1117) : uint(const_74);
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_169)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1038)).getListItemByName(const_468) as IWindowContainer;
            _loc1_.findChildByName(const_712).caption = this.var_169.name;
            var_2229.crop(_loc1_.getChildByName(const_712) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_317));
            _loc2_.bitmap = var_503.getAvatarFaceBitmap(this.var_169.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_483.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1626).content as XML) as IWindowContainer;
         ...
         var _loc4_:IWindow = _loc1_.findChildByName(const_386);
         _loc1_.x = 0;
         _loc1_.y = 0;
         _loc1_.width = name_2;
      ...
      private function releaseFriendTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_ = param1.findChildByName(const_386);
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1149:
               case const_1037:
                  this.removeNotificationToken(FriendNotification.const_410,true);
                  if(var_358 && this.var_169)
                  {
                     var_358.startConversation(this.var_169.id);
                     this.deselect(true);
               ...
               case const_1421:
                  if(var_358 && this.var_169)
                  {
                     var_358.followToRoom(this.var_169.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1137;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1278:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2246);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_714;
               break;
            case FriendNotification.const_1173:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2246);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_714;
               break;
            case FriendNotification.const_410:
         ...
         if(_loc4_)
         {
            ...
            {
               _loc7_ = IItemListWindow(_window.findChildByName(const_386));
