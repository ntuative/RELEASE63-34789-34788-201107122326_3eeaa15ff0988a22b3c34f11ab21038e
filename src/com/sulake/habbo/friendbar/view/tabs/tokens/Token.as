package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static const const_2044:String = "title";
      
      protected static const const_1149:String = "message";
      
      protected static const const_1413:Rectangle = new Rectangle(0,0,25,25);
      ...
      protected var var_1420:FriendNotification;
      
      protected var var_1149:DropAnimation;
      ...
      {
         return this.var_1420.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1420.viewOnce;
      }
      ...
      protected function prepare(param1:String, param2:String, param3:String, param4:String, param5:String, param6:Boolean) : void
      {
         ...
         this._window.findChildByName(const_2044).caption = param1;
         this._window.findChildByName(const_1149).caption = !!param2 ? param2 : "";
         ...
         this._icon = var_1432.create("ICON_" + this.typeCode,WindowType.const_365,WindowStyle.const_104,WindowParam.const_30,Token.const_1413) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1432.create("BITMAP_" + this.typeCode,WindowType.const_411,WindowStyle.const_104,WindowParam.const_183,Token.const_1413) as IBitmapWrapperWindow;
         ...
         if(param6)
         {
            this.var_1149 = new DropAnimation(this._icon,600,32);
         }
      }
   }
}
