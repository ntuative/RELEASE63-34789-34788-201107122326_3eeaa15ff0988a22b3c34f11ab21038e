package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2058:String = "friend_request_tab_xml";
      
      protected static const const_469:String = "bubble";
      
      protected static const const_1149:String = "message";
      
      protected static const const_2057:String = "button_accept";
      
      protected static const const_1424:String = "button_close";
      
      protected static const const_1036:String = "click_region_reject";
      
      protected static const REGION_REJECT_TEXT:String = "link_reject";
      
      private static const const_74:uint = 16435481;
      
      private static const const_1117:uint = 16767334;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1602:uint = 16777215;
      
      private static var var_1601:FriendRequestTab;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1601 ? var_1601 : new FriendRequestTab();
         _loc2_.var_168 = false;
         if(_loc2_.friend)
         {
            if(_loc2_.friend.figure != param1.figure)
            {
               _loc3_ = IBitmapWrapperWindow(_loc2_._window.findChildByName(const_317));
               _loc3_.bitmap = var_503.getAvatarFaceBitmap(param1.figure);
            }
         }
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2058).content as XML) as IWindowContainer;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_365,WindowStyle.const_104,WindowParam.const_30,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_411,WindowStyle.const_104,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
         ...
         IItemListWindow(_loc1_.findChildByName(const_386)).addListItemAt(_loc7_,0);
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2057:
                  var_358.acceptFriendRequest(var_169.id);
                  break;
               case const_1424:
                  if(selected)
                  {
                  ...
                  break;
               case const_1036:
                  var_358.declineFriendRequest(var_169.id);
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == const_1036)
            {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1036)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1602;
            }
         }
      }
      ...
      public function avatarImageReady(param1:FriendRequest, param2:BitmapData) : void
      {
         ...
         if(!disposed)
         {
            if(friend)
            {
               ...
               {
                  _loc3_ = _window.findChildByName(const_317) as IBitmapWrapperWindow;
                  if(_loc3_)
                  {
                     _loc4_ = var_503.getAvatarFaceBitmap(param1.figure);
                     if(_loc4_)
                     {
