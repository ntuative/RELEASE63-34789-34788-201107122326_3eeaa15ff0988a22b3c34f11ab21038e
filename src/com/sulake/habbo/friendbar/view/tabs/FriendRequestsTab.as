package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2062:String = "friend_requests_tab_xml";
      ...
      protected static const const_2059:String = "button_accept_all";
      
      protected static const const_2061:String = "click_area_discard_all";
      ...
      protected static const const_1423:String = "text_discard";
      
      private static var var_1601:FriendRequestsTab;
      
      private static const const_74:uint = 4294625561;
      
      private static const const_1117:uint = 4294957414;
      
      private static const const_1644:uint = 4289431312;
      
      private static const const_1643:uint = 4290616362;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1601 ? var_1601 : new FriendRequestsTab();
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_2121)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1356.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1644) : uint(const_1643);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_712).caption = _loc5_.name;
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2062).content as XML) as IWindowContainer;
         ...
         this.var_1356 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1039)).underline = false;
         }
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_1424:
                  ...
                  break;
               case const_2059:
                  var_358.acceptAllFriendRequests();
                  break;
               case const_2061:
                  var_358.declineAllFriendRequests();
                  break;
               case const_2057:
                  var_358.acceptFriendRequest(param2.parent.id);
                  break;
               case const_1040:
                  var_358.declineFriendRequest(param2.parent.id);
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1423)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1040)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1423)).textColor = const_1602;
            }
         }
      }
