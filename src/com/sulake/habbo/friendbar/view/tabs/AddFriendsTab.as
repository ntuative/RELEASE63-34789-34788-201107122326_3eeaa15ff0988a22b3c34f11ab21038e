package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1595:String = "add_friends_tab_xml";
      
      private static const const_1594:String = "find_friends_icon_png";
      
      private static var var_1059:int = -1;
      
      private static const const_74:uint = 6907230;
      
      private static const const_1117:uint = 9209986;
      
      private static const POOL:Array = [];
      
      private static const const_480:Array = [];
      ...
      {
         var _loc1_:IWindowContainer = false ? const_480.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1595).content as XML) as IWindowContainer;
         ...
         _loc3_.bitmap = ASSETS.getAssetByName(const_1594).content as BitmapData;
      ...
      private function releaseEntityWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_480.indexOf(param1) == -1)
            {
               const_480.push(param1);
            }
         }
      }
