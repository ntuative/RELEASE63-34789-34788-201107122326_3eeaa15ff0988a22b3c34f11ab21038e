package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      private static const const_1043:int = 200;
      
      private static const const_1044:int = 500;
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1043) : int(const_1044));
         if(!var_938 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_938,!!_hover ? int(const_1043) : int(const_1044));
         if(!var_938 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
