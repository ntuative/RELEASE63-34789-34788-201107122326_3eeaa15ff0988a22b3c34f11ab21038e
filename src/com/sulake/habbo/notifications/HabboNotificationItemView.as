package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_611:int = 70;
      
      public static const const_1901:int = 5;
      
      private static const name_4:int = 0;
      
      private static const const_493:int = 1;
      ...
      private var var_252:HabboNotificationItem;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1849 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1849 = 15;
         }
         this.var_1848 = this._window.height;
         this.var_1498 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_252.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_493:
               ...
               _loc2_ = Number(this.var_1218) / Number(this.var_986["time_fade_in"]);
               if(this.var_1218 > int(this.var_986["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1071:
               ...
               if(this.var_1499 > int(this.var_986["time_display"]) && !this.var_1850)
               {
                  this.startFadeOut();
               }
               break;
            case const_1070:
               ...
               _loc3_ = 1 - Number(this.var_1219) / Number(this.var_986["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1219 > int(this.var_986["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1849;
         if(this._window.height < this.var_1848)
         {
            this._window.height = this.var_1848;
         }
      }
      ...
      {
         this.var_1219 = 0;
         this._state = const_1070;
      }
      
      private function startDisplay() : void
      {
         this.var_1499 = 0;
         this._state = const_1071;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1901;
         this._window.y = this.var_1498;
      }
