package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1510:String = "pixelbalance";
      
      private static const const_1511:String = "badges";
      
      private static const const_1513:String = "selectbadge";
      
      private static const const_1508:String = "inventory";
      
      private static const const_1509:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1507:String = "friendlist";
      
      private static const const_1512:String = "pet_inventory";
      
      private static const const_1506:String = "go_to_room";
      ...
      private var var_1874:IHabboToolbar;
      ...
      private var var_544:HabboNotificationViewManager;
      
      private var var_245:HabboAlertDialogManager;
      
      private var var_810:ParkBusDialogManager;
      
      private var var_2549:Boolean;
      
      private var var_995:ClubGiftNotification;
      
      private var var_992:ClubEndingNotification;
      
      private var var_993:ClubPromoNotification;
      
      private var var_3078:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1875 = false;
         this.var_3078 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_994);
         }
         var _loc6_:Map = this.var_994["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_994["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1232.push(_loc8_);
         return this.var_1232.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1232.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_245 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      {
         this.var_1874 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_544 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1874,this.var_994["styles"],this.var_994["view"]);
         ...
         registerUpdateReceiver(this.var_544,1);
         registerUpdateReceiver(this,2);
         this.var_397.events.addEventListener(BadgeImageReadyEvent.const_237,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_397.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1392,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1392,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1916,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_960,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_397.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_397.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_397.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1990,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            case CatalogPageMessageProductData.const_79:
               ...
               break;
            case CatalogPageMessageProductData.const_63:
               ...
               break;
            case CatalogPageMessageProductData.const_189:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1403)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_2037,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_993 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_992 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_544.isSpaceAvailable() && this.var_1232.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_544.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1512:
               if(this.var_12 != null && this.var_12.hasRoomSession)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_137);
               }
               break;
            case const_1509:
               break;
      ...
      {
         if(param1 != null && this.var_544 != null)
         {
            this.var_544.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_333;
            }
            if(param2 == 3002)
            {
               return FurniCategory.const_366;
            }
            if(param2 == 4057)
            {
               return FurniCategory.const_334;
            }
            return 1;
         }
         return 1;
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_245 == null)
         {
            return;
         }
         this.var_245.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_245.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_245.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_245.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_245.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_810 == null)
         {
            this.var_810 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_810 != null)
         {
            this.var_810.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1385,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1385,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1082.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_62);
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_42,3);
               _loc4_ = _loc6_.getCroppedImage(AvatarSetType.const_57);
               _loc6_.dispose();
            }
         }
         else
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2549)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_960,null);
            this.var_2549 = true;
      ...
      {
         if(param2.type == WindowEvent.const_148 || param2.type == WindowEvent.const_596)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_995 && this.var_995.visible)
         {
            return;
         }
         this.var_995 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1874);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_960,_loc6_);
      }
   }
}
