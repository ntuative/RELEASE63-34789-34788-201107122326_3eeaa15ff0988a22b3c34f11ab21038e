package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1467:Point = new Point(110,50);
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1467;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1032 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_282 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1931.prepare(this.var_1032);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1270,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1256,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_817,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_873,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_817,false);
         ...
         this.var_1546 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1546.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1930 == -1 ? 0 : int(this.var_16.height - this.var_1930);
         var _loc4_:int = this.var_1929 == -1 ? 0 : int(this.var_16.width - this.var_1929);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_282.y = Util.getLowestPoint(this.var_16.content);
         this.var_282.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1259,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_817,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1270,false);
         ...
         this.var_1930 = this.var_16.height;
         this.var_1929 = this.var_16.width;
