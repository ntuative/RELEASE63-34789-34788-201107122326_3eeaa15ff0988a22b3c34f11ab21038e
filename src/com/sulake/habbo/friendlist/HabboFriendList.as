package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_182:String = "face";
      ...
      private var var_157:IHabboMessenger;
      
      private var var_141:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_611:IAvatarRenderManager;
      
      private var var_788:ISessionDataManager;
      
      private var var_2438:FriendListLookAndFeel;
      
      private var var_494:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1809:OpenedToWebPopup;
      
      private var var_2437:int;
      
      var var_118:FriendCategories;
      
      private var var_120:FriendRequests;
      
      private var var_1808:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1022:IHabboNotifications;
      
      private var var_641:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2438 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1808 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_641.stop();
            this.var_641.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_641 = null;
         }
         ...
         if(this.var_157)
         {
            this.var_157.release(new IIDHabboMessenger());
            this.var_157 = null;
         }
         if(this.var_141)
         {
         ...
         if(this.var_611)
         {
            this.var_611.release(new IIDAvatarRenderManager());
            this.var_611 = null;
         }
         if(this.var_1022)
         {
            this.var_1022.release(new IIDHabboNotifications());
            this.var_1022 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_788)
         {
            this.var_788.release(new IIDSessionDataManager());
            this.var_788 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1809 = new OpenedToWebPopup(this);
         }
         this.var_1809.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_118.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_113);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_459);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_118.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_359,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_611.createAvatarImage(param1,AvatarScaleType.const_110,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_57);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      {
         var _loc1_:String = this.var_141.getKey("client.minimail.embed.enabled");
         return _loc1_ == "AvatarEditorGridColorItem";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_141.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_157 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_611 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_1022 = param2 as IHabboNotifications;
      ...
      {
         this.var_788 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_120 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_118.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1350,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_427,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_494 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_641)
         {
            this.var_641 = new Timer(120000);
            this.var_641.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_641.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         if(this.var_118.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_427);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_120.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_120.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_494.findTab(FriendListTab.const_90).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_120.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_494.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1808.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_118.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_118.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_494.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_494.findTab(FriendListTab.const_90);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_788 || !this.var_120)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_788.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_120.vipLimit;
         }
         else if(this.var_788.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
            _loc2_ = this.var_120.clubLimit;
         }
         if(_loc2_ > this.var_120.limit)
         {
            this.var_120.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_118 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_118.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_182) as IBitmapWrapperWindow;
