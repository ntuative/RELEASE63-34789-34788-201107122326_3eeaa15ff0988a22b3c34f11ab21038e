package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1554:String = "purse";
      
      private static const const_1553:String = "extra_tools";
      ...
      private var var_685:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1286:PurseExtension;
      
      private var var_1554:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_686:ExtensionView;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_278.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_278 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
            this.var_278.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "AvatarEditorGridColorItem")
         {
            this.var_686 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_686)
            {
               this.var_1286 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_685 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1554 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_686.attachExtension(const_1554,this.var_1286.window,ExtensionFixedSlotsEnum.const_1846);
               this.var_686.attachExtension(const_1553,this.var_685.window,ExtensionFixedSlotsEnum.const_1889);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_685.showRoomInfo();
         }
         else
         {
            this.var_685.hideRoomInfo();
         }
      }
