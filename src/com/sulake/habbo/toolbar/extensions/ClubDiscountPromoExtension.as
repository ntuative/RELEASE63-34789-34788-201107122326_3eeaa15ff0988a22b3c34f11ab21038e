package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ClubDiscountPromoExtension
   {
      ...
      private static const const_706:String = "club_promo";
      
      private static const const_1544:int = 13;
      
      private static const const_1116:int = 14;
      
      private static const const_1543:uint = 16777215;
      
      private static const const_1545:uint = 12247545;
      ...
      private var var_686:IExtensionView;
      ...
      public function ClubDiscountPromoExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager, param6:ICoreLocalizationManager, param7:IHabboInventory, param8:IHabboCatalog, param9:IConnection)
      {
         ...
         this.var_686 = param1.extensionView;
         if(this.var_12)
         {
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_329,this.onClubChanged);
         }
      }
         ...
         if(_loc4_)
         {
            ...
            if(_loc3_)
            {
               ...
               if(this.var_88)
               {
                  ...
                  if(_loc5_)
                  {
                     this.var_851 = _loc5_.content as BitmapData;
                     if(this.var_851)
                     {
                        this.var_88.bitmap = this.var_851.clone();
                     }
                  }
                  this.var_88.visible = false;
               }
               this.var_1321 = _loc3_.findChildByName("text_region") as IRegionWindow;
               if(this.var_1321)
               {
                  this.var_1321.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onTextRegionClicked);
                  this.var_1321.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onTextRegionMouseOver);
                  this.var_1321.addEventListener(WindowMouseEvent.const_25,this.onTextRegionMouseOut);
               }
               this.assignState();
            }
         }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_686)
            {
               this.var_686.detachExtension(const_706);
               this.var_686 = null;
            }
            this.animate(false);
            this.clearAnimation();
            ...
            if(this.var_12)
            {
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_329,this.onClubChanged);
               this.var_12 = null;
            }
            this._catalog = null;
      ...
      private function onClubChanged(param1:HabboInventoryHabboClubEvent) : void
      {
         if(this.var_12.clubIsExpiring)
         {
            if(!this._view)
            {
               ...
               this.assignState();
               this.var_686.attachExtension(const_706,this._view,ExtensionFixedSlotsEnum.const_2013);
            }
         }
         else
         {
      ...
      private function animate(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_701 = new Timer(15000);
            this.var_701.addEventListener(TimerEvent.TIMER,this.onTriggerTimer);
            this.var_701.start();
         }
         else
         {
      ...
      private function resetAnimationVariables() : void
      {
         ...
         this.var_2032 = this._view.width - 7 - this.var_88.bitmap.width;
         this.var_1592 = 0;
      }
      
      private function startAnimationTimer() : void
      {
         this.var_722 = new Timer(25,26);
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         this.var_88.x = 3 + this.var_1592 / 20 * this.var_2032;
         if(this.var_88.x > this.var_2032)
         {
            _loc2_ = this._view.width - 4 - this.var_88.x;
            _loc3_ = new BitmapData(_loc2_,this.var_851.height);
            _loc3_.copyPixels(this.var_851,new Rectangle(0,0,_loc2_,this.var_851.height),new Point(0,0));
