package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1557:uint = 16777215;
      
      private static const const_1556:uint = 12247545;
      
      private static const const_1555:String = "HELP";
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_419 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_67.removeListItem(this.var_419);
      }
      
      public function showRoomInfo() : void
      {
         this.var_67.addListItemAt(this.var_419,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_337)
         {
            this.var_337 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_337.x = _loc1_.x + this._window.width - this.var_337.width;
            this.var_337.y = _loc1_.y + this._window.height - this.var_337.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1555);
               break;
