package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class CreditsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1618:uint = 4291993382;
      
      private static const const_1619:uint = 4290807040;
      
      private static const const_487:Array = ["icon_credit_0_png","icon_credit_1_png","icon_credit_2_png","icon_credit_3_png","icon_credit_4_png","icon_credit_5_png","icon_credit_6_png"];
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_140,this.onCreditBalance);
      }
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_2181 != -1)
         {
            if(this.var_2181 > param1.balance)
            {
