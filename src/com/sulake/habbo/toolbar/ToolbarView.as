package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1467:Point = new Point(3,3);
      
      private static const const_1707:uint = 7433577;
      
      private static const const_1704:uint = 5723213;
      
      private static const const_490:String = "_hover";
      
      private static const const_489:String = "_normal";
      
      private static const const_488:int = 5;
      
      private static const const_1709:int = 600;
      
      private static const const_1703:int = 80;
      
      private static const const_1710:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1708:int = -2;
      
      private static const const_1705:int = 5;
      
      private static const const_1706:int = 10;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1467;
         this._window.addEventListener(WindowEvent.const_566,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_489);
         }
         ...
         this.var_235 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_235);
         var _loc14_:ITextWindow = this.var_235.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_235.x = _loc13_.width - this.var_235.width - const_488;
         this.var_235.y = const_488;
         this.var_3024 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1709;
         if(!param1 && _loc2_ == this.var_1694)
         {
            return;
         }
         this.var_1694 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1710) : int(const_1703);
         var _loc4_:int = !!_loc2_ ? int(const_1708) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1705 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1706;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_235 != null && this.var_3024)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_868:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_824:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_490);
               this.setIconBgHoverState(_loc3_,const_490);
               break;
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_489);
               this.setIconBgHoverState(_loc3_,const_489);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_490 ? this.var_1692 : this.var_1693;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_490)
         {
            param1.color = const_1707;
         }
         else
         {
            param1.color = const_1704;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1694 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1694 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1693 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1692)
         {
            this.var_1692.dispose();
         }
         this.var_1692 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1133.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_488;
            _loc2_.y = const_488;
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","false") == "AvatarEditorGridColorItem";
      }
   }
}
