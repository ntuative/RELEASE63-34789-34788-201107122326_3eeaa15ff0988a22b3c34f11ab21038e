package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1528:int = 5;
      
      private static const const_1530:int = 800;
      
      private static const const_1529:int = 15;
      
      private static const const_1531:int = 300;
      ...
      private var var_1247:QuestController;
      
      private var var_1010:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1247 = new QuestController(this);
         this.var_1010 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1528);
      }
      
      public static function method_3(param1:IWindowContainer, param2:Array, param3:int, param4:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_397.events.removeEventListener(BadgeImageReadyEvent.const_237,this.var_1010.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_397.events.addEventListener(BadgeImageReadyEvent.const_237,this.var_1010.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1247.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1010.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1247.questTracker.isVisible();
      }
      ...
      public function refreshReward(param1:Boolean, param2:IWindowContainer, param3:int, param4:int) : void
      {
         ...
         method_3(param2,["reward_caption_txt","reward_amount_txt","currency_bitmap"],_loc5_.x,3);
