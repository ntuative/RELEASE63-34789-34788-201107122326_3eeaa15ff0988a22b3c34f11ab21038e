package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1458:int = 30;
      ...
      private var var_607:IScrollbarWindow;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_789 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_789.toggle();
         this.var_1810 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1479.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1479[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_49.getXmlWindow("Quests"));
         this._window.findChildByTag("close").procedure = this.onWindowClose;
         this.var_67 = IItemListWindow(this._window.findChildByName("quest_list"));
         this.var_607 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_67.spacing = const_1456;
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_49.getXmlWindow("QuestEntry"));
         var _loc2_:IWindowContainer = IWindowContainer(this.var_49.getXmlWindow("Campaign"));
         var _loc3_:IWindowContainer = IWindowContainer(this.var_49.getXmlWindow("Quest"));
         var _loc4_:IWindowContainer = IWindowContainer(this.var_49.getXmlWindow("EntryArrows"));
         var _loc5_:IWindowContainer = IWindowContainer(this.var_49.getXmlWindow("CampaignCompleted"));
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1457;
         new PendingImage(this.var_49,IBitmapWrapperWindow(_loc4_.findChildByName("arrow_0")),"quest_arrow1");
         new PendingImage(this.var_49,IBitmapWrapperWindow(_loc4_.findChildByName("arrow_1")),"quest_arrow2");
         new PendingImage(this.var_49,IBitmapWrapperWindow(_loc2_.findChildByName("completion_bg_red_bitmap")),"quest_counterbkg_disabled");
         new PendingImage(this.var_49,IBitmapWrapperWindow(_loc2_.findChildByName("completion_bg_blue_bitmap")),"quest_counterbkg_active");
         new PendingImage(this.var_49,IBitmapWrapperWindow(_loc2_.findChildByName("completion_bg_green_bitmap")),"quest_counterbkg_completed");
         new PendingImage(this.var_49,IBitmapWrapperWindow(_loc5_.findChildByName("completed_pic_bitmap")),"category_completed");
         _loc3_.x = _loc2_.x + _loc2_.width + const_1455;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1458;
      ...
      {
         param1.findChildByName("campaign_header_txt").caption = this.var_49.getCampaignName(param2);
         param1.findChildByName("completion_txt").caption = param2.completedQuestsInCampaign + "/" + param2.questCountInCampaign;
         this.var_49.setupCampaignImage(param1,param2,true);
      ...
      {
         param1.findChildByName("quest_header_txt").caption = this.var_49.getQuestRowTitle(param2);
         param1.findChildByName("desc_txt").caption = this.var_49.getQuestDesc(param2);
         ...
         this.var_49.setupQuestImage(param1,param2);
         this.var_49.refreshReward(param2.waitPeriodSeconds < 1,param1,param2.activityPointType,param2.rewardCurrencyAmount);
      ...
      public function refreshDelay(param1:IWindowContainer, param2:QuestMessageData) : Boolean
      {
         ...
         if(param1.findChildByName("delay_desc_txt").visible)
         {
            ...
            _loc4_ = FriendlyTime.getFriendlyTime(this.var_49.localization,_loc3_);
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.close();
            _loc3_ = Boolean(parseInt(this.var_49.configuration.getKey("new.identity","0")));
            if(_loc3_ && this.var_1810 && !this.var_1811)
            {
               this.var_1810 = false;
               this.var_49.habboHelp.showWelcomeScreen(new WelcomeNotification(HabboToolbarIconEnum.QUESTS,"quests.rejectnotification"));
            }
         }
      }
      ...
      private function onAcceptQuest(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_49.send(new AcceptQuestMessageComposer(_loc3_));
         this._window.visible = false;
      }
      ...
      private function onCancelQuest(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_49.send(new RejectQuestMessageComposer());
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1450 = NextQuestTimer.const_849;
         this.refresh(true);
      }
   }
}
