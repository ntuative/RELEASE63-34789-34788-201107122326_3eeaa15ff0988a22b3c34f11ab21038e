package com.sulake.habbo.quest
{
   ...
   public class TwinkleImages implements IDisposable
   {
      ...
      {
         PendingImage.retrievePreviewAsset(this.var_49,"ach_twinkle" + param1,this.onImageReady);
      }
      ...
      private function onImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!_loc3_ || !this.var_49.assets)
         {
            return;
         }
         var _loc4_:BitmapDataAsset = this.var_49.assets.getAssetByName(_loc3_) as BitmapDataAsset;
         if(_loc4_ == null)
         {
            return;
         }
