package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1480:int = 56;
      
      private static const const_476:int = 5;
      
      private static const const_1593:int = 5;
      
      private static const const_1118:Point = new Point(8,8);
      
      private static const const_1596:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_143 == null || this.var_143.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc8_.x = const_1118.x;
            _loc8_.y = const_1118.y;
         ...
         var _loc2_:* = this.var_143.waitPeriodSeconds > 0;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1593;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.setupLink("link_region",_loc3_.y + _loc3_.height + const_476);
         ...
         this._window.height = _loc8_.height + const_1480;
      ...
      private function setupLink(param1:String, param2:int) : int
      {
         ...
         {
            _loc7_ = const_476 + _loc6_.height;
         }
         if(!_loc5_ && _loc6_.visible)
         {
            _loc7_ = -const_476 - _loc6_.height;
      ...
      {
         return this.var_143.waitPeriodSeconds < 1 && const_1596.indexOf(this.var_143.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this.var_49.localization.hasKey(this.var_143.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this.var_49.localization.hasKey(this.var_143.getCampaignLocalizationKey() + ".searchtag");
         return this.var_143.waitPeriodSeconds < 1 && (_loc1_ || _loc2_);
      }
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this.var_49.openNavigator(this.var_143);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Boolean = this.var_49.questController.questsList.refreshDelay(this._window,this.var_143);
         if(_loc2_)
         {
            this.openDetails(this.var_143);
         }
      }
   }
}
