   ...
   public class PendingImage implements IDisposable
   {
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!this.disposed)
         {
            ...
            if(_loc2_ != null)
            {
               this.setImageFromAsset(this.var_1886,_loc2_.assetName,null);
            }
         }
         this.dispose();
      }
      ...
      {
         if(!param2 || !this.var_49.assets)
         {
            return;
         }
         var _loc4_:BitmapDataAsset = this.var_49.assets.getAssetByName(param2) as BitmapDataAsset;
         if(_loc4_ == null)
         {
            retrievePreviewAsset(this.var_49,param2,param3);
            return;
         }
         if(param1)
         {
