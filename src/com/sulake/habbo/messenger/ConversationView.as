package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1654:int = 10;
      
      private static const const_1140:int = 100;
      
      private static const const_1655:int = 20;
       
      
      private var var_157:HabboMessenger;
      
      private var var_2934:IScrollbarWindow;
      
      private var var_2143:IContainerButtonWindow;
      
      private var var_67:IItemListWindow;
      
      private var var_589:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_157 = param1;
         this.var_2143 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_67 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2934 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_157.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1140 + const_1655)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_157.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1654;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_589 == null || _loc1_.id != this.var_589.id)
         {
            this.var_589 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_589.followingAllowed)
         {
            this.var_2143.enable();
         }
         else
         {
            this.var_2143.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_67.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_589.messages.length - const_1140);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_589.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_589.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_157.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_1009 || param3.type == Message.const_938 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_589.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_157.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_157.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_157.send(new FollowFriendMessageComposer(this.var_589.id));
         this.var_157.send(new EventLogMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_157.conversations.closeConversation();
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_938)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1400)
         {
            return 4294927974;
         }
         if(param1 == Message.const_738)
         {
            return 4293454056;
         }
