package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_479:Conversations;
      
      private var var_203:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_141 && this._localization && this._friendList && this.var_611 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_479 = new Conversations(new ConversationsDeps(this));
         this.var_203 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_479.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_479.setSelected(_loc2_);
            this.var_203.openMessenger();
            this.var_203.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_479 ? this.var_479.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_479.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_479.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_203 && this.var_203.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_203)
         {
            if(this.var_203.isMessengerOpen())
            {
               this.var_203.close();
            }
            else
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_141.getKey("url.prefix",_loc2_);
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_938,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1172,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_479.addMessageAndUpdateView(param1);
         if(!this.var_203.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1219);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1400,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_479.addMessageAndUpdateView(_loc3_);
      }
