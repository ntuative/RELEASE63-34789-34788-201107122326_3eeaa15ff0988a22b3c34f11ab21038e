package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_2116:int = 1000;
      
      private static var var_1091:Array = [];
      
      private static var var_2115:int = 200;
      ...
      private var var_2114:Dictionary;
      
      private var var_545:Timer;
      
      private var var_1637:Map;
      ...
      {
         this.var_877 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_878 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         this.var_545 = new Timer(1000,1);
         ...
         this.var_36.connection.send(this.var_1851);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_878.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1090.length < var_2116)
         {
            ...
            param1.width = this.var_878.width;
            param1.height = this.var_878.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1091.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_877.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1091.length < var_2115)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_877.width;
            param1.height = this.var_877.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2114[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1637.getValue(param2.chatterName))
            {
               this.var_1637.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1637.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1638)
         {
