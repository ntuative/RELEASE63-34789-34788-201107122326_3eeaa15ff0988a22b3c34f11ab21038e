package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_516:ITextFieldWindow;
      
      private var var_680:Boolean = true;
      
      private var var_1034:ICheckBoxWindow;
      
      private var var_1556:ICheckBoxWindow;
      
      private var var_1557:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_426));
         Logger.log("BEGINNING TO SHOW: " + this.var_426);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1984;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_426);
         if(param1.flatId != this.var_426)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_426);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_516 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_516.procedure = this.onInputClick;
         ...
         this.var_1034 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1556 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1557 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_741,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_680 || this.var_516.text == "")
         {
            this.var_36.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1034.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1757,_loc2_,this.var_516.text,"",""));
         if(this.var_1556.isSelected || this.var_1557.isSelected || this.var_1034.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1556.isSelected,this.var_1557.isSelected,this.var_1034.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1992);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1287.selection];
         if(_loc3_ != null)
         {
            this.var_680 = false;
            this.var_516.text = _loc3_;
         }
      }
   }
}
