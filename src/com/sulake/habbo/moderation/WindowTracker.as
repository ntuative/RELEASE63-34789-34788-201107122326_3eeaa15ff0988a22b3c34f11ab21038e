package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1767:int = 1;
      
      public static const const_1739:int = 2;
      
      public static const const_1358:int = 3;
      
      public static const const_741:int = 4;
      
      public static const const_1307:int = 5;
      
      public static const const_1853:int = 6;
      
      public static const const_1772:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1984:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_2067[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2067[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
