package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2346:String = "my_issues";
      
      private const const_2348:String = "open_issues";
      
      private const const_2347:String = "picked_issues";
      ...
      private var var_1774:IIssueBrowserView;
      
      private var var_1773:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_274 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_274.numTabItems)
            {
               _loc5_ = this.var_274.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_274 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_274 == null || this.var_274.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_274.selector.getSelectableByName("open_issues");
         this.var_274.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_370.view.width = this.var_274.container.width;
         this.var_370.view.height = this.var_274.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2346:
               if(this.var_1774 == null)
               {
                  this.var_1774 = new MyIssuesView(this.issueManager,this,this.var_274.container);
               }
               return this.var_1774;
            case this.const_2348:
               if(this.var_1773 == null)
               {
                  this.var_1773 = new OpenIssuesView(this.issueManager,this,this.var_274.container);
               }
               return this.var_1773;
            case this.const_2347:
               if(this.var_1775 == null)
               {
                  this.var_1775 = new PickedIssuesView(this.issueManager,this,this.var_274.container);
               }
