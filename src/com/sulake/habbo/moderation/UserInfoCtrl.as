package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1115:int = 60;
      
      private static const const_1113:int = 3600;
      
      private static const const_1114:int = 86400;
      
      private static const const_1112:int = 31536000;
      ...
      public function UserInfoCtrl(param1:IFrameWindow, param2:ModerationManager, param3:String, param4:Boolean = false)
      {
         ...
         this.var_1319 = param4;
      }
      
      public static function formatTime(param1:int) : String
      {
         if(param1 < 2 * const_1115)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1113)
         {
            return Math.round(param1 / const_1115) + " mins ago";
         }
         if(param1 < 2 * const_1114)
         {
            return Math.round(param1 / const_1113) + " hours ago";
         }
         if(param1 < 2 * const_1112)
         {
            return Math.round(param1 / const_1114) + " days ago";
         }
         return Math.round(param1 / const_1112) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1318.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_36.getXmlWindow("user_info"));
            this.var_1318.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_36,WindowTracker.const_1307,this._data.userId),this._callerFrame,this.var_1319,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new RoomVisitsCtrl(this.var_36,this._data.userId),this._callerFrame,this.var_1319,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new SendMsgsCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1442),this._callerFrame,this.var_1319,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ModActionCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1442),this._callerFrame,this.var_1319,false,true);
      }
