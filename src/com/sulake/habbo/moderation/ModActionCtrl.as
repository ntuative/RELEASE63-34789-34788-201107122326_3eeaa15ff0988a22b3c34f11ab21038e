package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1160:IDropMenuWindow;
      ...
      private var var_944:OffenceCategoryData;
      
      private var var_945:OffenceData;
      
      private var var_1161:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1161 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1159 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1729;
         ...
         this.var_1160 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1160);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_944 != null;
         if(this.var_945 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_945.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_944 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_944.offences,this.var_1161,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1159,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1441,this.var_516.text,this.var_1442));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_944 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_945 = this.var_944.offences[_loc3_];
         this.var_516.text = this.var_945.msg;
         this.var_680 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1441,this.var_516.text,this.var_1442));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1160.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1441,this.var_516.text,this.method_5(),this.var_1442));
         this.dispose();
      }
      ...
      private function method_5() : int
      {
         var _loc1_:int = this.var_1160.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1161.destroy();
            this.var_1161 = null;
         }
         if(this.var_1159 != null)
         {
            this.var_1159.destroy();
            this.var_1159 = null;
         }
         this.var_1160 = null;
         this.var_516 = null;
