package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_804:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2531 = param2.pickerUserId;
         this.var_2532 = param2.pickerUserName;
         this.var_1591 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1224 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1225;
         }
         if(this.var_804 == null || param1.timeStamp < this.var_804.timeStamp)
         {
            this.var_804 = param1;
         }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1224 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1225;
            }
            if(this.var_804 == _loc2_)
            {
               this.var_804 = null;
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_804;
         if(_loc2_ == null)
         {
