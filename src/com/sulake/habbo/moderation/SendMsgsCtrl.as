package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1729;
      ...
      {
         return WindowTracker.const_1739;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.messageTemplates[this.var_1287.selection];
         if(_loc3_ != null)
         {
            this.var_680 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModMessageMessageComposer(this.var_1441,this.var_516.text,this.var_1442));
         this.dispose();
      }
