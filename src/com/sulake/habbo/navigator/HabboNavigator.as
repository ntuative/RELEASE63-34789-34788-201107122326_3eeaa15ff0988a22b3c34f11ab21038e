package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_346:MainViewCtrl;
      
      private var var_715:RoomInfoViewCtrl;
      
      private var var_1345:RoomCreateViewCtrl;
      ...
      private var var_1138:GuestRoomPasswordInput;
      
      private var var_325:GuestRoomDoorbell;
      
      private var var_1344:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2836 = new Array();
         ...
         this.var_346 = new MainViewCtrl(this);
         this.var_715 = new RoomInfoViewCtrl(this);
         this.var_1345 = new RoomCreateViewCtrl(this);
         this.var_2765 = new RoomThumbnailRenderer(this);
         this.var_1138 = new GuestRoomPasswordInput(this);
         this.var_325 = new GuestRoomDoorbell(this);
         this.var_494 = new Tabs(this);
         this.var_1344 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_359,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_346.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_141.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_346.startSearch(Tabs.const_267,Tabs.const_509,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_346.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_346.startSearch(Tabs.const_312,Tabs.const_253);
         this.var_494.getTab(Tabs.const_312).tabPageDecorator.tabSelected();
      }
