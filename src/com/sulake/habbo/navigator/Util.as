package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1512:CutToWidth = new CutToWidth();
      
      private static var var_2565:CutToHeight = new CutToHeight();
      ...
      public static function method_3(param1:IWindowContainer, param2:Array, param3:int, param4:int, param5:int) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1512.beforeSearch(param2,param1,param3);
         binarySearch(var_1512,param2.length - 1);
      }
