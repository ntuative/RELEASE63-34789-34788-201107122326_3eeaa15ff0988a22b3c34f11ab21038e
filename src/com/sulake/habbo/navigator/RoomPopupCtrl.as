package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_142:GuestRoomData;
      
      private var var_2765:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2765 = new RoomThumbnailRenderer(param1);
         this.var_1128 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_204 = IWindowContainer(param1.findChildByName("details_container"));
         }
         this.var_204.visible = true;
         Util.hideChildren(this.var_204);
         this.refreshRoomName(this.var_204,this.var_142);
         if(this.var_142.ownerName != "" && this.var_142.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_204,!!this.var_142.event ? this.getEventCtg(this.var_142.categoryId) : this.getRoomCtg(this.var_142.categoryId));
         this.refreshRoomDesc(this.var_204,this.var_142);
         this.refreshExtraCont();
         this.refreshInfo(this.var_204,"trading_allowed",this.var_142.allowTrading);
         this.refreshInfo(this.var_204,"doormode_doorbell",this.var_142.doorMode == 1);
         this.refreshInfo(this.var_204,"doormode_password",this.var_142.doorMode == 2);
         Util.moveChildrenToColumn(this.var_204,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         this.var_204.height = Util.getLowestPoint(this.var_204);
      }
      
      private function refreshOwnerName() : void
      {
         this.refreshTextWithCaption("roomowner",this.var_204,this.var_142.ownerName);
         var _loc1_:ITextWindow = ITextWindow(this.var_204.findChildByName("roomowner"));
         if(this.var_142.ownerName != "" && this.var_142.ownerName != "-")
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_204.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         this.var_1128.refreshTags(_loc1_,this.var_142.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_142.score);
         if(this.var_142.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_142.eventCreationTime);
         }
         this.var_2765.refreshThumbnail(_loc1_,this.var_142.thumbnail,false);
      ...
      private function refreshTextWithCaption(param1:String, param2:IWindowContainer, param3:String) : void
      {
         ...
         _loc5_.text = param3;
         Util.method_3(_loc4_,[param1 + ".caption",param1],_loc6_.x,0,2);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_267,Tabs.const_442,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
