package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_446)
         {
            this.var_446.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_446.reset();
            this.var_446 = null;
         }
         if(this.var_374)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_58 == null)
         {
            this.var_58 = IWindowContainer(this._navigator.getXmlWindow(this.var_1144));
         ...
         this.var_58.x = _loc2_.x + this.var_2456 + param1.width;
