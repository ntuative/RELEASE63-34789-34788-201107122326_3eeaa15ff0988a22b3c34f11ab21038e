package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1400:TextFieldManager;
      
      private var var_959:TextFieldManager;
      
      private var var_960:TextFieldManager;
      
      private var var_1138:TextFieldManager;
      
      private var var_1399:TextFieldManager;
      
      private var var_1401:ICheckBoxWindow;
      
      private var var_1404:ICheckBoxWindow;
      
      private var var_1402:ICheckBoxWindow;
      
      private var var_924:ICheckBoxWindow;
      
      private var var_2205:ITextWindow;
      
      private var var_1139:IDropMenuWindow;
      
      private var var_1137:IDropMenuWindow;
      
      private var var_3040:IWindowContainer;
      ...
      private var var_1701:IWindowContainer;
      ...
      {
         this.var_426 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_426));
         if(this.var_1406 != null)
         {
            this.var_1406.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_426)
         {
            return;
         }
         this.var_57 = param1;
      ...
      {
         if(param1 != this.var_426 || this.var_1407 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1407 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1899)
         {
            this.var_923.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1944)
         {
            this.var_923.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1764)
         {
            this.var_1400.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1812)
         {
            this.setTagError(this.var_959,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_960,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1744)
         {
            this.setTagError(this.var_959,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_960,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1729)
         {
            this.var_1138.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_923.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1400.clearErrors();
         this.var_959.clearErrors();
         this.var_960.clearErrors();
         this.var_1138.clearErrors();
         this.var_1399.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_326,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_550,this.onDoorModePasswordUnselect);
         ...
         this.var_923 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1400 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_959 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_960 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1138 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1399 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1401 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1404 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1402 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_924 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_2205 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1139 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1137 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_3040 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1403 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1405 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2206 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1701 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_266 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1406 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1700 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1700.mouseThreshold = 0;
         this.var_1700.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1406.visible = false;
         if(!this.var_1699)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2206.visible = this.var_1699;
         this.populateForm();
         if(this.var_925)
         {
            this.var_1405.visible = true;
            this.var_1701.visible = true;
            this.refreshFlatControllers();
            this.var_1405.height = Util.getLowestPoint(this.var_1405) + 4;
         }
         else
         {
            this.var_1403.visible = true;
            this.var_1701.visible = true;
            this.var_3040.visible = this.var_1699;
            this.var_1403.height = Util.getLowestPoint(this.var_1403) + 4;
         }
         this.var_1700.text = !!this.var_925 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1403.name,this.var_1405.name,this.var_1701.name,this.var_2206.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_923.setText(_loc1_.name);
         this.var_1400.setText(_loc1_.description);
         this.var_1138.setText("");
         this.var_1399.setText("");
         ...
         {
            case RoomSettingsData.const_223:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_127);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_959,_loc1_.tags[0]);
         this.setTag(this.var_960,_loc1_.tags[1]);
         if(this.var_1401)
         {
            if(_loc1_.allowPets)
            {
               this.var_1401.select();
            }
            else
            {
               this.var_1401.unselect();
            }
         }
         if(this.var_1404)
         {
            ...
            {
               this.var_1404.select();
            }
            else
            {
               this.var_1404.unselect();
            }
         }
         if(this.var_1402)
         {
            ...
            {
               this.var_1402.select();
            }
            else
            {
               this.var_1402.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_924);
            this.disableWindow(this.var_1139);
            this.disableWindow(this.var_1137);
            this.disableWindow(this.var_2205);
         }
         else
         {
            this.enableWindow(this.var_924);
            this.enableWindow(this.var_1139);
            this.enableWindow(this.var_1137);
            this.enableWindow(this.var_2205);
         }
         if(this.var_924)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_924.unselect();
            }
         }
         if(this.var_1139)
         {
            this.var_1139.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1137)
         {
            this.var_1137.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_923.getText();
         _loc2_.description = this.var_1400.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_223;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_127;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_553;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_127)
         {
            _loc8_ = this.var_1138.getText();
            _loc9_ = this.var_1399.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1138.clearErrors();
               this.var_1399.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1401.isSelected;
         _loc2_.allowFoodConsume = this.var_1404.isSelected;
         _loc2_.allowWalkThrough = this.var_1402.isSelected;
         _loc2_.hideWalls = this.var_924.isSelected;
         _loc2_.wallThickness = this.var_1139.selection - 2;
         _loc2_.floorThickness = this.var_1137.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_959,_loc2_.tags);
         this.addTag(this.var_960,_loc2_.tags);
         this.clearErrors();
         this.var_1407 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_426);
         if(this.var_57 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_57.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_426]);
         _loc2_.show();
      }
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc1_:IWindow = this.var_266.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_266.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_57.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_266.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            _loc5_ = this.var_266.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_266.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_266.findChildByName("flat_controllers_footer"));
            if(this.var_57 != null && this.var_57.controllers.length > 0)
            {
               ...
               Util.moveChildrenToColumn(this.var_266,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_266.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_71,HabboWindowStyle.const_31,HabboWindowParam.const_64,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_426));
      }
