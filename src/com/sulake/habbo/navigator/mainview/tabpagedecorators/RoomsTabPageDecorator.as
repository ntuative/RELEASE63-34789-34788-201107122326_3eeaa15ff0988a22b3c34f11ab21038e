package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_164:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_164 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            this.prepareRoomCategories();
            this.var_164.addEventListener(WindowEvent.const_48,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_164 != null)
         {
            this.var_164.removeEventListener(WindowEvent.const_48,this.onFilterSelected);
            this.var_164.selection = 0;
            this.var_164.addEventListener(WindowEvent.const_48,this.onFilterSelected);
         }
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_164 == null ? 0 : int(this.var_164.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_226,Tabs.const_406);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_226,Tabs.const_742);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_226,Tabs.const_406,"" + _loc3_);
         }
         if(this.var_164)
         {
            this._navigator.trackNavigationDataPoint(this.var_164.enumerateSelection()[this.var_164.selection],"category.view");
         }
      }
      
      public function get filterCategory() : String
      {
         return !!this.var_164 ? this.var_164.enumerateSelection()[this.var_164.selection] : null;
      }
   }
}
