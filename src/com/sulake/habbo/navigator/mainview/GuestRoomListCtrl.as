package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_579:RoomPopupCtrl;
      
      private var var_607:IScrollbarWindow;
      
      private var var_1323:UserCountRenderer;
      
      private var var_1620:IWindowContainer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_579 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1323 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_607 = IScrollbarWindow(this.var_211.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_607.scrollV = 0;
         }
         this.var_211.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_199,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1969,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_223,null,0);
         this._navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_127,null,0);
         this.refreshRoomName(param1,param2);
         this.var_1323.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_579.visible && this.var_2852)
         {
            return;
         }
         ...
         this.var_579.room = _loc4_;
         this.var_579.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1620.tags[0];
            this.var_1620.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2851 - _loc2_.stageX);
         this.var_2851 = _loc2_.stageX;
         this.var_2852 = _loc3_ > 2;
      }
   }
}
