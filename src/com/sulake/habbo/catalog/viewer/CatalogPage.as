package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2051:String = "ctlg_";
       
      
      protected var var_2267:XML;
      ...
      private var var_549:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1241:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_549 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1242);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1242);
      }
      ...
      {
         var _loc2_:String = const_2051 + param1;
         ...
         this.var_2267 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2267) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1843:
               if(this.var_1241 == null)
               {
                  this.var_1241 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1241);
               }
               break;
            case CatalogWidgetEnum.const_1836:
            ...
            case CatalogWidgetEnum.const_1869:
               ...
               break;
            case CatalogWidgetEnum.const_1981:
            ...
            case CatalogWidgetEnum.const_1904:
               ...
               break;
            case CatalogWidgetEnum.const_2020:
            ...
            case CatalogWidgetEnum.const_1917:
               ...
               break;
            case CatalogWidgetEnum.const_1893:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_549.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_549 != null)
         {
            return this.var_549.dispatchEvent(param1);
         }
         return false;
      }
