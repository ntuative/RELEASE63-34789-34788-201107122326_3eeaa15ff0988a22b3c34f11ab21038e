package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1051:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_229:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1051).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1051).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_92,MouseCursorType.const_955);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_955);
         }
      }
