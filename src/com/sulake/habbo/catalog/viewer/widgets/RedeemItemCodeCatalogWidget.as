package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1008:IButtonWindow;
      
      private var var_1007:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1008.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1008 = null;
         }
         if(this.var_1007 != null)
         {
            this.var_1007.removeEventListener(WindowKeyboardEvent.const_197,this.windowKeyEventProcessor);
            this.var_1007 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1008 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1008 != null)
         {
            this.var_1008.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1007 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1007 != null)
         {
            this.var_1007.addEventListener(WindowKeyboardEvent.const_197,this.windowKeyEventProcessor);
         }
         return true;
      }
