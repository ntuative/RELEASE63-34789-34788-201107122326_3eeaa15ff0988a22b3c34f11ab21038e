package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1098:ITextWindow;
      ...
      private var var_587:IDisplayObjectWrapper;
      
      private var var_2132:Point;
      
      private var var_588:IItemGridWindow;
      
      private var var_1649:IScrollbarWindow;
      
      protected var var_1753:XML;
      
      private var var_2924:Array;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_206.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_206 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1098 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1362 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_100 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_206 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_206 != null)
         {
            this.var_206.visible = false;
            this.var_587 = this.var_206.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_587 != null && _loc3_ != null)
            {
               this.var_206.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_587.width,this.var_587.height);
               if(_loc4_ != null)
               {
                  this.var_587.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_2132 = new Point(this.var_100.x,this.var_100.y);
         this.var_588 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1649 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_588 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1753 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_588 != null)
         {
            this.var_588.visible = false;
            this.var_588.destroyGridItems();
         }
         ...
         this.var_1098.text = _loc4_;
         this.var_1362.text = _loc5_;
         this.var_1098.height = this.var_1098.textHeight + 5;
         this.var_1362.y = this.var_1098.y + this.var_1098.height;
         this.var_1362.height = Math.max(130,this.var_1362.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_545:
                  _loc6_ = this._bundlePreview.clone();
                  if(this.var_588 != null)
                  {
                     this.var_588.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_588,this.var_1649,this.var_1753);
                     this.var_588.scrollV = 0;
                  }
                  if(this.var_206 != null)
                  {
                     this.var_206.visible = false;
               ...
               case Offer.const_431:
                  ...
                  if(this.var_206 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_79 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_189)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_79:
                        if(_loc8_ != null && this.var_587 != null)
                        {
                     ...
                     case ProductTypeEnum.const_189:
                        ...
                        else
                        {
                           ...
                           _loc6_ = new BitmapData(this.var_100.width,this.var_100.height,false,_loc15_);
                           _loc16_ = null;
                           _loc17_ = page.viewer.catalog as HabboCatalog;
                           if(_loc17_.avatarRenderManager != null)
                           {
                              _loc19_ = _loc17_.sessionDataManager.figure;
                              _loc18_ = _loc17_.avatarRenderManager.createAvatarImage(_loc19_,AvatarScaleType.const_62);
                              if(_loc18_ != null)
                              {
                                 _loc18_.setDirection(AvatarSetType.const_57,3);
                                 _loc18_.initActionAppends();
                                 _loc18_.appendAction(AvatarAction.const_348,AvatarAction.const_637);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_100);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2924)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2924 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_100 != null && true)
         {
            ...
            if(this.var_100.bitmap == null)
            {
               this.var_100.bitmap = new BitmapData(this.var_100.width,this.var_100.height,true,16777215);
            }
            this.var_100.bitmap.fillRect(this.var_100.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_100.width - param1.width) / 2,(this.var_100.height - param1.height) / 2);
            this.var_100.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_100.invalidate();
            this.var_100.x = this.var_2132.x;
            this.var_100.y = this.var_2132.y;
            if(param3 != null)
            {
               this.var_100.x += param3.x;
               this.var_100.y += param3.y;
            }
         }
         if(param2)
         {
