package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_513:IItemGridWindow;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_870,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_284,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_777,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_257,this.deActivateScrollbar);
         }
         this.var_33 = param2;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_234.stop();
            this.var_234.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_234 = null;
         }
         if(this.var_513 != null)
         {
            this.var_513.destroyGridItems();
            this.var_513 = null;
         }
         this.var_1753 = null;
         this.var_237 = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_513 = _window.findChildByName("itemGrid") as IItemGridWindow;
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1753 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_220)
         {
            this.var_234 = new Timer(25);
            this.var_234.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_234.start();
         }
         else
         {
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_873 >= 0 && this.var_873 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_873];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_873;
               if(this.var_873 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1753) as IWindowContainer;
         this.var_513.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_545)
         {
            ++this.var_2090;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_2090);
         }
      }
