package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private const const_238:int = 31;
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            ...
            _loc2_ = _loc7_ >= this.const_238 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = _loc7_ % this.const_238;
            _loc4_ = _loc7_ / this.const_238;
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_27.purse.pastVipDays >= this.const_238 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_27.purse.pastVipDays % this.const_238;
            _loc4_ = this.var_27.purse.pastVipDays / this.const_238;
            this.var_27.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_27.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         if(!param2.isSelectable && _loc6_ > 0)
         {
            ...
            if(_loc6_ >= this.const_238)
            {
               _loc7_ += ".long";
            }
            _loc12_ = _loc6_ % this.const_238;
            _loc13_ = _loc6_ / this.const_238;
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_251)
         {
            this.var_251 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_251)
         {
            return;
         }
         var _loc4_:IBitmapWrapperWindow = this.var_251.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc4_)
         {
            return;
         }
         ...
         this.var_251.setGlobalPosition(_loc6_.subtract(new Point(this.var_251.width / 2,this.var_251.height / 2)));
         this.var_251.visible = true;
         this.var_251.activate();
      }
