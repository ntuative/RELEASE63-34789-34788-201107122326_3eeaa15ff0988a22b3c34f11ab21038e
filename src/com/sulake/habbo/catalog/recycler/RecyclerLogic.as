package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1138:int = 2;
      ...
      {
         return this.var_724 != const_1139;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2108 != RecyclerStatusMessageEvent.const_1264;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_724 == const_485;
      }
      ...
      {
         this.var_724 = const_1138;
         this.var_144 = new Array(const_229);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_229)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_724 = const_1139;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2108)
         {
            case RecyclerStatusMessageEvent.const_1763:
               this.var_724 = const_485;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1264:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1770:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1403:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1945:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_144.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_229)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_144.length < const_229)
         {
            return false;
         }
         var _loc1_:int = 0;
