package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_703:uint = 1;
      ...
      private var var_1206:IRoomSession;
      ...
      private var var_1082:IAvatarRenderManager;
      ...
      private var var_255:ICatalogNavigator;
      
      private var var_115:Purse;
      
      private var var_105:RecyclerLogic;
      
      private var var_159:IMarketPlace;
      ...
      private var var_2732:Boolean = true;
      
      private var var_2730:Boolean = true;
      
      private var var_1993:Boolean = false;
      
      private var var_2731:GiftWrappingConfiguration;
      
      private var var_1304:ClubGiftController;
      
      private var var_557:ClubBuyController;
      
      private var var_694:ClubExtendController;
      
      private var var_845:Map;
      
      private var var_1305:Boolean = false;
      
      private var var_846:IPurchasableOffer;
      
      private var var_1570:IDragAndDropDoneReceiver;
      ...
      private var var_693:RoomPreviewer;
      
      private const const_2075:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1082)
         {
            this.var_1082.release(new IIDAvatarRenderManager());
            this.var_1082 = null;
         }
         if(this.var_141)
         {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_77,this.onRoomSessionEvent);
            this.var_15.events.removeEventListener(RoomSessionEvent.const_82,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1773);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_397.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_557.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._communication.addHabboConnectionMessageEvent(new PurchaseNotAllowedMessageEvent(this.method_7));
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2729 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_397.loadProductData(this);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1082 = param2 as IAvatarRenderManager;
      }
      
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._roomEngine = param2 as IRoomEngine;
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_159,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_141 != null && this.var_141.getKey("catalog.furniture.animation","false") == "AvatarEditorGridColorItem")
         {
            if(this.var_693 == null)
            {
               this.var_693 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_141.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_880 || !this.var_255 || !this.var_255.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1047 = -1;
            this.var_844 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_255.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_141.getKey("client.credits.embed.enabled","false") == "AvatarEditorGridColorItem";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_141.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_397.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_397.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_63)
         {
            _loc3_ = this.var_397.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_845.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_255 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         if(this.var_141.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_703) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2075;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_274,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_77:
               this.var_1993 = param1.session.isPrivateRoom;
               this.var_1206 = param1.session;
               if(this.var_105 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_159 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1304 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_557 == null)
         {
            this.var_557 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_694 == null)
         {
            this.var_694 = new ClubExtendController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1571 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_255.buildCatalogIndex(_loc2_);
         if(this.var_844 && this.var_844 != "")
         {
            this.var_255.openPage(this.var_844);
            this.var_844 = "";
            this.var_1047 = -1;
         }
         else if(this.var_1047 > -1)
         {
            this.var_255.openPageById(this.var_1047,this.var_1994);
            this.var_1047 = -1;
            this.var_1994 = -1;
            this.var_844 = "";
         }
         else if(this.var_1571 && this.var_2729)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_255.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_2028));
         }
         else
         {
            this.var_255.loadFrontPage();
         }
      }
      ...
      private function method_7(param1:IMessageEvent) : void
      {
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2732 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1235);
         }
         this.var_2732 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_140,this.var_115.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2730 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1305);
         }
         this.var_2730 = false;
         if(this.var_223 != null && !this.var_223.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_340,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_943)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_324,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_340,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_324,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_115.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1331 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1304.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_159 != null)
         {
            this.var_159.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_159 != null)
         {
            this.var_159.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_159 != null)
         {
            this.var_159.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2731 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_159.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_557 != null)
         {
            this.var_557.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_694 != null && this.var_141.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_694.onOffer(param1);
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_845.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_845.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         param1.dispose();
         this.resetPlacedOfferData();
         if(param2.type == WindowEvent.const_148)
         {
            if(false && "AvatarEditorGridColorItem" == this.var_141.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_141.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_148)
         {
            _loc3_ = this.var_141.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_141.keyExists("catalog.drag_and_drop") || this.var_141.getKey("catalog.drag_and_drop") != "AvatarEditorGridColorItem")
         {
            return false;
         }
         if(!this.var_1206 || !this.var_1206.isRoomOwner)
         {
            return false;
         }
         ...
         {
            case ProductTypeEnum.const_189:
               _loc3_ = false;
               break;
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_233);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_228);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_218);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1305 && param1.type == RoomEngineObjectEvent.const_159)
         {
            this.resetPlacedOfferData(true);
            if(this.var_846 == null || this.var_846.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_846.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_846);
            _loc5_ = this.var_1570;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_345,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_65 != null && this.var_65.productClassId == param1.classId)
         {
            if(this.var_65.roomCategory == this._roomEngine.activeRoomCategory && this.var_65.roomId == this._roomEngine.activeRoomId)
            {
               ...
               {
                  case FurniCategory.const_366:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_228);
                     ...
                     break;
                  case FurniCategory.const_333:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_233);
                     if(this.var_65.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_334:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_218);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_141.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_703);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_693 != null)
         {
            this.var_693.updatePreviewRoomView();
         }
      }
   }
}
