package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2372:int = 10;
      ...
      private const const_2087:uint = 4.293848814E9;
      
      private const const_2086:uint = 4.294967295E9;
      
      private const const_1556:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1360 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_325,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_339,this.onMessageInputFocus);
         }
         this.var_2131 = true;
         this.var_2130 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_326,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_669,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_2019 = _loc1_.stuffTypes;
            this.var_886 = _loc1_.boxTypes;
            this.var_884 = _loc1_.ribbonTypes;
            this.var_1359 = this.var_2019[0];
            this.var_410 = this.var_886[0];
            this.var_409 = this.var_884[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_409 > this.var_884.length - 1)
         {
            this.var_409 = 0;
         }
         if(this.var_410 < 0)
         {
            this.var_410 = this.var_886.length - 1;
         }
         if(this.var_410 > this.var_886.length - 1)
         {
            this.var_410 = 0;
         }
         var _loc1_:int = this.var_886[this.var_410] * 1000 + this.var_884[this.var_409];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1359,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1647 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_2019)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1359);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_886[this.var_410]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_884[this.var_409]);
         this._catalog.purchaseProductAsGift(this.var_1648,this.var_1360,this.var_1646,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1648,this.var_1360,this.var_1646);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2921 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_262)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2372)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2921 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_411 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_411 + 1);
               break;
      ...
      {
         if(this.var_306 == null || !this.var_306.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_306.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_411) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_306 == null)
         {
            this.var_306 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_885 == null)
         {
            this.var_885 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_306 == null || this.var_885 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_306.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_885.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_306.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_411) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_411);
         }
         this.var_411 = param1;
         if(this.var_411 < 0)
         {
            this.var_411 = _loc2_.numListItems - 1;
         }
         if(this.var_411 >= _loc2_.numListItems)
         {
            this.var_411 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_411) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1556;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2087) : uint(this.const_2086);
      }
      ...
      {
         this.var_1359 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1359;
               }
            }
            _loc4_++;
         }
