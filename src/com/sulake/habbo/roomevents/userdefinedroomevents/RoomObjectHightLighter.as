package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_93.roomEngine.getRoomObject(this.var_93.roomId,this.var_93.roomCategory,param1,RoomObjectCategoryEnum.const_27);
      }
