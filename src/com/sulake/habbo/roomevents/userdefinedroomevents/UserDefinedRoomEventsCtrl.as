package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_360:int = 3;
      
      private static var var_1473:int = 2;
       
      
      private var var_93:HabboUserDefinedRoomEvents;
      
      private var _window:IFrameWindow;
      
      private var var_56:IWindowContainer;
      
      private var var_1797:TriggerConfs;
      
      private var var_1798:ActionTypes;
      
      private var var_1799:ConditionTypes;
      
      private var var_277:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_784:RoomObjectHightLighter;
      
      private var var_202:UserDefinedRoomEventsHelp;
      
      private var var_1187:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1797 = new TriggerConfs();
         this.var_1798 = new ActionTypes();
         this.var_1799 = new ConditionTypes();
         this.var_277 = new Dictionary();
         super();
         this.var_93 = param1;
         this.var_784 = new RoomObjectHightLighter(param1);
         this.var_202 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_277[param1])
         {
            delete this.var_277[param1];
            this.var_784.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_277[param1] = param2;
            this.var_784.show(param1);
         }
         this.refresh();
      }
      ...
      {
         return this.resolveHolder().getElementByCode(this.var_37.code);
      }
      
      private function resolveHolder() : ElementTypeHolder
      {
         if(this.var_37 as TriggerDefinition != null)
         {
            return this.var_1797;
         }
         if(this.var_37 as ActionDefinition != null)
         {
            return this.var_1798;
         }
         if(this.var_37 as ConditionDefinition != null)
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_93.getXmlWindow("ude_main"));
         ...
         this.var_1187 = new SliderWindowController(this.var_93,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_93.assets,0,20,1);
         this.var_1187.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1187.setValue(0);
      ...
      private function onDelaySliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_93.localization.registerParameter("wiredfurni.params.delay","seconds",_loc5_);
            }
         }
      }
      ...
      private function setIcon(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
         ...
         this.var_93.refreshButton(_loc4_,param3,true,null,0,param2);
      }
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_784.hideAll(this.var_277);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.prepareWindow();
         this.var_37 = param1;
         Logger.log("Received: " + this.var_37 + ", " + param1.code);
         var _loc2_:Element = this.resolveType();
         this.var_784.hideAll(this.var_277);
         this.var_277 = new Dictionary();
         for each(_loc3_ in this.var_37.stuffIds)
         {
            this.var_277[_loc3_] = "yes";
         }
         _loc4_ = !!_loc2_.hasSpecialInputs ? this.prepareCustomInput() : null;
         _loc2_.onEditStart(_loc4_,this.var_37);
         this.var_784.showAll(this.var_277);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1187.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            if(_loc2_.requiresFurni == STUFF_SELECTION_OPTION_BY_ID_OR_BY_TYPE)
            {
               ...
               this.getFurniTypeMatchesText().caption = this.var_93.localization.getKey("wiredfurni.pickfurnis.furnitypematches");
               this.getFurniTypeMatchesCheckBox().visible = true;
               this.getFurniTypeMatchesText().visible = true;
            }
            else if(_loc2_.requiresFurni == var_360)
            {
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_93.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_37.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_37 as TriggerDefinition != null)
         {
            this.var_93.send(new UpdateTriggerMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ActionDefinition != null)
         {
            this.var_93.send(new UpdateActionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ConditionDefinition != null)
         {
            this.var_93.send(new UpdateConditionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1187.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_202.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1473) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1473 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_93.send(new ApplySnapshotMessageComposer(this.var_37.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_360)
         {
            return this.var_37.stuffTypeSelectionCode;
         }
         return 0;
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1797);
         this.refreshConfigureElement(this.var_1798);
         this.refreshConfigureElement(this.var_1799);
      ...
      {
         if(!param1.acceptTriggerable(this.var_37))
         {
      ...
      {
         var _loc2_:IFurnitureData = this.var_93.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      private function refreshHeader(param1:Element, param2:String) : void
      {
         ...
         this.setText(_loc3_,"conf_name_txt",this.getElementName(this.var_37.stuffTypeId));
         this.setText(_loc3_,"conf_desc_txt",this.getElementDesc(this.var_37.stuffTypeId));
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         var _loc1_:ActionDefinition = ActionDefinition(this.var_37);
         ...
         this.var_93.localization.registerParameter("wiredfurni.conflictingtriggers.text","triggers",_loc2_);
         this.refreshWarning(this.var_93.localization.getKey("wiredfurni.conflictingtriggers.caption"),this.var_93.localization.getKey("wiredfurni.conflictingtriggers.text"));
      }
      ...
      private function refreshConflictingActions() : void
      {
         ...
         var _loc1_:TriggerDefinition = TriggerDefinition(this.var_37);
         ...
         this.var_93.localization.registerParameter("wiredfurni.conflictingactions.text","actions",_loc2_);
         this.refreshWarning(this.var_93.localization.getKey("wiredfurni.conflictingactions.caption"),this.var_93.localization.getKey("wiredfurni.conflictingactions.text"));
      }
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         if(_loc5_ == null)
         {
            _loc5_ = IWindowContainer(this.var_93.getXmlWindow("ude_" + _loc1_.getKey() + "_inputs_" + _loc2_.code));
            _loc5_.name = _loc4_;
            _loc3_.addChild(_loc5_);
            _loc2_.onInit(_loc5_,this.var_93);
         }
         return _loc5_;
      }
      ...
      private function refreshSelectFurni() : void
      {
         ...
         var _loc4_:int = this.var_37.furniLimit;
         this.var_93.localization.registerParameter("wiredfurni.pickfurnis.caption","count","" + _loc3_);
         this.var_93.localization.registerParameter("wiredfurni.pickfurnis.caption","limit","" + _loc4_);
      }
