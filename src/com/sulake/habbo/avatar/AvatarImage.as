package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1496:String = "Default";
      
      private static const const_1497:int = 2;
      
      private static const const_1495:String = AvatarSetType.const_42;
      ...
      protected var var_287:AvatarImageCache;
      
      protected var _figure:AvatarFigureContainer;
      
      protected var var_605:IAvatarDataContainer;
      
      protected var var_361:Array;
      
      protected var var_48:BitmapData;
      
      private var var_1069:IActiveActionData;
      ...
      private var var_2519:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1495,const_1497);
         this.var_361 = new Array();
         this.var_1069 = new ActiveActionData(AvatarAction.const_429);
         this.var_1069.definition = this._structure.getActionDefinition(const_1496);
         this.resetActions();
      ...
      {
         param2 += this.var_1858;
         if(param2 < AvatarDirectionAngle.const_1301)
         {
            param2 = AvatarDirectionAngle.const_371 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_371)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_653,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_279.length == 1 && this.var_103 == this.var_1826)
         {
            return this.var_103 + this.var_541 + this.var_653 % 4;
         }
         if(this.var_279.length == 2)
         {
            for each(_loc1_ in this.var_279)
            {
               ...
               {
                  return this.var_103 + this.var_541 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_653 % 11;
                  return this.var_103 + "_" + this.var_1826 + this.var_541 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2517 || param2 != this.var_2518 || param1 != this.var_2519)
         {
            this.var_2517 = param3;
            this.var_2518 = param2;
            this.var_2519 = param1;
            this.var_1857 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1421 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1421)
            {
               this.var_48.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_315.definition.geometryType,this.var_103);
         this.var_48.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_653);
         ...
         {
            if(this.var_605.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc13_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_605.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_653);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_361.push(new ActiveActionData(param1,param2,this.var_653));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_315 = this.var_1069;
         this.var_315.definition = this.var_1069.definition;
         this.resetBodyPartCache(this.var_1069);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_279)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_541 = "";
         this.var_279 = this._structure.sortActions(this.var_361);
         if(this.var_279 == null)
         {
            this.var_879 = new Array(0,0,0);
            if(this.var_1222 != "")
            {
               _loc1_ = true;
               this.var_1222 = "";
         ...
         {
            this.var_879 = this._structure.getCanvasOffsets(this.var_279,this._scale,this.var_103);
            for each(_loc4_ in this.var_279)
            {
               this.var_541 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_367)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1502 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1222 != this.var_541)
            {
               _loc1_ = true;
               this.var_1222 = this.var_541;
            }
         }
         this.var_1501 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_279)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_954 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1858 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_605 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_361 || _loc1_.actionType == AvatarAction.const_255 || _loc1_.actionType == AvatarAction.const_396)
               {
                  this.var_954 = true;
               }
            }
