package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2828:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2063 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2829 = parseInt(_loc2_,16);
         this.var_2827 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1806 = this._rgb >> 16 & 255;
         this.var_1807 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_2060 = this.var_1806 / 255 * 1;
         this.var_2061 = this.var_1807 / 255 * 1;
         this.var_2062 = this._b / 255 * 1;
         if(this.var_2063 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2828 = false;
         }
         this.var_831 = new ColorTransform(this.var_2060,this.var_2061,this.var_2062,this._alphaMultiplier);
         this.var_1339 = this.generatePaletteMapForGrayscale(this.var_2827,this.var_2829);
      }
      ...
      {
         return this.var_1339.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1339.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1339.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1339.getValue("alphas") as Array;
      }
