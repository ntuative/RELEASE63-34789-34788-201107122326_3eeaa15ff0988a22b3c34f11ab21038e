package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_349:PetDataManager;
      ...
      private var var_261:AvatarAssetDownloadManager;
      
      private var var_2122:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_717 = RenderMode.const_1887;
         this.var_348 = new Map();
         this.var_123 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_133,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_123.add(AvatarType.const_133,_loc4_);
         ...
         this.var_349 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_882 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_349.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_261)
         {
            this.var_261.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_349.init();
         this.var_882.init();
         _loc2_ = this.var_123.getValue(AvatarType.const_133) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_123.getValue(AvatarType.const_133) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_141.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_261 == null)
               {
                  ...
                  _loc6_ = this.var_141.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_141.getKey("flash.dynamic.avatar.download.url","");
                  this.var_261 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_261.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1073)
         {
            if(this.var_2911 && this.var_2912 && this.var_2913)
            {
               this.var_1073 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_261.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_261.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_123.getValue(AvatarType.const_133) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_261.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2122)
         {
            this.var_2122 = new AvatarFigureContainer(this.const_2370);
         }
         this.var_261.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2122,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(param1 == null || this.var_348 == null)
         {
            return;
         }
         for each(_loc2_ in this.var_348.getKeys())
         {
            _loc3_ = this.var_348.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_349.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1980)
         {
            _loc6_ = !this.var_349.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_349.createPetFigureString(param1,param2,param3);
         ...
         if(param5 != null)
         {
            ...
            this.var_348.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_349.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_123.getValue(AvatarType.const_58);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_348.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_348.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_123.getValue(AvatarType.const_133) as AvatarStructure;
      ...
      {
         return this.var_349 as IPetDataManager;
      }
