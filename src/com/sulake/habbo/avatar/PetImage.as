package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_605:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_57)
         {
            if((this.var_103 == 6 || this.var_103 == 0) && param2 == 7)
            {
               param2 = this.var_103;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1611);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_653);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_653);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_653);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_653);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_541 = this.var_541 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_434:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1838:
                  case AvatarAction.const_1808:
                  case AvatarAction.const_1761:
                  case AvatarAction.const_1178:
                  case AvatarAction.const_1245:
                  case AvatarAction.const_1953:
                  case AvatarAction.const_1834:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_361.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1069);
         this.getCache().resetBodyPartCache(this.var_1069);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1610 = this._structure.sortActions(this.var_361);
         ...
         {
            this.var_879 = this._structure.getCanvasOffsets(this.var_1610,this._scale,this.var_103);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1610)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_255)
               {
                  this.var_954 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_361)
               {
                  this.var_954 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1264 = _loc4_.id;
                     this.var_1912 = _loc4_.breed;
                     break;
                  }
               }
            }
