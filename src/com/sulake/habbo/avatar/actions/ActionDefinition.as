package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1920:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1920 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2906 = parseInt(param1.@precedence);
         this.var_2903 = String(param1.@activepartset);
         this.var_2902 = String(param1.@assetpartdefinition);
         this.var_2904 = String(param1.@lay);
         this.var_827 = String(param1.@geometrytype);
         this.var_2430 = Boolean(parseInt(param1.@main));
         this.var_2901 = Boolean(parseInt(param1.@LatencyPingResponseMessageParser));
         this.var_2905 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "AvatarEditorGridColorItem"));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "LatencyPingResponseMessageParser")
            {
               this.var_2907 = _loc6_;
            }
            else
            {
               this.var_1920[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_158[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_879.getValue(param1) == null)
         {
            this.var_879.add(param1,new Map());
         }
         var _loc4_:Map = this.var_879.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_879.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1920[param1];
         if(_loc2_ == null)
         {
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_158[param1];
         if(_loc2_ != null)
         {
