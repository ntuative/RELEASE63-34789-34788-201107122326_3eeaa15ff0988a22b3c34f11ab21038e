package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_2250:String = "hot_looks";
      
      public static const const_2282:String = "my_looks";
       
      
      private var var_594:Dictionary;
      
      public function HotLooksModel(param1:HabboAvatarEditor)
      {
         super(param1);
         this.var_594 = new Dictionary();
         this.var_594["null"] = new Array();
         this.var_594["null"] = new Array();
         this.var_594["undefined.index"] = 0;
         this.var_594["undefined.index"] = 0;
      ...
      {
         var _loc2_:Array = this.var_594["null"];
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (this.var_594[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
