package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private var var_390:IBitmapWrapperWindow;
      ...
      private function createView() : void
      {
         ...
         this.var_390 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1543)
         {
            _loc5_ = this.var_27.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_110,this.var_1020,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_42,parseInt(FigureData.const_866));
         ...
         if(this.var_390)
         {
            if(this.var_390.bitmap)
            {
               this.var_390.bitmap.dispose();
            }
            this.var_390.bitmap = new BitmapData(this.var_390.width,this.var_390.height,true,0);
            _loc7_ = (this.var_390.width - _loc1_.width) / 2;
            _loc8_ = (this.var_390.height - _loc1_.height) / 2;
            this.var_390.bitmap.draw(_loc1_,new Matrix(1,0,0,1,_loc7_,_loc8_));
         }
         if(_loc2_)
         {
            _loc1_.dispose();
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_1020 = this.var_27.gender;
               this.var_27.handler.saveWardrobeOutfit(this.var_1926,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this.var_27.loadAvatarInEditor(this._figure,this.var_1020,this.var_27.clubMemberLevel);
               }
         }
      }
