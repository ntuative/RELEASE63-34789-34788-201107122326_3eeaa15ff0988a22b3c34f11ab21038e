package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1411:IWindowContainer;
      
      public static var var_1703:IWindowContainer;
      
      public static var var_2220:int = 6710886;
      
      private static const const_1538:int = 5000;
      
      private static const const_1467:Point = new Point(100,30);
      ...
      private var var_253:ITabSelectorWindow;
      ...
      private var var_2625:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1268 = [];
         this.var_1537 = [AvatarEditorFigureCategory.const_819,AvatarEditorFigureCategory.const_57,AvatarEditorFigureCategory.const_298,AvatarEditorFigureCategory.const_767,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_109];
         super();
         this.var_23 = param1;
         if(var_1411 == null)
         {
            _loc4_ = this.var_23.manager.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1411 = this.var_23.manager.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1703 == null)
         {
         ...
         this._saveTimer = new Timer(const_1538,1);
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_85.position = const_1467;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_675 == null)
            {
               this.var_675 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_71,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_675.addChild(this.var_59);
            }
            _loc3_ = this.var_675.getChildIndex(this.var_59);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1268.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1268.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_253 = this.var_59.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_253.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_253.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1268.indexOf(_loc2_.name) < 0)
            {
               _loc3_ = this.var_253.removeSelectable(_loc2_);
               _loc4_ = _loc1_ + 1;
               while(_loc4_ < this.var_253.numSelectables)
               {
                  this.var_253.getSelectableAt(_loc4_).x = this.var_253.getSelectableAt(_loc4_).x - _loc3_.width;
                  _loc4_++;
               }
            }
            _loc1_--;
         }
         this.var_253.setSelected(this.var_253.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_35 && (this.var_1538 == AvatarEditorSideCategory.const_109 || this.var_2625))
         {
            _loc4_ = "null";
         }
      ...
      {
         if(this.var_1538 == AvatarEditorSideCategory.const_109)
         {
            this.var_2625 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_567:
               break;
            case AvatarEditorSideCategory.const_510:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_510);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_372 = param1;
         this.var_253.setSelected(this.var_253.getSelectableByName(param1));
      }
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_23.manager.catalog.openCatalogPage(CatalogPageName.const_143,true);
         }
      }
   }
}
