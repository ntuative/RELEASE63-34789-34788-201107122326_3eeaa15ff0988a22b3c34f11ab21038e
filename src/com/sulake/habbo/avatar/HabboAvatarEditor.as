package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1639:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1640:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_584:HabboAvatarEditorManager;
      ...
      private var var_1353:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_584 = param2;
         this.var_1088 = this.var_584.avatarRenderManager.getFigureData(AvatarType.const_133);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_118)
            {
               _loc1_.dispose();
               _loc1_ = null;
            }
         ...
         {
            for each(_loc2_ in this.var_585)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_725["null"] = new FigureData(this);
         this.var_725["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_725["null"];
         var _loc3_:FigureData = this.var_725["null"];
         _loc2_.loadAvatarData(const_1639,FigureData.const_88);
         _loc3_.loadAvatarData(const_1640,FigureData.FEMALE);
         this.var_118 = new Map();
         this.var_585 = new Map();
         this.var_118.add(AvatarEditorFigureCategory.const_819,new BodyModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_57,new HeadModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_298,new TorsoModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_767,new LegsModel(this));
         if(param1 == null || param1.indexOf(AvatarEditorFigureCategory.HOTLOOKS) > -1)
         {
            this.var_118.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
         }
         this.var_585.add(AvatarEditorSideCategory.const_109,new WardrobeModel(this));
         this.var_585.add(AvatarEditorSideCategory.const_510,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_876 != param3)
         {
            this.var_876 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_725[param2];
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(this.var_2337 != param1)
         {
            this.var_2337 = param1;
            _loc4_ = true;
         }
         if(this.var_118 && _loc4_)
         {
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_819);
         }
      }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_118.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = this.var_585.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_725[this.var_1020];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1353.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_584.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2111;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_876 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_715)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1703.clone() as IWindowContainer,param1,_loc13_);
                     _loc4_[_loc17_].push(_loc18_);
                     _loc17_++;
                  }
                  if(param2 != FigureData.const_94)
                  {
                     _loc19_ = 0;
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_584.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_584.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_584.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
                  _loc22_ = (_loc21_.content as BitmapData).clone();
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1411.clone() as IWindowContainer,param1,null,null,false);
                  _loc7_.iconImage = _loc22_;
                  _loc3_.push(_loc7_);
               }
            }
            _loc16_ = param2 != FigureData.const_94;
            for each(_loc6_ in _loc8_.partSets)
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1740)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_876 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1411.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_584.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_876 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_585.getValue(AvatarEditorSideCategory.const_109);
      }
