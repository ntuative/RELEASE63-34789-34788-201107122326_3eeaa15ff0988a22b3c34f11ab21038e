package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2083:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1522:IAvatarImage;
      ...
      private var var_389:IActiveActionData;
      ...
      private var var_2627:ByteArray;
      
      private var var_2628:ImageData;
      
      private var var_1060:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_827 == GeometryType.const_1192 && param1 == GeometryType.const_1283 || this.var_827 == GeometryType.const_1283 && param1 == GeometryType.const_1192)
         {
            this.var_827 = param1;
            this.var_99 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_389 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_389;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_389 || !this.var_389.definition))
         {
            if(this.var_389.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_389.definition.state + "." + this.var_389.actionParameter);
               _loc13_ = param2 - this.var_389.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_389.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_389 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_869)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_495)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1522.getFigure(),_loc5_,this.var_827,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_438 == null)
         {
            ...
            this.var_438 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_389);
            if(this.var_438 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_99)
         {
            this.var_99 = this._structure.getCanvas(this._scale,this.var_827);
            if(!this.var_99)
            {
               return null;
            }
            this.var_2626 = new Point(0,this.var_99.height - int(this.var_99.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1851[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_779 || _loc10_ == AvatarAction.const_396;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1542 = this.var_139.bodyPartId;
               this.var_199 = this.var_139.partType;
               this.var_1925 = this.var_139.partId;
               this._frame = this.var_139.getFrameIndex(param3);
               _loc5_ = param1;
               _loc7_ = false;
               if(_loc6_)
               {
                  if(_loc9_ == "wav" && (this.var_199 == "lh" || this.var_199 == "ls" || this.var_199 == "lc" || this.var_199 == "lhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "drk" && (this.var_199 == "rh" || this.var_199 == "rs" || this.var_199 == "rc" || this.var_199 == "rhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "crr" && this.var_199 == "rhs")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_199 == "ri")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_199 == "cp")
                  {
                     _loc7_ = true;
                  }
                  else
                  {
                     ...
                     if(this.var_139.flippedPartType != this.var_199)
                     {
                        this.var_199 = this.var_139.flippedPartType;
                     }
                  }
               }
               this.var_1541 = this._scale + "_" + this.var_139.action.assetPartDefinition + "_" + this.var_199 + "_" + this.var_1925 + "_" + _loc5_ + "_" + this._frame;
               this.var_467 = this._assets.getAssetByName(this.var_1541) as BitmapDataAsset;
               if(this.var_467 == null)
               {
                  this.var_1541 = this._scale + "_std_" + this.var_199 + "_" + this.var_1925 + "_" + _loc5_ + "_0";
                  this.var_467 = this._assets.getAssetByName(this.var_1541) as BitmapDataAsset;
               }
               if(!(!this.var_467 || !this.var_467.content))
               {
                  if(this.var_139.paletteMapId > -1)
                  {
                     this.var_1060 = this._structure.renderManager.paletteManager.getPalette(this.var_139.paletteMapId);
                     if(this.var_1060 != null)
                     {
                        this.var_1019 = this.var_467.content as BitmapData;
                        this.var_200 = new BitmapData(this.var_1019.width,this.var_1019.height);
                        this.var_2627 = this.var_1060.colorize(this.var_1019.getPixels(this.var_1019.rect));
                        this.var_200.setPixels(this.var_200.rect,this.var_2627);
                     }
                     else
                     {
                        this.var_200 = (this.var_467.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1542 == AvatarBodyPartType.const_298 || this.var_1542 == AvatarBodyPartType.const_1788 || this.var_1542 == AvatarBodyPartType.const_1807) && this.var_139.color != null)
                  {
                     _loc16_ = 0.7;
                     ...
                     this.var_200.colorTransform(this.var_200.rect,_loc18_);
                  }
                  else if(this.var_139.isColorable && this.var_139.color != null)
                  {
                     this.var_200.colorTransform(this.var_200.rect,this.var_139.color.colorTransform);
                  }
                  if(this.var_139.isBlendable)
                  {
                     this.var_200.colorTransform(this.var_200.rect,this.var_139.blendTransform);
                  }
                  this.var_1017 = this.var_467.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_62)
                     {
                  ...
                  this.var_2628 = new ImageData(this.var_200,this.var_1017,_loc7_);
                  this.var_1018.push(this.var_2628);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_1018,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2626.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_62)
            {
         ...
         _loc8_ = this.var_1018.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1018.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
