package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      private var var_180:AvatarRenderManager;
      ...
      public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_313)
            {
      ...
      {
         if(param1 == null || this.var_582 == null)
         {
            return;
         }
         var _loc2_:int = this.var_582.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_582.splice(_loc2_,1);
         }
      }
      ...
      {
         var _loc1_:* = null;
         while(this.var_582.length > 0)
         {
            _loc1_ = this.var_582.pop() as IPetDataListener;
      ...
      public function getPetData(param1:int, param2:IPetDataListener = null) : IPetData
      {
         ...
         if(_loc3_ == null)
         {
            this.assetsReady(param1,AvatarScaleType.const_62,param2);
         }
         return _loc3_;
      }
      ...
      public function createPetFigureString(param1:int, param2:int, param3:uint) : String
      {
         ...
         var _loc7_:PetColor = _loc4_.method_12(param3);
         if(_loc7_ == null)
         {
            return _loc6_;
         }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1630.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_720.getValue(_loc6_) == null)
               {
                  ...
                  this.var_313.push(_loc8_);
                  this.var_720.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_582.indexOf(param3) == -1)
                  {
                     this.var_582.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_720.getKeys())
         {
            _loc5_ = this.var_720.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_313.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
            this.var_313.splice(_loc3_,1);
