package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyModel extends CategoryBaseModel implements IAvatarEditorCategoryModel, IAvatarImageListener
   {
      ...
      {
         super.init();
         initCategory(FigureData.const_94);
         _isInitialized = true;
         if(!_view)
         {
      ...
      {
         var _loc4_:CategoryData = var_118[param1];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         this.updateSelectionsFromFigure(FigureData.const_94);
      }
      ...
      override protected function updateSelectionsFromFigure(param1:String) : void
      {
         ...
         var _loc2_:int = var_27.figureData.getPartSetId(FigureData.const_94);
         var _loc3_:Array = var_27.figureData.getColourIds(FigureData.const_94);
         var _loc4_:CategoryData = var_118[param1];
         if(_loc4_ == null)
         {
            return;
         ...
         for each(_loc5_ in _loc4_.parts)
         {
            ...
            _loc7_ = var_27.manager.avatarRenderManager.createAvatarImage(_loc6_,AvatarScaleType.const_62,null,this);
            _loc5_.iconImage = _loc7_.getCroppedImage(AvatarSetType.const_57);
            _loc7_.dispose();
         }
      }
