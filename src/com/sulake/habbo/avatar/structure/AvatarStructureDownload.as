package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      private var var_2960:IStructureData;
      
      private var var_2157:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            ...
            {
               Core.error("Could not load avatar structure, got empty data from URL " + loaderStruct.assetLoader.url + " data length = " + data.length + ".",false,Core.const_219);
            }
            this.var_2157 = new XML(data);
         }
         catch(e:Error)
         {
         ...
         this.var_2960.appendXML(this.var_2157);
      ...
      private function onDataFailed(param1:Event) : void
      {
         ...
         Core.error("Could not load avatar structure. Failed to get data from URL " + _loc3_,false,Core.const_219);
      }
   }
}
