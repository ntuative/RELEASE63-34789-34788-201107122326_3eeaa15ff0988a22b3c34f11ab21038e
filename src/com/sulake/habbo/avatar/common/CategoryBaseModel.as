package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:CategoryData = this.var_118[param1];
         if(_loc2_ == null)
         {
            _loc3_ = this.var_27.generateDataContent(this,param1);
            if(_loc3_)
            {
               this.var_118[param1] = _loc3_;
      ...
      {
         if(!this.var_118 || !this.var_27 || !this.var_27.figureData)
         {
            return;
         }
         var _loc2_:CategoryData = this.var_118[param1];
      ...
      public function hasClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         for each(_loc3_ in this.var_118)
         {
            if(_loc3_)
            {
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc2_:Array = this.var_118.getKeys();
      ...
      {
         var _loc3_:CategoryData = this.var_118[param1];
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc4_:CategoryData = this.var_118[param1];
         if(_loc4_ == null)
         {
            return;
         }
