package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1123:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_697.width,this.var_697.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_697,this.var_697.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1052.width,this.var_1052.height,true,0);
            _loc5_ = this.var_1052.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_1123.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_1054.width,this.var_1054.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_1054,this.var_1054.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_1123)
            {
               switch(this.var_1123.clubLevel)
               {
                  case HabboClubLevelEnum.const_51:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_35:
                     _loc4_.style = HabboIconType.const_1015;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_43:
                     _loc4_.style = HabboIconType.const_965;
                     _loc4_.visible = true;
               }
            }
            else
