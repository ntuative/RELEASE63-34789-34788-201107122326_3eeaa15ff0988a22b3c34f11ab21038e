   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_40)
         {
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_231,_windowManager,_assetLibrary);
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_304,_windowManager,_assetLibrary);
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_314,_windowManager,_assetLibrary);
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_294,_windowManager,_assetLibrary);
         ...
         if(var_78 && var_170 == "")
         {
            var_78.switchCategory(FigureData.const_231);
         }
      }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case FigureData.const_304:
               var_52 = "tab_hat";
               break;
            case FigureData.const_314:
               var_52 = "tab_accessories";
               break;
            case FigureData.const_294:
               var_52 = "tab_eyewear";
               break;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_accessories":
                  this.switchCategory(FigureData.const_314);
                  break;
               case "tab_eyewear":
                  this.switchCategory(FigureData.const_294);
                  break;
               case "tab_masks":
