package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_387:AdImageRequest;
      
      private var var_1245:BitmapData = null;
      
      private var var_1244:BitmapData = null;
      ...
      {
         this.var_278 = param2 as IHabboCommunicationManager;
         if(this.var_278 == null)
         {
            return;
         }
         this._connection = this.var_278.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2581 = this._config.getKey("interstitial.enabled","false") == "AvatarEditorGridColorItem";
         this.var_2578 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2579 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1899 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_250 != null && this.var_250.running)
         {
            this.var_250.reset();
            return false;
         }
         if(this.var_1243 == 0)
         {
            this.var_1243 = getTimer();
            return false;
         }
         if(this.var_1899 > 0 && this.var_1900 >= this.var_1899)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1243;
         if(_loc1_ > this.var_2578)
         {
            ++this.var_1900;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1518 = _loc2_.imageUrl;
         this.var_2580 = _loc2_.clickUrl;
         this.var_1243 = getTimer();
         if(this.var_1518 != "")
         {
            _loc3_ = this.var_1518;
            ...
            {
               this.var_250 = new Timer(this.var_2579,1);
               this.var_250.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_250.running)
            {
               this.var_250.reset();
            }
            this.var_250.start();
            _loc4_ = new URLRequest(this.var_1518);
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_41,this.interstitialLoaderEventHandler);
         }
         else
         {
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_572,param1.bitmapData,this.var_2580));
            this.var_1243 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_551));
         }
      }
      
      public function showRoomAd(param1:int, param2:int) : void
      {
         this.var_387 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_387 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_387 = new AdImageRequest(this.var_387.roomId,this.var_387.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_387 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_557,this.var_387.roomId,this.var_387.roomCategory,_loc4_,_loc2_.assetName,this.var_387.clickURL,this.var_1245,this.var_1244));
            this.var_387 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1245 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1244 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         var _loc8_:Array = this.var_668.getValue(_loc7_);
         if(_loc8_ == null)
         {
            _loc8_ = new Array();
            this.var_668.add(_loc7_,_loc8_);
         }
         if(_loc8_.length > 0)
         {
         ...
         _loc10_.addEventListener(AssetLoaderEvent.const_41,this.onBillboardImageLoadError);
      }
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_668.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_750,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_668.remove(_loc2_.assetName);
