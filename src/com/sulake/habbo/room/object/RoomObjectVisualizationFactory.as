package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1361 = param2 as IAvatarRenderManager;
      }
      ...
      public function createRoomObjectVisualization(param1:String) : IRoomObjectGraphicVisualization
      {
         ...
         switch(param1)
         {
            case RoomObjectVisualizationEnum.ROOM:
               ...
               break;
            case RoomObjectVisualizationEnum.const_374:
               _loc2_ = PublicRoomVisualization;
               break;
            case RoomObjectVisualizationEnum.const_356:
               _loc2_ = PublicRoomParkVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1253:
            ...
            case RoomObjectVisualizationEnum.BOT:
               _loc2_ = AvatarVisualization;
               break;
            case RoomObjectVisualizationEnum.const_58:
               _loc2_ = PetVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1389:
               _loc2_ = AnimatedPetVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1340:
               _loc2_ = FurnitureVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1171:
               _loc2_ = AnimatedFurnitureVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1242:
            ...
            case RoomObjectVisualizationEnum.const_327:
               ...
               break;
            case RoomObjectVisualizationEnum.const_1247:
               _loc2_ = FurnitureValRandomizerVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1279:
            ...
            case RoomObjectVisualizationEnum.const_1401:
               ...
               break;
            case RoomObjectVisualizationEnum.const_1748:
               _loc2_ = FurnitureCuboidVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1384:
               _loc2_ = FurnitureGiftWrappedVisualization;
               break;
            case RoomObjectVisualizationEnum.const_330:
               _loc2_ = FurnitureCounterClockVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1333:
            ...
            case RoomObjectVisualizationEnum.const_354:
               ...
               break;
            case RoomObjectVisualizationEnum.const_347:
               _loc2_ = FurnitureRoomBillboardVisualization;
               break;
            case RoomObjectVisualizationEnum.const_383:
