package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_704:Number = 0.25;
      
      private static const const_1234:Number = 0.25;
      
      public static const const_73:int = -110;
      
      public static const const_118:int = -100;
      ...
      private var var_1577:Number = 1.0;
      
      private var var_1050:Number = 1.0;
      
      private var var_972:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            while(_loc7_ < param1)
            {
               _loc4_[_loc7_] = const_73;
               _loc5_[_loc7_] = const_73;
               _loc6_[_loc7_] = false;
               _loc7_++;
            }
            this.var_122.push(_loc4_);
            this._tileMatrixOriginal.push(_loc5_);
            this.var_559.push(_loc6_);
            _loc3_++;
         }
         this.var_225 = param1;
         this._height = param2;
         this._minX = this.var_225;
         this.var_481 = -1;
         this.var_482 = this._height;
         this.var_483 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_225 && param2 >= 0 && param2 < this._height)
         {
            _loc4_ = this.var_122[param2] as Array;
            ...
            if(param3 >= 0)
            {
               ...
               if(param1 > this.var_481)
               {
                  this.var_481 = param1;
               }
               if(param2 < this.var_482)
               {
                  this.var_482 = param2;
               }
               if(param2 > this.var_483)
               {
                  this.var_483 = param2;
               }
            }
            ...
            {
               if(param1 == this._minX || param1 == this.var_481)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_482;
                  while(_loc6_ < this.var_483)
                  {
               ...
               if(param2 == this.var_482 || param2 == this.var_483)
               {
                  _loc7_ = false;
                  _loc8_ = this._minX;
                  while(_loc8_ < this.var_481)
                  {
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_122[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_225)
            {
               this._tileMatrixOriginal[_loc3_][_loc2_] = this.var_122[_loc3_][_loc2_];
               _loc2_++;
            }
            _loc3_++;
         }
         var _loc4_:Point = findEntranceTile(this.var_122);
         _loc3_ = 0;
         while(_loc3_ < this._height)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_225)
            {
               if(this.var_559[_loc3_][_loc2_])
               {
                  this.var_122[_loc3_][_loc2_] = const_118;
               }
               _loc2_++;
            }
            _loc3_++;
      ...
      private function initialize(param1:Point, param2:Boolean) : Boolean
      {
         ...
         if(param1 != null)
         {
            ...
            this.setTileHeight(param1.x,param1.y,const_73);
         }
         this.var_972 = getFloorHeight(this.var_122);
         if(!param2)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_122.length)
         {
            _loc4_ = this.var_122[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      private function createWallPlanes() : Boolean
      {
         ...
         {
            if(this.getTileHeightInternal(_loc8_,_loc9_) > const_118)
            {
               _loc9_--;
               break;
            }
         ...
         if(_loc22_)
         {
            ...
            while(_loc2_ < _loc26_)
            {
               if(!_loc20_[_loc2_])
               {
                  ...
                  {
                     if(this.getTileHeightInternal(_loc29_.x + _loc3_ * _loc30_.x - _loc31_.x,_loc29_.y + _loc3_ * _loc30_.y - _loc31_.y) == const_118)
                     {
                        _loc20_[_loc2_] = true;
                        break;
                     }
      ...
      private function extractTopWall(param1:Point) : Point
      {
         ...
         while(_loc2_ < 1000)
         {
            if(this.getTileHeightInternal(param1.x + _loc2_,param1.y) > const_118)
            {
               return new Point(param1.x + _loc2_ - 1,param1.y);
            }
            if(this.getTileHeightInternal(param1.x + _loc2_,param1.y + 1) <= const_118)
            {
      ...
      private function extractRightWall(param1:Point) : Point
      {
         ...
         while(_loc2_ < 1000)
         {
            if(this.getTileHeightInternal(param1.x,param1.y + _loc2_) > const_118)
            {
               return new Point(param1.x,param1.y + (_loc2_ - 1));
            }
            if(this.getTileHeightInternal(param1.x - 1,param1.y + _loc2_) <= const_118)
            {
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_308,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_460,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1234 * this.var_1577;
         var _loc9_:Number = const_704 * this.var_1050;
         ...
         this.addPlane(RoomPlaneData.const_308,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_308,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_308,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_308,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      private function getHeightMapWidth(param1:Array) : int
      {
         ...
         while(_loc6_ < _loc2_)
         {
            ...
            _loc4_ = this.var_122[_loc6_] as Array;
      ...
      private function extractFloorPlane(param1:Array, param2:Boolean) : Boolean
      {
         ...
         if(param1 == null || this.var_122 == null || param1 == this.var_122)
         {
            return false;
         }
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:* = null;
         if(param1.length > this.var_122.length)
         {
            return false;
         }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_313,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_704 * this.var_1050;
            _loc19_ = _loc18_;
            if(this.var_1050 > 1)
            {
               _loc19_ = const_704;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_313,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_313,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_313,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_313,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_225}" height="{this._height}" wallHeight="{this.var_1576}"/>;
         var _loc2_:int = 0;
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_340.length)
         {
            _loc12_ = this.var_340.getWithIndex(_loc4_);
            if(_loc12_ != null)
            {
               _loc13_ = this.var_340.getKey(_loc4_);
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_161[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1374;
         }
         var _loc2_:RoomPlaneData = this.var_161[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_161[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
      ...
      public function addFloorHole(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_340.add(param1,_loc6_);
      }
      
      public function removeFloorHole(param1:int) : void
      {
         this.var_340.remove(param1);
      }
      ...
      private function initializeHoleMap() : void
      {
         ...
         while(_loc2_ < this._height)
         {
            _loc3_ = this.var_559[_loc2_];
            _loc1_ = 0;
            while(_loc1_ < this.var_225)
            {
               _loc3_[_loc1_] = false;
               _loc1_++;
            }
         ...
         while(_loc4_ < this.var_340.length)
         {
            _loc5_ = this.var_340.getWithIndex(_loc4_);
            if(_loc5_ != null)
            {
               _loc6_ = _loc5_.x;
               ...
               _loc7_ = _loc7_ >= this.var_225 ? int(this.var_225 - 1) : int(_loc7_);
