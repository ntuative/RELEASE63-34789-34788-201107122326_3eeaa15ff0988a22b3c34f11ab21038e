package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_526,RoomObjectRoomActionEvent.const_628];
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1586:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_526,0,_loc4_,_loc5_);
                     break;
                  case const_1588:
                  case const_1587:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_628,0,_loc4_,_loc5_);
               }
         }
