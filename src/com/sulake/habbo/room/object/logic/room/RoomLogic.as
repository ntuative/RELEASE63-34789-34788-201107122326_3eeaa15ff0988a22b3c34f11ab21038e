package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1532:uint = 16777215;
      
      private var var_1919:int = 255;
      
      private var var_1266:uint = 16777215;
      
      private var var_1916:int = 255;
      
      private var var_1265:int = 0;
      
      private var var_1918:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_640,RoomObjectMouseEvent.const_162];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_769,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_879,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_977,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_914,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1002,1);
         }
      }
         ...
         if(this.var_1533)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_769,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1355,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1265)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1917;
            if(_loc2_ - this.var_1265 >= this.var_1918)
            {
               _loc3_ = this.var_1266;
               _loc4_ = this.var_1916;
               this.var_1265 = 0;
            }
            else
            {
               _loc7_ = this.var_1532 >> 16 & 255;
               _loc8_ = this.var_1532 >> 8 & 255;
               _loc9_ = this.var_1532 & 255;
               _loc10_ = this.var_1266 >> 16 & 255;
               _loc11_ = this.var_1266 >> 8 & 255;
               _loc12_ = this.var_1266 & 255;
               _loc13_ = (_loc2_ - this.var_1265) / this.var_1918;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1919 + (this.var_1916 - this.var_1919) * _loc13_;
               this._color = _loc3_;
               this.var_1917 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_879,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_980:
               param2.setString(RoomObjectVariableEnum.const_228,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_771:
               param2.setString(RoomObjectVariableEnum.const_233,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_895:
               param2.setString(RoomObjectVariableEnum.const_218,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_607:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_315)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_858:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1214,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1383:
               param2.setNumber(RoomObjectVariableEnum.const_977,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1191:
               param2.setNumber(RoomObjectVariableEnum.const_914,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_1002,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_704:
               param2.setNumber(RoomObjectVariableEnum.const_1194,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1234:
               param2.setNumber(RoomObjectVariableEnum.const_1308,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_174:
               this._planeParser.addFloorHole(param1.id,param1.x,param1.y,param1.width,param1.height);
               this.var_1533 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_154:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1227,int(param1.bgOnly));
         this.var_1532 = this._color;
         this.var_1919 = this.var_1917;
         this.var_1266 = _loc3_;
         this.var_1916 = _loc4_;
         this.var_1265 = getTimer();
         this.var_1918 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_674,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1863,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1979,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1738,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_674,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_308 || _loc12_ == RoomPlaneData.const_460)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
