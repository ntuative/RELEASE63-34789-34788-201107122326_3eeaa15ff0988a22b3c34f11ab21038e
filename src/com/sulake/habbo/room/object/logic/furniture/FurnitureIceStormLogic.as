package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_3036:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_3036 = param1.extra;
            this.var_1397 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1397 > 0 && param1 >= this.var_1397)
         {
            this.var_1397 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_2200,String(this.var_2200),this.var_3036);
