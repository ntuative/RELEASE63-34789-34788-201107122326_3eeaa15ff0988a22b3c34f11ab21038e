package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneData
   {
      ...
      public static const const_460:int = 3;
      ...
      private var var_2771:Vector3d = null;
      ...
      public function RoomPlaneData(param1:int, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Array)
      {
         ...
         if(param3 != null && param4 != null)
         {
            ...
            this.var_2771 = new Vector3d(_loc6_,_loc7_,_loc8_);
         }
      ...
      {
         return this.var_1588.length;
      }
      
      public function get maskCount() : int
      {
         return this.var_205.length;
      }
      ...
      public function getSecondaryNormal(param1:int) : IVector3d
      {
         ...
         _loc2_.assign(this.var_1588[param1] as IVector3d);
         return _loc2_;
      }
