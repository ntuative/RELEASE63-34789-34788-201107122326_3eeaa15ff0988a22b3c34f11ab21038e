package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_2014:int = 16777215;
      
      public static const const_1926:int = 13421772;
      
      private static const const_1110:int = 16777215;
      
      private static const const_1108:int = 13421772;
      
      private static const const_1109:int = 10066329;
      
      private static const const_1107:int = 10066329;
      
      public static const const_1988:int = 16777215;
      
      public static const const_1997:int = 13421772;
      
      public static const const_1947:int = 10066329;
      ...
      private var var_847:Rectangle = null;
      ...
      private var var_1050:Number = NaN;
      
      private var var_1577:Number = NaN;
      
      private var var_2753:Number = NaN;
      
      private var var_2002:String = null;
      
      private var var_1312:uint = 16777215;
      
      private var var_2752:int = 255;
      
      private var var_2755:int = 255;
      
      private var var_2754:int = 255;
      
      private var var_2000:Boolean = true;
      
      private var var_1313:int = 0;
      
      private var _lastUpdateTime:int = -1000;
      
      private const const_2366:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_341["null"] = false;
         this.var_341["null"] = true;
         this.var_341["null"] = true;
         this.var_341["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_847 = super.boundingRectangle;
         }
         return new Rectangle(this.var_847.x,this.var_847.y,this.var_847.width,this.var_847.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_78 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
               ...
               if(_loc3_.type == RoomPlane.const_78)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1050))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1050;
         }
         if(!isNaN(this.var_1577))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1577;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_769);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1373);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_308)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_78,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_460)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1988;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1997;
               }
               else
               {
                  _loc13_.color = const_1947;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1823)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_78,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_460)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2366 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_399.length)
            {
               _loc11_ = this.var_695[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_399[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2000)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2754 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2755 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2752 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1738)
         {
            this.var_1738 = param1.updateId;
            this.var_847 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1447 || _loc3_.y != this.var_2294 || _loc3_.z != this.var_2295 || param1.scale != this.var_2001))
            {
               this.var_1447 = _loc3_.x;
               this.var_2294 = _loc3_.y;
               this.var_2295 = _loc3_.z;
               this.var_2001 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1214);
            if(_loc3_ != this.var_2002)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2002 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_879));
            if(_loc4_ != this.var_1312)
            {
               this.var_1312 = _loc4_;
               this.var_2754 = this.var_1312 & 255;
               this.var_2755 = this.var_1312 >> 8 & 255;
               this.var_2752 = this.var_1312 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1227));
            if(_loc5_ != this.var_2000)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_233);
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_977));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_914));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1002));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1194);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1308);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1050 || _loc3_ != this.var_1577))
            {
               this.var_1050 = _loc2_;
               this.var_1577 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1355);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2753)
            {
               this.var_2753 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_161.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_78 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_341["null"] || param2 != this.var_341["null"] || param3 != this.var_341["null"])
         {
            this.var_341["null"] = param1;
            this.var_341["null"] = param2;
            this.var_341["null"] = param3;
            this.var_399 = [];
            this.var_695 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_399;
         if(this.var_399.length == 0)
         {
            _loc6_ = this.var_161;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_399.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_341[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_399.push(_loc12_);
                        this.var_695.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1313;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_561.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_561.maskCount)
         {
            _loc10_ = this.var_561.getMaskType(_loc8_);
            _loc11_ = this.var_561.getMaskLocation(_loc8_);
            _loc12_ = this.var_561.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_161.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_78 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_78 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_315)
                              {
