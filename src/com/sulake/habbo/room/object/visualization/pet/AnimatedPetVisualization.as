package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1460:String = "head";
      
      private static const const_690:int = 1;
      
      private static const const_1063:int = 1000;
      
      private static const const_1462:String = "pet_experience_bubble_png";
      
      private static const const_1463:int = 0;
      
      private static const const_1461:int = 1;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_980 = [];
         super();
         while(this.var_137.length < ANIMATION_INDEX_COUNT)
         {
            this.var_137.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_137.length)
            {
               _loc2_ = this.var_137[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1462) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2466)
            {
               this.var_2466 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_289);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_169);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_289);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_169);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_2046 = _loc3_.getNumber(RoomObjectVariableEnum.const_266) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_213);
            if(!isNaN(_loc8_))
            {
            ...
            {
               this.var_1826 = direction;
            }
            this.var_1488 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2381 = _loc3_.getNumber(RoomObjectVariableEnum.const_463);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_747);
            if(_loc9_ != this.var_1827)
            {
               this.var_1827 = _loc9_;
               this.var_2465 = this.var_1827.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_375 != null)
         {
            ...
            if(this.var_1488 > 0)
            {
               _loc2_ = param1 - this.var_1488;
               if(_loc2_ < const_1063)
               {
                  this.var_375.alpha = int(Math.sin(_loc2_ / const_1063 * 0) * 255);
      ...
      {
         return super.getAdditionalSpriteCount() + const_690;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_137.length)
         {
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1487 = false;
         var _loc1_:int = this.var_137.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_137[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function updateAnimations(param1:Number) : int
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_137.length)
         {
            _loc5_ = this.var_137[_loc4_];
            if(_loc5_ != null)
            {
      ...
      override protected function getFrameNumber(param1:int, param2:int) : int
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:int = this.var_137.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_137[_loc3_];
            if(_loc4_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_137.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_137[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2465);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_690)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_690))
            {
               if(param2 >= FurnitureVisualizationData.const_623.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_623[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1826);
         }
         return direction;
      }
      ...
      {
         if(this.var_980[param1] == null)
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1460)
            {
               this.var_980[param1] = true;
            }
            else
            {
               this.var_980[param1] = false;
            }
         }
