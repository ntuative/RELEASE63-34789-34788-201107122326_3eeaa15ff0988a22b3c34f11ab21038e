package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1616:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1348)
            {
      ...
      {
         if(this.var_2858 == param1 && this.var_2857 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1616)
            {
               this.var_2079 = _loc2_;
               this.var_2858 = param1;
               this.var_2857 = direction;
               return this.var_2079;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1348.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_580 + 2;
         var _loc4_:int = this.var_719 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_718[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_718[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_580 == 0 || this.var_719 == 0)
         {
            ...
            this.var_580 = _loc2_.getNumber(RoomObjectVariableEnum.const_277);
            this.var_719 = _loc2_.getNumber(RoomObjectVariableEnum.const_355);
         }
         this.var_498 = [];
         this.var_718 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_580 * 2 + this.var_719 * 2)
         {
            this.var_498.push(false);
            this.var_718.push(ShoreMaskCreatorUtility.const_85);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_580 + 2;
         var _loc2_:int = this.var_719 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_80,getSize(param3),this.var_498,this.var_718,assetCollection);
      }
