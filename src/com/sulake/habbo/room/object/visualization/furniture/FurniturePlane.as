package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_766:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_766 = new Vector3d();
         this.var_766.assign(param2);
      ...
      {
         if(param1 != this.var_2293)
         {
            if(!param1)
            {
               this.var_322.assign(this.var_766);
               this.var_321.assign(this.var_765);
            }
            else
            {
               this.var_322.assign(this.var_766);
               this.var_322.mul(this.var_765.length / this.var_766.length);
               this.var_321.assign(this.var_765);
               this.var_321.mul(this.var_766.length / this.var_765.length);
            }
            this.var_1738 = -1;
            this.var_1447 = this.var_1447 - 1;
      ...
      private function needsNewTexture(param1:IRoomGeometry) : Boolean
      {
         ...
         if(this.var_225 > 0 && this._height > 0)
         {
            if(_loc3_ == null)
            {
               return true;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_104 == null && this.var_1167 != null || this.var_322 == null || this.var_321 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1738)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1447 || _loc4_.y != this.var_2294 || _loc4_.z != this.var_2295 || param1.scale != this.var_2001))
            {
               this.var_1447 = _loc4_.x;
               this.var_2294 = _loc4_.y;
               this.var_2295 = _loc4_.z;
               ...
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_171.z - _loc7_,this.var_129.z - _loc7_,this.var_97.z - _loc7_,this.var_128.z - _loc7_);
