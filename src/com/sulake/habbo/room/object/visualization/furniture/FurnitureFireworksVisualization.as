package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_247:FurnitureParticleSystem;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_659)
         {
            for each(_loc1_ in this.var_659)
            {
               _loc1_.dispose();
            }
            this.var_659 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_247 = this.var_659[param1];
               _loc3_ = true;
            }
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_247)
         {
            this.var_247.setAnimation(param1);
         }
      ...
      {
         if(this.var_247 && this.var_247.controlsSprite(param3))
         {
            return this.var_247.getSpriteYOffset(param1,param2,param3);
         }
