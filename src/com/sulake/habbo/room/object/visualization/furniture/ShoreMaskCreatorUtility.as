package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      public static const const_164:int = 0;
      
      public static const const_85:int = 1;
      ...
      {
         return param1 + param2 * const_1542;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_164,const_85,const_70,const_164,const_85,const_70];
                     _loc8_ = [const_85,const_85,const_85,const_70,const_70,const_70];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
