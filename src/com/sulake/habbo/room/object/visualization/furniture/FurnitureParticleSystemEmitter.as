package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1852:String = "cone";
      
      public static const const_1766:String = "plane";
      
      public static const const_1977:String = "sphere";
       
      
      private var _name:String;
      
      private var var_2996:int = -1;
      
      private var var_2998:Number;
      
      private var _direction:Vector3D;
      
      private var var_1119:Number = 0.1;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_2994 = param9;
         this._energy = param8;
         this.var_2997 = param10;
         this.reset();
      }
      ...
      public function reset() : void
      {
         ...
         this.var_1118 = 0;
         this.var_1077 = false;
         this.init(0,0,0,this._direction,this.var_2998,this.var_1119,this.var_2994,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1374.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1077 = true;
         if(this.var_1118 < this.var_1675)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2993)
         {
            switch(this.var_2995)
            {
               case const_1852:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1119,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_416.push(_loc4_);
            ++this.var_1118;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1374.length);
         return this.var_1374[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1118 < this.var_1675)
         {
            if(this.age % this.var_2997 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1118 < this.var_1675)
         {
            ...
            this.y = (2 - this.var_310) * this.y - (1 - this.var_310) * this.lastY + this.var_2166 * this.var_1119 * this.var_1119;
         ...
         for each(_loc2_ in this.var_416)
         {
            ...
            _loc2_.y = (2 - this.var_310) * _loc2_.y - (1 - this.var_310) * _loc2_.lastY + this.var_2166 * this.var_1119 * this.var_1119;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_416.splice(this.var_416.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
