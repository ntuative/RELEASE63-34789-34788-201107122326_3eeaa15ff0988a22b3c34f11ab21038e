package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_814:String = "RCL_LOADER_READY";
      
      private static const const_387:String = "RCL_PUBLICROOM_";
      ...
      private static const const_473:String = "place_holder";
      
      private static const const_687:String = "wall_place_holder";
      
      private static const const_686:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_473;
      
      private static const const_685:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1052:String = "selection_arrow";
      ...
      private var var_776:Map = null;
      
      private var var_440:Map = null;
      
      private var var_586:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1460:IEventDispatcher = null;
      ...
      private var var_961:Map = null;
      
      private var _pets:Dictionary;
      
      private var var_962:Map = null;
      
      private var var_215:PublicRoomData = null;
      
      private var var_1459:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2348 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2350 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1053)
         {
            return;
         }
         this.var_1460 = param1;
         this.var_2351 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2349 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_397.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_525.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_525.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_440.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_440.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_369)
            {
               delete this.var_369[_loc1_];
            }
            this.var_369 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_777.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_439.add(_loc3_,_loc4_);
               if(this.var_369[_loc7_] == null)
               {
                  this.var_369[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_624.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_623.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_623.remove(_loc7_);
               this.var_623.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2352)
         {
            ...
            {
               this.var_1460.dispatchEvent(new Event(const_814));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_524 != null)
         {
            ...
            this.var_524.add(param1,param2);
         }
         if(this.var_523 != null)
         {
            this.var_523.remove(param2);
            this.var_523.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_524 != null)
         {
            _loc2_ = this.var_524.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_523 != null)
         {
            _loc2_ = this.var_523.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_215 != null && (this.var_215.type == param1 || this.var_215.hasWorldType(param1)))
         {
         ...
         {
            return RoomObjectCategoryEnum.const_342;
         }
         return RoomObjectCategoryEnum.const_155;
      }
      ...
      {
         return [const_473,const_687,const_686,const_685,TILE_CURSOR,const_1052];
      }
      ...
      {
         var _loc3_:String = this.var_624.getValue(param1) as String;
      ...
      {
         return this.var_961.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_962[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_624.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_777.getValue(param1) != null)
         {
            return this.var_777.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_215 != null && this.var_215.hasWorldType(const_387 + param1))
         {
            return this.var_215.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_303 || param1 == RoomObjectVisualizationEnum.const_58 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_623.getValue(param1));
         }
         return 0;
      }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_369[_loc4_] == null)
                     {
                        this.var_369[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_453,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1459.getValue(param1) != null)
         {
            this.var_215 = this.var_1459.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_887,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2348.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_2034);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2350.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_453,_loc5_);
         }
         else
         {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_962.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1459.add(param1,_loc4_);
         this.var_215 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_776.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_776.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_525.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_776.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_525.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_525.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_586.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_440.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_440.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_440[_loc2_] != null)
         {
            _loc3_ = this.var_440.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_387 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_387 + param1) == RoomObjectCategoryEnum.const_86)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_215.getWorldHeightScale(const_387 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_215 != null)
         {
            return this.var_215.getWorldScale(const_387 + param1);
         }
         return 32;
      }
