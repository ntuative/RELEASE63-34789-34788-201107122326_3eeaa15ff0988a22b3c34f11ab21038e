package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      private var var_1979:Map;
      
      private var var_1294:Map;
      
      private var var_1037:Array;
      
      public function RoomObjectFactory(param1:IContext, param2:uint = 0)
      {
         this.var_1979 = new Map();
         this.var_1294 = new Map();
         this.var_1037 = [];
         super(param1,param2);
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1037.indexOf(param1) < 0)
         {
            this.var_1037.push(param1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1294.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_1037.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_1037.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1294.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1294.getValue(param1) == null)
         {
            this.var_1294.add(param1,true);
            for each(_loc2_ in this.var_1037)
            {
               if(_loc2_ != null)
               {
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectLogicEnum.const_328:
               ...
               break;
            case RoomObjectLogicEnum.const_1936:
            ...
            case RoomObjectLogicEnum.const_1930:
               ...
               break;
            case RoomObjectLogicEnum.const_1875:
               _loc2_ = FurnitureSoundMachineLogic;
               break;
            case RoomObjectLogicEnum.const_1861:
               _loc2_ = FurnitureJukeboxLogic;
               break;
            case RoomObjectLogicEnum.const_1960:
               _loc2_ = FurnitureSongDiskLogic;
               break;
            case RoomObjectLogicEnum.const_2038:
            ...
            case RoomObjectLogicEnum.const_383:
               ...
               break;
            case RoomObjectLogicEnum.const_2021:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1979.getValue(param1) == null)
            {
               this.var_1979.add(param1,true);
