package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_11:IRoomCreator = null;
      ...
      public function setCurrentRoom(param1:int, param2:int) : void
      {
         if(this.var_1024 != 0 || this.var_1025 != 0)
         {
            if(this.var_11 != null)
            {
               this.var_11.disposeRoom(this.var_1024,this.var_1025);
            }
         }
      ...
      private function isPublicRoom(param1:int, param2:int) : Boolean
      {
         if(this.var_11)
         {
            return this.var_11.isPublicRoom(param1,param2);
         }
         return false;
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new SleepMessageEvent(this.method_6));
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(this.var_1024 != _loc3_.roomId || this.var_1025 != _loc3_.roomCategory)
         {
         ...
         if(this.var_11 != null)
         {
            this.var_11.setWorldType(_loc3_.roomId,_loc3_.roomCategory,_loc4_);
         }
         if(this.var_1940)
         {
         ...
         if(this.var_11 != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               while(_loc5_ < _loc4_)
               {
                  ...
                  this.var_11.setRoomObjectAlias(_loc6_,_loc7_);
                  _loc5_++;
               }
            }
         }
      ...
      private function onHeightMap(param1:IMessageEvent) : void
      {
         ...
         this.var_11.setTileHeightMap(_loc4_,_loc5_,_loc8_);
      }
      ...
      private function onHeightMapUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:TileHeightMap = this.var_11.getTileHeightMap(_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
      ...
      private function onRoomVisualizationSettings(param1:IMessageEvent) : void
      {
         ...
         if(this.var_11 != null)
         {
            this.var_11.updateObjectRoomVisibilities(_loc4_,_loc5_,_loc6_,true);
            this.var_11.updateObjectRoomPlaneThicknesses(_loc4_,_loc5_,_loc8_,_loc9_);
         }
      }
      ...
      private function onRoomProperty(param1:IMessageEvent) : void
      {
         ...
         if(this.var_11 != null)
         {
            this.var_11.updateObjectRoom(_loc4_,_loc5_,_loc6_,_loc7_,_loc8_);
         }
      }
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:LegacyWallGeometry = this.var_11.getLegacyGeometry(_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         ...
         var _loc14_:TileHeightMap = this.var_11.getTileHeightMap(_loc4_,_loc5_);
         if(_loc14_ == null)
         {
            return;
         }
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc19_ < _loc7_)
            {
               ...
               if(!_loc13_)
               {
                  if((_loc15_ > 0 && _loc15_ < _loc8_ - 1 || _loc19_ > 0 && _loc19_ < _loc7_ - 1) && _loc20_ != RoomPlaneParser.const_73)
                  {
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.const_73 && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.const_73 && _loc3_.getTileHeight(_loc19_,_loc15_ + 1) == RoomPlaneParser.const_73)
                     {
                     ...
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.const_73 && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.const_73 && _loc3_.getTileHeight(_loc19_ + 1,_loc15_) == RoomPlaneParser.const_73)
                     {
         ...
         this.var_11.initializeRoom(_loc4_,_loc5_,_loc18_);
         if(this.var_833.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_833.objectData);
            this.var_833.objectData = null;
         }
         else
         {
            this.var_833.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_833.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_833.objectData = _loc6_;
         }
      }
      ...
      private function onObjectUpdate(param1:IMessageEvent) : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            this.var_11.updateObjectFurniture(_loc4_,_loc5_,_loc6_.id,_loc7_,_loc8_,_loc6_.state,_loc6_.data,_loc6_.extra);
         }
      }
      ...
      private function onObjectDataUpdate(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectFurniture(_loc4_,_loc5_,_loc6_,null,null,_loc7_,_loc8_);
      }
      ...
      private function onObjectsDataUpdate(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.objectCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = _loc7_.state;
               _loc10_ = _loc7_.data;
               this.var_11.updateObjectFurniture(_loc4_,_loc5_,_loc8_,null,null,_loc9_,_loc10_);
            }
            _loc6_++;
         }
      }
      ...
      private function onObjectRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:int = _loc3_.id;
         this.var_11.disposeObjectFurniture(_loc4_,_loc5_,_loc6_);
      }
      
      private function addActiveObject(param1:int, param2:int, param3:ObjectMessageData) : void
      {
         if(param3 == null || this.var_11 == null)
         {
            return;
         }
         ...
         {
            this.var_11.addObjectFurnitureByName(param1,param2,param3.id,param3.staticClass,_loc4_,_loc5_,param3.state,param3.data,param3.extra);
         }
         else
         {
            this.var_11.addObjectFurniture(param1,param2,param3.id,param3.type,_loc4_,_loc5_,param3.state,param3.data,param3.extra,param3.expiryTime,param3.knownAsUsable);
         }
      }
      ...
      private function addPassiveObject(param1:int, param2:int, param3:PublicRoomObjectMessageData) : void
      {
         ...
         this.var_11.addObjectFurnitureByName(param1,param2,_loc6_,param3.type,_loc4_,_loc5_,0,"");
      }
      ...
      private function onItemRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_11.disposeObjectWallItem(_loc4_,_loc5_,_loc3_.itemId);
      }
      ...
      private function onItemUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:LegacyWallGeometry = this.var_11.getLegacyGeometry(_loc4_,_loc5_);
         if(this.var_11 == null || _loc6_ == null)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            ...
            this.var_11.updateObjectWallItem(_loc4_,_loc5_,_loc7_.id,_loc8_,_loc9_,_loc7_.state,_loc7_.data);
         }
      }
      ...
      private function onItemDataUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_11.updateObjectWallItemData(_loc4_,_loc5_,_loc3_.id,_loc3_.itemData);
      }
      ...
      private function addWallItem(param1:int, param2:int, param3:ItemMessageData) : void
      {
         ...
         var _loc4_:LegacyWallGeometry = this.var_11.getLegacyGeometry(param1,param2);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         this.var_11.addObjectWallItem(param1,param2,param3.id,param3.type,_loc5_,_loc6_,param3.state,param3.data,param3.knownAsUsable);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.getUserCount())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               this.var_11.addObjectUser(_loc4_,_loc5_,_loc7_.id,_loc8_,_loc9_,_loc7_.dir,_loc10_,_loc7_.figure);
               if(_loc7_.webID == this.var_2637)
               {
                  this.var_11.setOwnUserId(_loc4_,_loc5_,_loc7_.id);
               }
               this.var_11.updateObjectUserFigure(_loc4_,_loc5_,_loc7_.id,_loc7_.figure,_loc7_.sex,_loc7_.subType);
            }
            _loc6_++;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:IRoomInstance = this.var_11.getRoom(_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_936);
         var _loc8_:int = 0;
         while(_loc8_ < _loc3_.userUpdateCount)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               this.var_11.updateObjectUser(_loc4_,_loc5_,_loc9_.id,_loc11_,_loc13_,_loc12_,_loc9_.dirHead);
               _loc14_ = "null";
               _loc15_ = "";
               this.var_11.updateObjectUserFlatControl(_loc4_,_loc5_,_loc9_.id,null);
               _loc16_ = false;
               _loc17_ = false;
               for each(_loc18_ in _loc9_.actions)
               {
                  ...
                  {
                     case "flatctrl":
                        this.var_11.updateObjectUserFlatControl(_loc4_,_loc5_,_loc9_.id,_loc18_.actionParameter);
                        break;
                     case "sign":
                        this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc9_.id,RoomObjectVariableEnum.const_425,int(_loc18_.actionParameter));
                        break;
                     case "gst":
                        this.var_11.updateObjectPetGesture(_loc4_,_loc5_,_loc9_.id,_loc18_.actionParameter);
                        break;
                     case "wav":
                     case "mv":
                        _loc17_ = true;
               ...
               this.var_11.updateObjectUserPosture(_loc4_,_loc5_,_loc9_.id,_loc14_,_loc15_);
            }
            _loc8_++;
         }
      }
      ...
      private function onUserRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_11.disposeObjectUser(_loc4_,_loc5_,_loc3_.id);
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserFigure(_loc3_,_loc4_,_loc2_.id,_loc2_.figure,_loc2_.sex);
      }
      ...
      private function onWave(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_248,_loc6_);
      }
      ...
      private function onDance(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_649,_loc3_.danceStyle);
      }
      ...
      private function onAvatarEffect(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_11.updateObjectUserEffect(_loc4_,_loc5_,_loc3_.userId,_loc3_.effectId,_loc3_.delayMilliSeconds);
      }
      ...
      private function method_6(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_266,_loc6_);
      }
      ...
      private function onCarryObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is CarryObjectMessageEvent)
         {
            ...
            this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_370,_loc2_.itemType,_loc2_.itemName);
         }
      }
      ...
      private function onUseObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is UseObjectMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_283,_loc2_.itemType);
         }
      }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_11.updateObjectFurniture(_loc3_,_loc4_,_loc2_.id,null,null,1,null);
            this.var_11.updateObjectFurniture(_loc3_,_loc4_,_loc2_.id,null,null,2,null);
            ...
            while(_loc6_ < _loc5_.length)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_11.updateObjectFurnitureLocation(_loc3_,_loc4_,_loc7_.id,_loc7_.loc,_loc7_.target);
               }
               _loc6_++;
            }
            if(_loc2_.avatar != null)
            {
               ...
               this.var_11.updateObjectUser(_loc3_,_loc4_,_loc8_.id,_loc8_.loc,_loc8_.target);
               switch(_loc8_.moveType)
               {
                  case SlideObjectMessageData.const_1190:
                     _loc9_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1338:
                     _loc9_ = "std";
               }
               this.var_11.updateObjectUserPosture(_loc3_,_loc4_,_loc8_.id,_loc9_);
            }
         }
      }
      ...
      private function onChat(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:int = this.getRoomId(_loc2_.roomId);
         var _loc4_:int = this.getRoomCategory(_loc2_.roomCategory);
         this.var_11.updateObjectUserGesture(_loc3_,_loc4_,_loc2_.userId,_loc2_.gesture);
         this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_200,Math.ceil(_loc2_.text.length / 10));
      }
      ...
      private function onTypingStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_616,_loc6_);
      }
      ...
      private function onPetExperience(param1:PetExperienceEvent) : void
      {
         ...
         var _loc3_:int = this.getRoomId(_loc2_.roomId);
         var _loc4_:int = this.getRoomCategory(_loc2_.roomCategory);
         this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.petRoomIndex,RoomObjectVariableEnum.const_463,_loc2_.gainedExperience);
      }
      ...
      private function onDiceValue(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectFurniture(_loc4_,_loc5_,_loc6_,null,null,_loc7_,"");
      }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:IRoomObject = this.var_11.getObjectRoom(_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1249,_loc3_.status);
         }
      }
      ...
      private function onPlayingGame(param1:YouArePlayingGameMessageEvent) : void
      {
         ...
         this.var_11.setIsPlayingGame(_loc3_,_loc4_,_loc5_);
      }
      ...
      private function onGamePlayerNumberValue(param1:IMessageEvent) : void
      {
         ...
         if(param1 is GamePlayerValueMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_415,_loc2_.value);
         }
      }
   }
}
