package com.sulake.habbo.room.messages
{
   ...
   public class RoomObjectRoomPlanePropertyUpdateMessage extends RoomObjectUpdateMessage
   {
      ...
      public static const const_1234:String = "RORPPUM_WALL_THICKNESS";
      
      public static const const_704:String = "RORPVUM_FLOOR_THICKNESS";
       
      
      private var _type:String = "";
      
      private var var_207:Number = 0.0;
