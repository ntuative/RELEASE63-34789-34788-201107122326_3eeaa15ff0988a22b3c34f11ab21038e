package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_464:String = "_INTERNAL_EVENT_UNLOCKED";
      ...
      public static const const_1354:uint = 4;
       
      
      protected var var_837:uint = 0;
      
      protected var var_1412:String = "";
      ...
      private var var_517:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_517 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_517.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_517.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1412 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1412);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1634 & const_1354)
         {
            if(_loc3_ == 0)
            {
               if(this.var_517.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_946 = false;
            this._events.dispatchEvent(new LockEvent(const_464,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_837 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_517.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_517.getStructByIndex(_loc8_);
