package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_783:Dictionary;
      
      private var var_1467:Array;
      
      private var var_1794:IConnectionStateListener;
      
      public function CoreCommunicationManager(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         this._connections = new Dictionary();
         this.var_1184 = new Dictionary();
         this.var_783 = new Dictionary();
      ...
      override public function dispose() : void
      {
         ...
         this.var_1184 = null;
         this.var_1794 = null;
         for each(_loc2_ in this.var_783)
         {
            while(true)
            {
         ...
         this.var_783 = null;
         for each(_loc3_ in this.var_1467)
         {
         }
         var _loc5_:* = null;
         this.var_1184 = null;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1376:
               _loc3_ = new SocketConnection(param1,this,this.var_1794);
               break;
            default:
      ...
      {
         var _loc2_:Class = this.var_1184[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:Array = this.var_783[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_783[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_783[_loc3_];
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1467)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
