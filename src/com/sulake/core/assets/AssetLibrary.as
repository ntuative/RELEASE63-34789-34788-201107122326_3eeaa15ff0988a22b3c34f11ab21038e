package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1364:String = "AssetLibraryReady";
      
      public static const const_887:String = "AssetLibraryLoaded";
      
      public static const const_2033:String = "AssetLibraryUnloaded";
      
      public static const const_2002:String = "AssetLibraryLoadError";
      
      private static const const_712:String = "name";
      
      private static const const_1132:String = "asset";
      
      private static const const_1130:String = "param";
      ...
      private static var var_2064:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_574;
         this.var_496 = new Dictionary(false);
         this.var_573 = new Dictionary(false);
         this.var_1074 = new Dictionary(false);
         this.var_187 = new Dictionary(false);
         var_1075.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_712 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1131);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1132);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_712);
               ...
               if(_loc9_ != null)
               {
                  _loc10_ = new _loc9_.method_2(_loc9_) as IAsset;
                  _loc10_.setUnknownContent(param3[_loc7_]);
                  _loc11_ = _loc6_.child(const_1130);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_712 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_712 == param1.url && this.var_1073)
         {
            if(!this.var_1076 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_713);
            }
            this.var_1076 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1364));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_573)
         {
            _loc2_ = this.var_573[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_573[_loc1_];
         }
         for(_loc1_ in this.var_187)
         {
            delete this.var_187[_loc1_];
         }
         for(_loc1_ in this.var_1074)
         {
            delete this.var_1074[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
         ...
         this.var_1073 = false;
         this.var_712 = null;
         dispatchEvent(new Event(AssetLibrary.const_2033));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1074[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_573[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1202,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1339,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1367,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_573[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_573[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  asset = new decl.method_2(decl,loader.url);
                  try
                  {
                  ...
                  if(this.var_187[struct.assetName] == null)
                  {
                     ++this.var_497;
                     this.var_495.push(struct.assetName);
                  }
                  this.var_187[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_573[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_187[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_495.length ? this.getAssetByName(this.var_495[param1]) : null;
      }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in this.var_187)
         {
            _loc3_ = this.var_187[_loc2_];
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_187)
         {
            if(this.var_187[_loc2_] == param1)
            {
               return this.var_495.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_187[param1] != null || (this.var_713 != null ? this.var_713[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_187[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            if(_loc4_)
            {
               ++this.var_497;
               this.var_495.push(param1);
            }
            this.var_187[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_2064.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         ...
         var _loc3_:* = new param2.method_2(param2);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_187)
            {
               if(this.var_187[_loc2_] == param1)
               {
                  this.var_495.splice(this.var_495.indexOf(_loc2_),1);
                  delete this.var_187[_loc2_];
                  --this.var_497;
                  return param1;
               }
            }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_496.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_496[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_496[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_496)
         {
            _loc3_ = AssetTypeDeclaration(this.var_496[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.method_2 == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_496)
         {
            _loc4_ = AssetTypeDeclaration(this.var_496[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_713 = _loc2_.resource;
         this.var_712 = _loc2_.url;
         if(this.var_1076)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_713);
         }
         this.var_1073 = true;
         dispatchEvent(new Event(AssetLibrary.const_887));
         dispatchEvent(new Event(AssetLibrary.const_1364));
         if(this.var_1076)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_2002));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1131);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1132);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_712) && _loc3_.attribute(const_712).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_712 + "!");
                     }
                     _loc5_ = new _loc4_.method_2(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_713[param1]);
                     _loc6_ = _loc3_.child(const_1130);
