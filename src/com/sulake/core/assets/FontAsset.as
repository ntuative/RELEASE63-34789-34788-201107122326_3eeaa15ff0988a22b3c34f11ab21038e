package com.sulake.core.assets
{
   ...
   public class FontAsset implements IAsset
   {
      ...
      protected var var_1764:AssetTypeDeclaration;
      
      protected var var_211:Font;
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         try
         {
            if(unknown is Class)
            {
               this.var_211 = Font(FontEnum.registerFont(unknown as Class));
            }
         }
         catch(e:Error)
         {
      ...
      public function setFromOtherAsset(param1:IAsset) : void
      {
         ...
         {
            this.var_211 = FontAsset(param1).var_211;
            return;
         }
