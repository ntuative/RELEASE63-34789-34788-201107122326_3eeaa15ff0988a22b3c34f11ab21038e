package com.sulake.core.localization
{
   ...
   public class Localization implements ILocalization
   {
      ...
      private var var_1593:Dictionary;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_582)
         {
      ...
      private function fillParameterValues() : String
      {
         ...
         for(_loc2_ in this.var_1593)
         {
            _loc3_ = this.var_1593[_loc2_];
