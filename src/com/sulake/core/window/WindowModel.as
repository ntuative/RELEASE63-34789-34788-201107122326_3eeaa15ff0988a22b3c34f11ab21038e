package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_428:Rectangle;
      ...
      protected var var_603:uint;
      
      protected var var_505:uint = 10;
      
      protected var var_746:Boolean = true;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_92 = param4;
         this.var_931 = param8 == null ? new Array() : param8;
         this._context = param6;
         this.var_10 = param7.clone();
         this.var_428 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_10 = null;
            this._context = null;
            this._state = WindowState.const_620;
            this.var_931 = null;
         }
      }
      ...
      {
         return this.var_428.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_428.height;
      }
