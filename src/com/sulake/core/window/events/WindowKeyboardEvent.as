package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_325:String = "WKE_KEY_UP";
      ...
      public static function allocate(param1:String, param2:Event, param3:IWindow, param4:IWindow, param5:Boolean = false) : WindowKeyboardEvent
      {
         ...
         _loc6_._type = param1;
         _loc6_.var_787 = param2 as KeyboardEvent;
         _loc6_._window = param3;
         _loc6_.var_748 = param4;
         _loc6_.var_168 = false;
         _loc6_.var_508 = param5;
         _loc6_.var_749 = POOL;
         return _loc6_;
      }
      ...
      {
         return allocate(_type,this.var_787,window,related,cancelable);
      }
      
      override public function toString() : String
      {
         return "WindowKeyboardEvent { type: " + _type + " cancelable: " + var_508 + " window: " + _window + " charCode: " + this.charCode + " }";
      }
   }
}
