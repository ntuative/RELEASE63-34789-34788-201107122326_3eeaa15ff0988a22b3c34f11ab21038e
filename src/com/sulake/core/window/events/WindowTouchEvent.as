package com.sulake.core.window.events
{
   ...
   public class WindowTouchEvent extends WindowEvent
   {
      ...
      public static const const_745:String = "WTE_BEGIN";
      
      public static const const_1359:String = "WTE_END";
      
      public static const const_2200:String = "WTE_MOVE";
      
      public static const const_2221:String = "WTE_OUT";
      
      public static const const_2243:String = "WTE_OVER";
      
      public static const const_2304:String = "WTE_ROLL_OUT";
      
      public static const const_2147:String = "WTE_ROLL_OVER";
      
      public static const const_758:String = "WTE_TAP";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Boolean, param12:Boolean, param13:Boolean) : WindowTouchEvent
      {
         ...
         _loc14_.var_748 = param3;
         _loc14_.var_168 = false;
         _loc14_.var_749 = POOL;
      ...
      {
         return "WindowTouchEvent { type: " + _type + " cancelable: " + var_508 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
