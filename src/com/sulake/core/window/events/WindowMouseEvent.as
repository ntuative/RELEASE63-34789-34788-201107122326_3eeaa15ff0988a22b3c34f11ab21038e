package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_2287:String = "WME_MIDDLE_CLICK";
      
      public static const const_2305:String = "WME_MIDDLE_DOWN";
      
      public static const const_2248:String = "WME_MIDDLE_UP";
      
      public static const const_199:String = "WME_MOVE";
      ...
      public static const const_292:String = "WME_UP_OUTSIDE";
      
      public static const const_322:String = "WME_WHEEL";
      
      public static const const_2118:String = "WME_RIGHT_CLICK";
      
      public static const const_2210:String = "WME_RIGHT_DOWN";
      
      public static const const_2186:String = "WME_RIGHT_UP";
      
      public static const const_1886:String = "WME_ROLL_OUT";
      
      public static const const_1954:String = "WME_ROLL_OVER";
      
      public static const const_2121:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_748 = param3;
         _loc13_.var_168 = false;
         _loc13_.var_749 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_508 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
