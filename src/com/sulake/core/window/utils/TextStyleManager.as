package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_206:String = "regular";
      ...
      private static var var_591:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_717:String = "{";
      
      private static const const_716:String = "}";
      
      private static const const_1657:String = "/*";
      
      private static const const_1656:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_101[const_206],var_101[ITALIC],var_101[BOLD]];
            var_101.reset();
            var_101[const_206] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_591.indexOf(_loc4_.name) == -1)
            {
               var_591.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "AvatarEditorGridColorItem" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_716);
         if(countSubStrings(param1,const_717) != countSubStrings(param1,const_716))
         {
            throw new Error("Mismatching amount of \"" + const_717 + "\" versus \"" + const_716 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1657) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1656) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_717)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
