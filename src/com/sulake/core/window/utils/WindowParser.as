package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2138:String = "_INCLUDE";
      
      public static const const_2312:String = "_TEMP";
      
      private static const const_1698:String = "layout";
      
      private static const const_1153:String = "window";
      
      private static const const_1154:String = "variables";
      
      private static const const_1152:String = "filters";
      
      private static const const_712:String = "name";
      
      private static const const_1700:String = "style";
      
      private static const const_728:String = "params";
      
      private static const const_1694:String = "tags";
      ...
      private static const const_1696:String = "visible";
      
      private static const const_1697:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1276:String = "blend";
      
      private static const const_1690:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1702:String = "treshold";
      
      private static const const_1689:String = "children";
      
      private static const const_1691:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1692:String = "height_min";
      
      private static const const_1693:String = "height_max";
      
      private static const const_729:String = "AvatarEditorGridColorItem";
      
      private static const const_185:String = "0";
      
      private static const const_1699:String = "$";
      
      private static const const_1447:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1701:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1695:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1430:Dictionary;
      
      protected var var_1431:Dictionary;
      
      protected var var_1155:Dictionary;
      
      protected var var_1718:Dictionary;
      
      protected var var_2275:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1430 = new Dictionary();
         this.var_1431 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1430,this.var_1431);
         this.var_1155 = new Dictionary();
         this.var_1718 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1155,this.var_1718);
         this.var_2275 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1695,const_50);
         return param1.replace(const_1701,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1430)
            {
               delete this.var_1430[_loc1_];
            }
            for(_loc1_ in this.var_1431)
            {
               delete this.var_1431[_loc1_];
            }
            for(_loc1_ in this.var_1155)
            {
               delete this.var_1155[_loc1_];
            }
            for(_loc1_ in this.var_1718)
            {
               delete this.var_1718[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1698)
         {
            _loc8_ = param1.child(const_1154);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1152).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1153);
         ...
         if(param1.localName() == const_1153)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1430[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_712,variables,"")));
         style = uint(this.parseAttribute(xml,const_1700,variables,style));
         params = uint(this.parseAttribute(xml,const_728,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1694,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_185));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_185));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_185));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_185));
         visible = this.parseAttribute(xml,const_1696,variables,visible.toString()) == const_729;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_728).length() > 0)
         {
            list = xml.child(const_728).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_712,variables,"") as String;
               if(this.var_1155[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_712)) + "\"!");
               }
               params |= this.var_1155[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1697,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1447);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1154)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1691,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1692,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1693,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_729;
         blend = Number(this.parseAttribute(xml,const_1276,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1690,variables,window.clipping.toString()) == const_729;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1702,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1152).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_209)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1431[param1.type];
