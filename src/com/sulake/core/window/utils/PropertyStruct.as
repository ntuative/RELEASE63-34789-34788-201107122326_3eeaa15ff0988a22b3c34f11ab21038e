package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      private var var_207:Object;
      
      private var _type:String;
      
      private var var_2943:Boolean;
      
      private var var_3098:Boolean;
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_3098 = param3 == const_258 || param3 == const_179 || param3 == const_291 || param3 == const_265;
      ...
      public function toString() : String
      {
         ...
         {
            case const_172:
               return "0x" + uint(this.var_207).toString(16);
            case const_39:
               return Boolean(this.var_207) == true ? "AvatarEditorGridColorItem" : "false";
            case const_291:
               return "Point(" + Point(this.var_207).x + ", " + Point(this.var_207).y + ")";
            case const_265:
               return "Rectangle(" + Rectangle(this.var_207).x + ", " + Rectangle(this.var_207).y + ", " + Rectangle(this.var_207).width + ", " + Rectangle(this.var_207).height + ")";
            default:
      ...
      public function toXMLString() : String
      {
         ...
         {
            case const_258:
               _loc3_ = this.var_207 as Map;
               _loc1_ = "<var key=\"" + this.var_733 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_291:
               ...
               break;
            case const_265:
               _loc6_ = this.var_207 as Rectangle;
               _loc1_ = "<var key=\"" + this.var_733 + "\">\r<value>\r<" + this._type + ">\r";
               ...
               break;
            case const_172:
               _loc1_ = "<var key=\"" + this.var_733 + "\" value=\"" + "0x" + uint(this.var_207).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_733 + "\" value=\"" + this.var_207 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
