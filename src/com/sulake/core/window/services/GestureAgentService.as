package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_316:Function;
      
      protected var var_1425:int;
      
      protected var var_1424:int;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_1424 = param5;
            this.var_234 = new Timer(40,0);
            this.var_234.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_234.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1425 *= 0.75;
         this.var_1424 *= 0.75;
         if(Math.abs(this.var_1425) <= 1 && Math.abs(this.var_1424) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_316 != null)
         {
            this.var_316(this.var_1425,this.var_1424);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_234.stop();
            this.var_234.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_234 = null;
         }
         if(this._working)
         {
