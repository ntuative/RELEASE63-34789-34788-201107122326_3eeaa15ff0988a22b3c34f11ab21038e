package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1717:uint = 500;
      
      protected var var_1428:String = "";
      
      protected var var_1413:Boolean = false;
      
      protected var var_880:Boolean = false;
      ...
      {
         this.var_1428 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1212,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_880 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc2_ && !param1)
         {
            _loc3_ = WindowEvent.allocate(WindowEvent.const_40,this,null);
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_197,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_448,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_17 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_325,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_994,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1993);
         _loc1_.push(this.var_1413 != PropertyDefaults.const_1260 ? new PropertyStruct(PropertyDefaults.const_987,this.var_1413,PropertyStruct.const_39,true) : PropertyDefaults.const_1831);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1224 ? new PropertyStruct(PropertyDefaults.const_759,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1958);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1268 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_2024);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_987:
                  this.var_1413 = _loc2_.value as Boolean;
                  if(this.var_1413)
                  {
               ...
               case PropertyDefaults.const_759:
                  ...
                  break;
               case PropertyDefaults.const_994:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1335:
