package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1414:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_933:Number;
      
      protected var var_607:Number;
      
      protected var var_606:Boolean;
      
      protected var var_43:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_148:Boolean = false;
      
      protected var var_1151:Boolean = false;
      ...
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         if(param1.var_43)
         {
            param1.var_43.assign(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         else
         {
            param1.var_43 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         param1.refreshTextImage();
      }
      ...
      {
         if(param1.var_43 && param1.var_43.left != param2)
         {
      ...
      {
         if(param1.var_43 && param1.var_43.top != param2)
         {
      ...
      {
         if(param1.var_43 && param1.var_43.right != param2)
         {
      ...
      {
         if(param1.var_43 && param1.var_43.bottom != param2)
         {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_206);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_953 ? true : null;
         }
      ...
      {
         this.var_933 = param1;
         this._field.scrollH = this.var_933 * Number(this._field.maxScrollH);
         this.refreshTextImage();
      }
      
      public function set scrollV(param1:Number) : void
      {
         if(param1 > this.var_607)
         {
            this.var_607 = param1;
            this._field.scrollV = Math.max(this._field.scrollV,param1 * this._field.maxScrollV + 1);
            this.refreshTextImage();
         }
         else if(param1 < this.var_607)
         {
            this.var_607 = param1;
      ...
      {
         return new Rectangle(this.var_933 * this.maxScrollH,this.var_607 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_933 = this.var_933;
         _loc1_.var_607 = this.var_607;
         _loc1_.var_43 = this.var_43.clone(_loc1_.setTextMargins);
         _loc1_._autoSize = this._autoSize;
         _loc1_.var_148 = this.var_148;
         return _loc1_;
      }
      ...
      protected function immediateClickHandler(param1:Event) : void
      {
         ...
         while(_loc4_.length > 0)
         {
            ...
            if(_loc6_.getParamFlag(WindowParam.const_30))
            {
               return;
            }
         }
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         this.var_606 = true;
         var _loc2_:int = this.var_43.left + this.var_43.right;
         var _loc3_:int = this.var_43.top + this.var_43.bottom;
         ...
         if(!_loc7_ && !param1)
         {
            _loc8_ = WindowEvent.allocate(WindowEvent.const_40,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("always_show_selection",this._field.alwaysShowSelection,PropertyStruct.const_39,this._field.alwaysShowSelection != false));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_754,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1284));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1257 ? new PropertyStruct(PropertyDefaults.const_852,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1195) : PropertyDefaults.const_1897);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_39,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_172,this._field.borderColor != 0));
         _loc1_.push(new PropertyStruct("condense_white",this._field.condenseWhite,PropertyStruct.const_39,this._field.condenseWhite != false));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_269,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1302 ? new PropertyStruct(PropertyDefaults.const_1316,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1291) : PropertyDefaults.const_1801);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_983) ? new PropertyStruct(PropertyDefaults.const_401,this._field.textColor,PropertyStruct.const_172,true) : PropertyDefaults.const_1176);
         _loc1_.push(this.var_454 != TextStyleManager.const_206 ? new PropertyStruct(PropertyDefaults.const_419,this.var_454,PropertyStruct.const_52,true,PropertyDefaults.const_901) : PropertyDefaults.const_1387);
         _loc1_.push(this.var_43.left != PropertyDefaults.const_1005 ? new PropertyStruct(PropertyDefaults.const_282,this.var_43.left,PropertyStruct.const_37,true) : PropertyDefaults.const_820);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_1006 ? new PropertyStruct(PropertyDefaults.const_260,this.var_43.top,PropertyStruct.const_37,true) : PropertyDefaults.const_762);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_803 ? new PropertyStruct(PropertyDefaults.const_263,this.var_43.right,PropertyStruct.const_37,true) : PropertyDefaults.const_894);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_973 ? new PropertyStruct(PropertyDefaults.const_272,this.var_43.bottom,PropertyStruct.const_37,true) : PropertyDefaults.const_1022);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1303 ? new PropertyStruct(PropertyDefaults.const_999,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1925);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_37,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_39,this._field.multiline != false));
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_52,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_136,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_136,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_39,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("bold",this._field.defaultTextFormat.bold != false,PropertyStruct.const_39,this._field.defaultTextFormat.bold != false && _loc2_.fontWeight != FontStyle.BOLD));
         _loc1_.push(new PropertyStruct("italic",this._field.defaultTextFormat.italic != false,PropertyStruct.const_39,this._field.defaultTextFormat.italic != false && _loc2_.fontStyle != FontStyle.ITALIC));
         _loc1_.push(new PropertyStruct("underline",this._field.defaultTextFormat.underline != false,PropertyStruct.const_39,this._field.defaultTextFormat.underline != false && _loc2_.textDecoration != "underline"));
         _loc1_.push(new PropertyStruct("kerning",this._field.defaultTextFormat.kerning != false,PropertyStruct.const_39,this._field.defaultTextFormat.kerning != false && !_loc2_.kerning));
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_136,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
