package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      private var var_209:DropMenuController;
      ...
      {
         if(param1 > this.var_309.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_326,this,null,true);
      ...
      {
         if(this.var_209 != null && !this.var_209.disposed)
         {
            this.var_209.destroy();
            this.var_209 = null;
         }
         super.dispose();
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_209 == null || this.var_209.disposed)
         {
            this.var_209 = context.create(name + "::submenu","",WindowType.const_511,var_92,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_209.setGlobalRectangle(_loc1_);
         }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_309.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_1117 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_209.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_1117)
         {
            if(this.open())
            {
               if(this.var_309.length)
               {
                  this.populateMenuItemContainer(this.var_309,this.getSubMenu(),this.subMenuEventProc);
                  this.var_1117 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1117 = false;
            this.getTitleLabel().text = this.var_735 < this.var_309.length && this.var_735 > -1 ? this.var_309[this.var_735] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_529,var_92,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_426,var_92,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_735 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_735).setStateFlag(WindowState.const_56,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_758)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1359:
            case WindowMouseEvent.const_55:
               if(param2 is IDropMenuItemWindow)
               {
                  if(param2.testStateFlag(WindowState.const_92))
                  {
                     this.selection = this.getMenuItemIndex(param2 as IDropMenuItemWindow);
                  }
               }
               break;
            case WindowTouchEvent.const_745:
            case WindowMouseEvent.const_44:
               ...
               break;
            case WindowEvent.const_570:
               if(param2 == this.var_209)
               {
                  this.closeMenuView();
               }
         }
      ...
      {
         if(getStateFlag(WindowState.const_105))
         {
            return true;
         }
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1756,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_309[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_309.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_811,this.var_309,PropertyStruct.const_179,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1730);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_811)
            {
