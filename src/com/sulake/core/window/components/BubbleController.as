package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2097:String = "_POINTER_UP";
      
      private static const const_2096:String = "_POINTER_DOWN";
      
      private static const const_2098:String = "_POINTER_LEFT";
      
      private static const const_2095:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_891;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_792,this._direction,PropertyStruct.const_52,true));
         }
         else
         {
         ...
         if(this.var_891 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_992,this.var_891,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1860);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_792:
                  ...
                  break;
               case PropertyDefaults.const_992:
