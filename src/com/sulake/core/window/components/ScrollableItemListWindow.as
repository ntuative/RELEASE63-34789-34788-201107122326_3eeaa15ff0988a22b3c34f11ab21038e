package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1296:IItemListWindow;
      
      private var var_471:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_89))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_471)
         {
            this.var_471.removeEventListener(WindowEvent.const_284,this.scrollBarEventProc);
            this.var_471.removeEventListener(WindowEvent.const_257,this.scrollBarEventProc);
            this.var_471 = null;
         }
         if(this.var_1296)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1296)
         {
            this.var_1296 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_471)
         {
            this.var_471 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_471)
            {
               this.var_471.addEventListener(WindowEvent.const_284,this.scrollBarEventProc);
               this.var_471.addEventListener(WindowEvent.const_257,this.scrollBarEventProc);
            }
         }
         return this.var_471;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_257)
         {
            this.hideScrollBar();
         }
      }
      ...
      private function hideScrollBar() : void
      {
         if(this._scrollBar.visible)
         {
            ...
            this._itemList.width = var_10.width;
         }
      }
