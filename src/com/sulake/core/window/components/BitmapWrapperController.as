package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_609 != PropertyDefaults.const_1215)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_996,this.var_609,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1856);
         }
         if(this.var_939 != PropertyDefaults.const_1395)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_998,this.var_939,PropertyStruct.const_52,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2010);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_996:
                  ...
                  break;
               case PropertyDefaults.const_998:
