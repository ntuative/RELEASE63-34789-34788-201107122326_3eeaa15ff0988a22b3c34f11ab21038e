package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1500:String = "_TITLE";
      
      private static const const_1501:String = "_HEADER";
      
      private static const const_1499:String = "_CONTENT";
      
      private static const const_1498:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1503:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1500) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1503 = findChildByTag(const_1501) as IHeaderWindow;
            if(!this.var_1503)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_211 = findChildByTag(const_1499) as IWindowContainer;
            if(!this.var_211)
            {
      ...
      {
         return findChildByTag(const_1498) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1419,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1148 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_285);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_285,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_285,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_323,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,_loc3_.left,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,_loc3_.top,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_263,0 - _loc3_.right,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_272,0 - _loc3_.bottom,PropertyStruct.const_37,_loc2_));
         return _loc1_;
      }
