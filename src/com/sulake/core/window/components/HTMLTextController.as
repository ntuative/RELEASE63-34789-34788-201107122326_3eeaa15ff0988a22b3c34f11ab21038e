package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1087:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_874:String;
      
      private var var_1352:String = null;
      
      private var var_2101:StyleSheet = null;
      ...
      {
         this.var_874 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1352 == param2)
         {
            return;
         }
         param1.var_1352 = param2;
         param1.var_2101 = null;
         if(param1.var_1352 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1352);
            param1.var_2101 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_961.indexOf(param1) > -1)
         {
            this.var_874 = param1;
         }
      }
      ...
      {
         return this.var_874 == LinkTarget.const_31 ? defaultLinkTarget : this.var_874;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_2101;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1334)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_874 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_963,this.var_874,PropertyStruct.const_52,true,PropertyDefaults.const_961));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_963)
            {
               this.var_874 = _loc2_.value as String;
               break;
            }
