package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_465:String = "_BTN_TEXT";
      
      protected static const const_1412:Number = 0.5;
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_465);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_284:
                  try
                  {
                     getChildByName(const_465).blend = getChildByName(const_465).blend + const_1412;
                  }
                  catch(e:Error)
                  {
                  }
                  break;
               case WindowEvent.const_257:
                  try
                  {
                     getChildByName(const_465).blend = getChildByName(const_465).blend - const_1412;
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1359:
                  type = "null";
                  break;
               case WindowTouchEvent.const_758:
                  type = "null";
            }
