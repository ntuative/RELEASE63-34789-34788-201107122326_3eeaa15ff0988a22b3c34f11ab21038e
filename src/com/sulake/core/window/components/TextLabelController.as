package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2704 = _loc2_.textWidth;
         this.var_2705 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_395 != _loc2_.color : this.var_395 != null && this.var_395 != PropertyDefaults.const_983) ? new PropertyStruct(PropertyDefaults.const_401,this.var_395,PropertyStruct.const_172,true) : PropertyDefaults.const_1176);
         if(this.var_43)
         {
            if(this.var_43.left != PropertyDefaults.const_1005)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_282,this.var_43.left,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_820);
            }
            if(this.var_43.top != PropertyDefaults.const_1006)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,this.var_43.top,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_762);
            }
            if(this.var_43.right != PropertyDefaults.const_803)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_263,this.var_43.right,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_894);
            }
            if(this.var_43.bottom != PropertyDefaults.const_973)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_272,this.var_43.bottom,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_1022);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_260:
                  ...
                  break;
               case PropertyDefaults.const_263:
                  if(this.var_43 || _loc2_.valid)
                  {
