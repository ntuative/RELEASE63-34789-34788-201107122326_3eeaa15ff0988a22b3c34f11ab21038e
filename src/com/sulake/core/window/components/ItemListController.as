package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2255:Boolean = false;
      
      protected var var_604:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_753:Number = -1.0;
      ...
      protected var var_1414:Boolean = false;
      
      protected var var_2256:int = 0;
      
      protected var var_2257:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_125 = 0;
         this.var_108 = 0;
         this._horizontal = param2 == WindowType.const_437;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_192 = var_506 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_426,WindowStyle.const_104,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_40,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_418,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_160,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_212,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1414;
      }
      ...
      {
         return new Rectangle(this.var_750 * this.maxScrollH,this.var_752 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_750 = param1;
            this._container.x = -this.var_750 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_61);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_654,this,null);
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_752 = param1;
            this._container.y = -this.var_752 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_654,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_564,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_418,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_160,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_212,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_199:
               if(this.var_1416)
               {
                  this.var_1415 = this.var_2256 - _loc3_;
                  this.var_1417 = this.var_2257 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1415 != 0 && this.var_125 != 0)
                     {
                        this.scrollH += this.var_1415 / this.var_125;
                     }
                  }
                  else if(this.var_1417 != 0 && this.var_108 != 0)
                  {
                     this.scrollV += this.var_1417 / this.var_108;
                  }
                  this.var_2256 = _loc3_;
                  this.var_2257 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_292:
               if(this.var_1416)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1415,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1417);
                  }
                  this.var_1416 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1143 && !this.var_604 && this._container)
         {
            this.var_604 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_991)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_449,this._spacing,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1206);
         }
         if(this.var_1143 != PropertyDefaults.const_1319)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_911,this.var_1143,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1910);
         }
         if(this.var_509 != PropertyDefaults.const_1411)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_744,this.var_509,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1792);
         }
         if(this.var_1414 != PropertyDefaults.const_1341)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_979,this.var_1414,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1929);
         }
         if(this.var_753 != PropertyDefaults.const_1221)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_929,this.var_753,PropertyStruct.const_136,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1914);
         }
         if(this.var_751 != PropertyDefaults.const_1402)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_799,this.var_751,PropertyStruct.const_136,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1872);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_449:
                  this.spacing = _loc2_.value as int;
                  break;
               case PropertyDefaults.const_744:
               ...
               case PropertyDefaults.const_911:
                  this.var_1143 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_929:
                  this.var_753 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_799:
