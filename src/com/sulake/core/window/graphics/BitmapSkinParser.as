package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_105:String = "LatencyPingResponseMessageParser";
      
      public static const const_93:String = "active";
      
      public static const const_87:String = "focused";
      
      public static const const_92:String = "hovering";
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "AvatarEditorGridColorItem";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "AvatarEditorGridColorItem";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_359 = SkinLayoutEntity.const_594;
                  break;
               case "move":
                  _loc5_.var_359 = SkinLayoutEntity.const_372;
                  break;
               case "strech":
                  _loc5_.var_359 = SkinLayoutEntity.const_541;
                  break;
               case "tiled":
                  _loc5_.var_359 = SkinLayoutEntity.const_381;
                  break;
               case "center":
                  _loc5_.var_359 = SkinLayoutEntity.const_580;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_357 = SkinLayoutEntity.const_594;
                  break;
               case "move":
                  _loc5_.var_357 = SkinLayoutEntity.const_372;
                  break;
               case "strech":
                  _loc5_.var_357 = SkinLayoutEntity.const_541;
                  break;
               case "tiled":
                  _loc5_.var_357 = SkinLayoutEntity.const_381;
                  break;
               case "center":
                  _loc5_.var_357 = SkinLayoutEntity.const_580;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_93:
               _loc10_ = 0;
               break;
            case BitmapSkinParser.const_105:
               _loc10_ = 0;
               break;
