package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1832:uint = 0;
      
      public static const const_897:uint = 1;
      
      public static const const_1212:uint = 2;
      
      public static const const_995:uint = 4;
      
      public static const const_1839:uint = 8;
      
      public static const const_1878:uint = 16;
      
      public static const const_2320:uint = 64;
      
      public static const const_2258:uint = 128;
      
      public static const const_1166:uint = 256;
      ...
      protected var var_238:DisplayObjectContainer;
      
      protected var var_2271:Boolean;
      
      protected var var_940:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1839:
               ...
               break;
            case GraphicContext.const_1878:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_995:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1166:
               break;
            case GraphicContext.const_1832:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_238.numChildren > 0)
               {
                  this.var_238.removeChildAt(0);
               }
            }
            this.var_238 = null;
            while(numChildren > 0)
         ...
         if(this.var_940)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2271,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2271,16777215);
                  }
                  var_365 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_238 == null)
         {
            this.var_238 = new Sprite();
            this.var_238.name = this.name + " - Child Container";
            this.var_238.mouseEnabled = false;
            addChild(this.var_238);
         }
         return this.var_238;
      }
      ...
      {
         return this.var_238 != null ? int(this.var_238.numChildren) : 0;
      }
