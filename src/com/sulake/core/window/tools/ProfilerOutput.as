package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1549:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1550:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_181:IProfiler;
      ...
      {
         super();
         this.var_25 = param1 as ICore;
         this.var_3085 = new Array();
         this.var_181 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1549() as ByteArray;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(value != this.visible)
         {
            ...
            if(value)
            {
               ...
               this.var_25.setProfilerMode(true);
               this.var_25.queueInterface(new IIDProfiler(),function(param1:IID, param2:IUnknown):void
               {
            ...
            {
               this.var_25.setProfilerMode(false);
            }
         }
      }
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_181)
         {
            this.var_181.removeStopEventListener(this.refresh);
            this.var_181 = null;
         }
         if(!this.var_181 && param1)
         {
            this.var_181 = param1;
            this.var_181.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_669)
            {
               this.var_1945 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_181.getProfilerAgentsInArray();
         ...
         if(this.var_1945)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_181.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_181.numBitmapAssetInstances + " / " + this.var_181.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_181.numTrackedBitmapDataInstances + " / " + this.var_181.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1550() as ByteArray;
