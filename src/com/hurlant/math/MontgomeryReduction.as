package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_2109 = param1.invDigit();
         this.var_2110 = this.var_2109 & 32767;
         this.var_2895 = this.var_2109 >> 15;
         this.var_2894 = 131071;
         this.var_2896 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_185) > 0)
         {
